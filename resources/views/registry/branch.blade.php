...
@section('content')
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align: left !important;align-items: center;padding: 10px 5px;">
                                        <h3 class="card-title form_title">Branch</h3>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align: right !important;align-items: center;padding: 10px 5px;">
                                        <button type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-info waves-effect btn-sm" onclick="refreshBranchDataFn()"><i class="fas fa-sync-alt"></i></button>
                                        @if (auth()->user()->can('Branch-Add'))
                                        <button type="button" class="btn btn-gradient-info btn-sm addbranch header-prop" id="addbranch"><i class="fas fa-plus"></i><span class="header-text">&nbsp Add</span></button>
                                        @endcan 
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="laravel-datatable-crud" class="display table-bordered table-striped table-hover dt-responsive defaultdatatable mb-0 mobile-dt" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:3%;">#</th>
                                            <th style="width:24%;">Branch Name</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title form_title">Branch Information</h4>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <table class="infotbl" style="width: 100%;font-size:12px">
                                    <tr>
                                        <td><label class="info_lbl">Branch Name</label></td>
                                        <td><label class="info_lbl" id="branchnamelbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="info_lbl">Branch Location</label></td>
                                        <td><label class="info_lbl" id="branchlocationlbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="info_lbl">Phone Number</label></td>
                                        <td><label class="info_lbl" id="phonenumberlbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="info_lbl">Email Address</label></td>
                                        <td><label class="info_lbl" id="emailaddresslbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align:left">
                                    <div class="btn-group dropdown">
                                        ...
                                        <ul class="dropdown-menu" id="branch_action_ul"></ul>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align:right">
                                    <input type="hidden" class="form-control" name="branchInfoId" id="branchInfoId" readonly="true" value=""/> 
    ...
    <div class="modal fade text-left fit-content" id="inlineForm" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="banktitlelbl" aria-hidden="true" style="overflow-y: scroll;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title form_title" id="branchtitle">Add Branch</h4>
                ...
                <form id="Register">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Branch Name<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" placeholder="Branch Name" class="form-control reg_form" name="BranchName" id="BranchName" onkeyup="branchNameFn()"/>
                                <span class="text-danger">
                                    <strong class="errordatalabel" id="name-error"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Branch Location<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" placeholder="Branch Location" class="form-control reg_form" name="BranchLocation" id="BranchLocation" onkeyup="branchlocationFn()"/>
                                <span class="text-danger">
                                    <strong class="errordatalabel" id="branchlocation-error"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Phone Number<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" placeholder="Phone or Mobile Number" class="form-control reg_form" name="PhoneNumber" id="PhoneNumber" onkeypress="return ValidatePhone(event);" onkeyup="phoneNumberFn()" />
                                <span class="text-danger">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                ...
                                <input type="text" placeholder="Email Address" class="form-control reg_form" name="EmailAddress" id="EmailAddress" onkeyup="emailvalFn()" />
                                <span class="text-danger">
                    ...
                    <div class="modal-footer">
                        <input type="hidden" class="form-control reg_form" name="branchId" id="branchId" readonly="true" value=""/>     
    ...
    <!--Start branch delete modal -->
    <div class="modal fade text-left" id="deletebranchconmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel35">Confirmation</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="deletebranchform">
                    ...
                    <div class="modal-body" style="background-color:#e74a3b">
                        <label strong style="font-size: 16px;font-weight:bold;color:white;">Do you really want to delete this branch?</label>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="branchdelId" id="branchdelId" readonly="true">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button id="deletebankbtn" type="button" class="btn btn-info">Delete</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function () {
            ...
            var ctable = $('#laravel-datatable-crud').DataTable({
                ...
                columns: [
                    ...
                    { data: 'BranchName', name: 'BranchName',width:"24%"},
                    { data: 'BranchLocation', name: 'BranchLocation',width:"30%"},
                    { data: 'PhoneNumber', name: 'PhoneNumber',width:"23%"},
                    ...
                    { data: 'action', name: 'action',
                        "render": function ( data, type, row, meta ) {
                            return `<div class="text-center"><a class="branchInfo" href="javascript:void(0)" onclick="branchInfoFn(${row.id})" data-id="branch_id${row.id}" id="branch_id${row.id}" title="Open branch information form"><i class="fa-sharp fa-regular fa-circle-info fa-xl" style="color: #00cfe8;"></i></a></div>`;
                        },
                        width:"4%"
                    }
                ],
                ...
                success: function(data) {
                    if(data.errors) {
                        if (data.errors.BranchName) {
                            $('#name-error').html(data.errors.BranchName[0]);
                        }
                        if (data.errors.BranchLocation) {
                            $('#branchlocation-error').html(data.errors.BranchLocation[0]);
                        }
        ...
        function branchEditFn(recordId) { 
            resetBranchForm();
            $.ajax({
                type: "get",
                url: "{{url('showbranch')}}"+'/'+recordId,
                dataType: "json",
                beforeSend: function () { 
                    cardSection.block({
                        message:
                ...
                success: function (data) {
                    $.each(data.branchlist, function(key, value) {
                        $("#branchId").val(recordId);
                        $('#BranchName').val(value.BranchName);
                        $('#BranchLocation').val(value.BranchLocation);
        ...
        function branchInfoFn(recordId){
            createBranchInfoFn(recordId);
            $("#informationmodal").modal('show');
        }

        function createBranchInfoFn(recordId) { 
            var action_log = "";
            var action_links = "";
            var lidata = "";
            $.ajax({
                ...
                success: function (data) {
                    $.each(data.branchlist, function(key, value) {
                        $('#branchnamelbl').html(value.BranchName);
                        $('#branchlocationlbl').html(value.BranchLocation);
                        $('#phonenumberlbl').html(value.PhoneNumber);
                        $('#emailaddresslbl').html(value.EmailAddress);
                    ...
                    action_links = `
                        <li>
                            <a class="dropdown-item viewBranchAction" onclick="viewBranchFn(${recordId})" data-id="viewactionbtn${recordId}" id="viewactionbtn${recordId}" title="View user log">
                        ...
                        @can("Branch-Edit")
                        <li>
                            <a class="dropdown-item branchEdit" onclick="branchEditFn(${recordId})" data-id="editlinkbtn${recordId}" id="editlinkbtn${recordId}" title="Open branch edit form">
                        ...
                        @can("Branch-Delete")
                        <li>
                            <a class="dropdown-item branchDelete" onclick="branchDeleteFn(${recordId})" data-id="deletelinkbtn${recordId}" id="deletelinkbtn${recordId}" title="Open branch delete confirmation">
                    ...
                    $("#branch_action_ul").empty().append(action_links);
                }
            });
        }

        function viewBranchFn(recordId){
            $("#action-log-title").html("User Log Information");
            $("#action-log-universal-modal").modal('show');
        }

        function branchDeleteFn(recordId) { 
            $("#branchInfoId").val(recordId);
            Swal.fire({
                title: warning_title,
                ...
                if (result.value) {
                    deleteBranchFn(recordId);
                }
                else if (result.dismiss === Swal.DismissReason.cancel) {}
            });
        }

        function deleteBranchFn(recordId) { 
        ...
        function branchNameFn() {
            $('#name-error').html('');
        }
        function branchlocationFn() {
            $('#branchlocation-error').html('');
        }
        function phoneNumberFn() {
