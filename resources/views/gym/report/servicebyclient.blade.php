                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Service Income by Client Report</h3>
                            </div>
                                ...
                                <div style="width:100%;">
                                    <div style="width:98%; margin-left:1%; margin-top:2%;">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                                <label strong style="font-size: 14px;color">Clients</label>
                                                    <div>
                                                        <select class="selectpicker form-control" id="Clients" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Clients ({0})" onchange="clientfn()">
                                                            @foreach ($memlist as $memlist)
                                                                <option value="{{$memlist->id}}">{{$memlist->MemberId}} ,   {{$memlist->Name}}  ,   {{$memlist->Mobile}}  ,   {{$memlist->Phone}}</option>
                                                            @endforeach               
                                                        </select>
                                                    </div>
                                                    <span class="text-danger">
                                                <strong id="clients-error"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                                <label strong style="font-size: 14px;color">Group Catagory</label>
                                                    <div>
                                    ...
                                    <div class="col-xl-12 col-md-6 col-sm-12 mb-2">
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                               <table id="servicebyclienttbl" class="table" style="width: 100%;color:black;">
                                                    <thead>
                                                        ...
                                                        <tr id="daterangetr" style="display: none;">
                                                            <th colspan="13">
                                                                <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Service Income by Client Report</b></p></h4>
                                                            </th>
                                                        </tr>
                                                        ...
                                                        <tr class="titletr" style="display: none;">
                                                            ...
                                                            <th colspan="10" style="border: 1px solid black;"><label id="invoicetypelbl" strong style="font-size: 14px;"></label></th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr style="color:white; border: 0.1px solid black;">
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Period</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Service Name</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Payment Type</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">No. of Group</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Payment Term</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Invoice Type</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">Date Range</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">FS/ Doc, Invoice/ Ref #</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Invoice Date</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:8%;">Before Tax</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:7%;">Tax</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:8%;">Total Price</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:8%;">Discount</th>
                                                    ...
                                                    <tfoot class="fitreportfooter">
                                                        ...
                                                        <tr>
                                                            <td colspan="9" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Total Cash</td>
                                                        ...
                                                        <tr>
                                                            <td colspan="9" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Total Credit</td>
                                                        ...
                                                        <tr>
                                                            <td colspan="9" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Grand Total</td>
...
@section('scripts') --}}
    <script type="text/javascript">
        ...
        {    
            ...
            var grouplist="";
            var paymenttermlist="";
            if(paymenttype==''||invoicetype==''||clients==''||period==''||groupcategory==''||paymentterm==''){
                if(invoicetype==''){
                    $('#invoicetype-error').html('Invoice type is required');
                }
                if(clients==''){
                    $('#clients-error').html('Client name is required');
                }
                if(period==''){
            ...
            {   
                ...
                var table = $("#servicebyclienttbl").DataTable({
                    destroy: true,
                    processing: true,
                    serverSide: true,
                    paging: false,
                    ...
                    searchHighlight: true,
                        ...
                        ajax: {
                            ...
                            url: '/servicebyclientdata/'+ fr + '/' + tr + '/' + paymenttype+'/'+invoicetype,
                            type: 'POST',
                            data:{
                        ...
                        rowGroup: {
                            startRender: function ( rows, group,level ) {
                                var color =  'style="font-weight:bold;background:#f2f3f4;"';
                                    if(level===0){
                                        return $('<tr ' + color + '>')
                                        .append('<td colspan="13" style="text-align:center;border: 0.1px solid black; background:#ccc;"><b>Payment Type : ' + group + ' </b></td></tr>')
                                    }
                                    else if(level===1){
                                        return $('<tr ' + color + '>')
                                        .append('<td colspan="13" style="text-align:left;border:0.1px solid;">Service Name : ' + group + '</td></tr>')
                                    } 
                                    else if(level===2){
                                        var text=group;
                                        text = text.replace(".", "");
                                        return $('<tr ' + color + '>')
                                        .append('<td colspan="13" style="text-align:left;border:0.1px solid;">Client : ' + text + '</td></tr>')
                                    }          
                            },
                            endRender: function ( rows, group,level ) {
                                ...
                                if(level===0){
                                    return $('<tr ' + color + '/>')
                                    .append('<td colspan="9" style="text-align:right;border:0.1px solid;">Total ' + group+ '</td>') 
                                    ...
                                    return $('<tr ' + color + '/>')
                                    .append('<td colspan="9" style="text-align:right;border:0.1px solid;">Total of : ' + text+ '</td>') 
                                    .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(totalbeforetax.toFixed(2))+'</td>')
                                    .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(totaltax.toFixed(2))+'</td>')
                                    .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(totalprices.toFixed(2))+'</td>')
                                    .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(discountamount.toFixed(2))+'</td></tr>');
                            ...
                            dataSrc: ['PaymentType','ServiceName','MemberInfo']
                        },
        ...
        $('#printtable').click(function(){
            ...
            let tbl = document.getElementById('servicebyclienttbl');
            ...
            var divToPrint=document.getElementById("servicebyclienttbl");
            var htmlToPrint = '' +
                '<style type="text/css">' +
                'table th, table td {' +
        ...
        $("#downloatoexcel").click(function(){
            ...
            tbl.removeChild(footer);
            tbl.appendChild(footer);
            $("#servicebyclienttbl").table2excel({
            name: "Worksheet Name",
            filename: "ServiceIncomeByClient", //do not include extension
