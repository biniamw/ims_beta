                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Service Income by Service Report</h3>
                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-6 col-sm-12 mb-2">
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                               <table id="servicebyservicetbl" class="table" style="width: 100%;color:black;">
                                                    <thead>
...
@section('scripts') --}}
    <script type="text/javascript">
        ...
        {    
            ...
            var grouplist="";
            var paymenttermlist="";
            if(paymenttype==''||invoicetype==''||services==''||period==''||groupcategory==''||paymentterm==''){
                if(invoicetype==''){
            ...
            {   
                ...
                var table = $("#servicebyservicetbl").DataTable({
                    destroy: true,
                    processing: true,
                    serverSide: true,
                    paging: false,
                    ...
                    searchHighlight: true,
                        ...
                        ajax: {
                            ...
                            url: '/servicebyservicedata/'+ fr + '/' + tr + '/' + paymenttype+'/'+invoicetype,
                            type: 'POST',
                            data:{
        ...
        $('#printtable').click(function(){
            ...
            let tbl = document.getElementById('servicebyservicetbl');
            ...
            var divToPrint=document.getElementById("servicebyservicetbl");
            var htmlToPrint = '' +
                '<style type="text/css">' +
                'table th, table td {' +
        ...
        $("#downloatoexcel").click(function(){
            ...
            tbl.removeChild(footer);
            tbl.appendChild(footer);
            $("#servicebyservicetbl").table2excel({
            name: "Worksheet Name",
            filename: "ServiceIncomeByService", //do not include extension
