                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Service Income by Invoice Report</h3>
                            </div>
                                ...
                                <div style="width:100%;">
                                    <div style="width:98%; margin-left:1%; margin-top:2%;">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                                <label strong style="font-size: 14px;color"> FS/ Invoice Number</label>
                                                    <div>
                                                        <select class="selectpicker form-control" id="FsInvoiceNumber" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="FS / Invoice Number ({0})" onchange="fsinvnumfn()">
                                                            @foreach ($invnumberlist as $invnumberlist)
                                                                <option value="{{$invnumberlist->VoucherNumber}}">{{$invnumberlist->VoucherNumber}}  ,   {{$invnumberlist->InvoiceNumber}}</option>
                                                            @endforeach               
                                                        </select>
                                                    </div>
                                                    <span class="text-danger">
                                                <strong id="fsnuminv-error"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                                <label strong style="font-size: 14px;color">Service Name</label>
                                                    <div>
                                    ...
                                    <div class="col-xl-12 col-md-6 col-sm-12 mb-2">
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                               <table id="incomebyinvoicenumtbl" class="table" style="width: 100%;color:black;">
                                                    <thead>
                                                        ...
                                                        <tr id="daterangetr" style="display: none;">
                                                            <th colspan="10">
                                                                <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Service Income by Invoice Report</b></p></h4>
                                                            </th>
                                                        </tr>
                                                        ...
                                                        <tr class="titletr" style="display: none;">
                                                            <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">Invoice Type</label></th> 
                                                            <th colspan="8" style="border: 1px solid black;"><label id="invoicetypelbl" strong style="font-size: 14px;"></label></th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr style="color:white; border: 0.1px solid black;">
                                                            ...
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">Group Catagory</th>
                                                            ...
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">Start Date</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">End Date</th>
                                                            ...
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">Loyalty Status</th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;"></th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;"></th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;"></th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;"></th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;"></th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;"></th>
                                                            <th style="color:white; border: 0.1px solid white;background-color:#00cfe8;"></th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tfoot class="fitreportfooter">
                                                        {{-- <tr style="display: none;">
                                                            <td colspan="8" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Total Cash</td>
                                                        ...
                                                        <tr style="display: none;">
                                                            <td colspan="8" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Total Credit</td>
                                                        ...
                                                        <tr>
                                                            <td colspan="8" rowspan="5" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Grand Total</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Before Tax</td>
                                                        ...
                                                        <tr>
                                                            <td class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Tax</td>
                                                        ...
                                                        <tr>
                                                            <td class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Total Price</td>
                                                        ...
                                                        <tr>
                                                            <td id="grdiscounttitle" class="text-right" style="font-weight:bold;border:0.1px solid;background:#f2f3f4;">Discount</td>
...
@section('scripts') --}}
    <script type="text/javascript">
        ...
        {    
            ...
            var fsinvoice=$('#FsInvoiceNumber').val(); 
            var selectedptype="";
            var selectedinvtype="";
            var servicelist="";
            var periodlists="";
            ...
            var paymenttermlist="";
            var fsinvoicelist="";
            if(paymenttype==''||invoicetype==''||services==''||period==''||groupcategory==''||paymentterm==''||fsinvoice==''){
                if(invoicetype==''){
                ...
                if(fsinvoice==''){
                    $('#fsnuminv-error').html('Payment type is required');
                }
            ...
            {   
                ...
                var table = $("#incomebyinvoicenumtbl").DataTable({
                    destroy: true,
                    processing: true,
                    serverSide: true,
                    paging: false,
                    ...
                    searchHighlight: true,
                        ...
                        ajax: {
                            ...
                            url: '/incomebyinvoicedata/'+ fr + '/' + tr + '/' + paymenttype+'/'+invoicetype,
                            type: 'POST',
                            data:{
                                ...
                                fsinvoicelist: $('#FsInvoiceNumber').val(),
                            },
                        },
                        buttons: true,
                        ordering: false,
                        ...
                        rowGroup: {
                            startRender: function ( rows, group,level ) {
                                ...
                                if(level===0){
                                    return $('<tr ' + color + '>').append('<td colspan="10" style="text-align:center;border: 0.1px solid black; background:#ccc;"><b>Payment Type : ' + group + ' </b></td></tr>')
                                }
                                else if(level===1){
                                    var text=group;
                                    text = text.replace("|", "");
                                    text = text.replace(".", "");
                                    return $('<tr ' + color + '>').append('<td colspan="10" style="text-align:left;border:0.1px solid;">' + text + '</td></tr>')
                                }         
                            },
                            endRender: function ( rows, group,level ) {
                                ...
                                var discountpercent = rows
                                .data()
                                .pluck('DiscountPercent')
                                .reduce(function (a, b) {
                                    return intVal(a) + intVal(b);
                                }, 0); 
                                ...
                                var color = 'style="font-weight:bold;background:#f2f3f4;"';
                                if(level===0){
                                    return $('<tr style="font-weight:bold;"><td colspan="8" rowspan="5" style="text-align:right;border:0.1px solid;">Total of : ' + group+ '</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Before Tax</td><td style="text-align:left;border:0.1px solid;">'+ numformat(totalbeforetax.toFixed(2))+'</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Tax</td><td style="text-align:left;border:0.1px solid;">'+ numformat(totaltax.toFixed(2))+'</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Total Price</td><td style="text-align:left;border:0.1px solid;">'+ numformat(totalprices.toFixed(2))+'</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Discount ('+numformat(discountpercent.toFixed(2)) +' %)</td><td style="text-align:left;border:0.1px solid;">'+ numformat(discountamount.toFixed(2))+'</td></tr>');
                                    // return $('<tr ' + color + '/>')
                                    ...
                                    var text=group;
                                    text = text.replace("|", "<div style='display:none;'>");
                                    text = text.replace(".", "</div>");
                                    return $('<tr style="font-weight:bold;"><td colspan="8" rowspan="5" style="text-align:right;border:0.1px solid;">Total of : ' + text+ '</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Before Tax</td><td style="text-align:left;border:0.1px solid;">'+ numformat(totalbeforetax.toFixed(2))+'</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Tax</td><td style="text-align:left;border:0.1px solid;">'+ numformat(totaltax.toFixed(2))+'</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Total Price</td><td style="text-align:left;border:0.1px solid;">'+ numformat(totalprices.toFixed(2))+'</td></tr><tr style="font-weight:bold;"><td style="text-align:right;border:0.1px solid;">Discount ('+numformat(discountpercent.toFixed(2)) +' %)</td><td style="text-align:left;border:0.1px solid;">'+ numformat(discountamount.toFixed(2))+'</td></tr><tr><td colspan="10" style="height:0.5rem"></td></tr>');
                                }
                                
                            }, 
                            dataSrc: ['PaymentType','InvoiceInfo']
                        },
                        "footerCallback": function ( row, data, start, end, display ) {
                            ...
                            $('#grdiscounttitle').html("Discount ("+numformat(discountpertoal.toFixed(2))+" %)"); 
                        }
                });
                    $('#exportdiv').show();
                    $("#printable").show();   
        ...
        $('#printtable').click(function(){
            ...
            let tbl = document.getElementById('incomebyinvoicenumtbl');
            ...
            var divToPrint=document.getElementById("incomebyinvoicenumtbl");
            var htmlToPrint = '' +
                '<style type="text/css">' +
                'table th, table td {' +
        ...
        $("#downloatoexcel").click(function(){
            ...
            tbl.removeChild(footer);
            tbl.appendChild(footer);
            $("#incomebyinvoicenumtbl").table2excel({
            name: "Worksheet Name",
            filename: "ServiceIncomeByInvoiceReport", //do not include extension
