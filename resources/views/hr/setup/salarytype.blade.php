...
@section('content')
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align: left !important;align-items: center;padding: 10px 5px;">
                                        <h3 class="card-title form_title">Salary Component</h3>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align: right !important;align-items: center;padding: 10px 5px;">
                                        <button type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-info waves-effect btn-sm" onclick="refreshSalaryCompDataFn()"><i class="fas fa-sync-alt"></i></button>
                                        @if (auth()->user()->can('Salary-Component-Add'))
                                        <button type="button" class="btn btn-gradient-info btn-sm addsalarytype header-prop" id="addsalarytype"><i class="fas fa-plus"></i><span class="header-text">&nbsp Add</span></button>
                                        @endcan 
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="laravel-datatable-crud" class="display table-bordered table-striped table-hover dt-responsive defaultdatatable mb-0 mobile-dt" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:31%;">Component Type</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title form_title">Salary Component Information</h4>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <table class="infotbl" style="width: 100%;font-size:12px">
                                    <tr>
                                        <td><label class="info_lbl">Component Name</label></td>
                                        <td><label class="info_lbl" id="salarytypenamelbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="info_lbl">Component Type</label></td>
                                        <td><label class="info_lbl" id="salarytypelbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr id="nonetaxabletr" style="display: none;">
                                        <td><label class="info_lbl">Non-Taxable Amount</label></td>
                                        <td><label class="info_lbl" id="nontaxableamountlbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align:left">
                                    <div class="btn-group dropdown">
                                        ...
                                        <ul class="dropdown-menu" id="salarycomp_action_ul"></ul>
                                    </div>
                                </div>
    ...
    <div class="modal fade text-left fit-content" id="inlineForm" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="banktitlelbl" aria-hidden="true" style="overflow-y: scroll;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title form_title" id="modaltitle">Add Salary Component</h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Component Name<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" placeholder="Salary Component Name" class="form-control mainforminp reg_form" name="SalaryTypeName" id="SalaryTypeName" onkeyup="salaryTypeNameFn()"/>
                                <span class="text-danger">
                                    <strong id="name-error" class="errordatalabel"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Component Type<b style="color: red; font-size:16px;">*</b></label>
                                <select class="select2 form-control" name="SalaryType" id="SalaryType" onchange="salaryTypeFn()">
                                    <option value="Earnings">Earnings</option>
                                    <option value="Deductions">Deductions</option>
                                </select>
                                <span class="text-danger">
                                    <strong id="salarytype-error" class="errordatalabel"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1" id="nontaxablediv" style="display: none;">
                                <label class="form_lbl">Non-Taxable Amount<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" id="NonTaxableAmount" name="NonTaxableAmount" class="form-control mainforminp reg_form" placeholder="Non-Taxable Amount" onkeyup="nonTaxableAmountFn()" onkeypress="return ValidateNum(event);"/>
                                <span class="text-danger">
                                    <strong id="nontaxableamount-error" class="errordatalabel"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function () {
            ...
            var ctable = $('#laravel-datatable-crud').DataTable({
                ...
                columns: [
                    ...
                    { data: 'SalaryTypeName', name: 'SalaryTypeName',width:"32%"},
                    { data: 'SalaryType', name: 'SalaryType',width:"31%"},
                    ...
                    { data: 'action', name: 'action',
                        "render": function ( data, type, row, meta ) {
                            return `<div class="text-center"><a class="salarytypeInfo" href="javascript:void(0)" onclick="salarytypeInfoFn(${row.id})" data-id="salarycomp_id${row.id}" id="salarycomp_id${row.id}" title="Open salary component information form"><i class="fa-sharp fa-regular fa-circle-info fa-xl" style="color: #00cfe8;"></i></a></div>`;
                        },
                        width:"4%"
                    }
                ],
        ...
        $("#addsalarytype").on("click", function () {
            resetSalaryCompFn();
        ...
        $('.record-save').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.errors) {
                        if (data.errors.SalaryTypeName) {
                            var text=data.errors.SalaryTypeName[0];
                            text = text.replace("salary type", "component");
                            $('#name-error').html(text);
                        }
                        if (data.errors.SalaryType) {
                            var text=data.errors.SalaryType[0];
                            text = text.replace("salary", "component");
                            $('#salarytype-error').html(text);
                        }
                        if (data.errors.NonTaxableAmount) {
                            var text=data.errors.NonTaxableAmount[0];
                            text = text.replace("salary", "component");
                            $('#nontaxableamount-error').html(text);
                        }
                        ...
                        if(parseInt(optype) == 2){
                            createSalaryCompInfoFn(recordId);
                        }
                        if(action == "close"){
        ...
        function salarytypeEdityFn(recordId) { 
            resetSalaryCompFn();
            if(parseInt(recordId) <= 10){
                toastrMessage('error',"This salary component is not editable.","Error");
            }
            else{
                $.ajax({
                    type: "get",
                    url: "{{url('showsalarytype')}}"+'/'+recordId,
                    dataType: "json",
                    beforeSend: function () { 
                        cardSection.block({
                            message:
                    ...
                    success: function (data) {
                        $.each(data.salarytypedata, function(key, value) {
                            $("#recId").val(recordId);
                            $('#SalaryTypeName').val(value.SalaryTypeName);
                            $('#SalaryType').val(value.SalaryType).select2({minimumResultsForSearch: -1});
                            $("#NonTaxableAmount").val(value.NonTaxableAmount);
                            $("#Description").val(value.Description);
                            $('#status').val(value.Status).select2({minimumResultsForSearch: -1});
                            value.SalaryType == "Earnings" ? $("#nontaxablediv").show() : $("#nontaxablediv").hide();
                        });
                    }
                });

                $("#modaltitle").html("Edit Salary Component");
        ...
        function salarytypeInfoFn(recordId){
            createSalaryCompInfoFn(recordId);
            $("#informationmodal").modal('show');
        }

        function createSalaryCompInfoFn(recordId){ 
            var action_log = "";
            var action_links = "";
            var lidata = "";
            $("#nonetaxabletr").hide()
            $.ajax({
                ...
                success: function (data) {
                    $.each(data.salarytypedata, function(key, value) {
                        $("#salarytypenamelbl").html(value.SalaryTypeName);
                        $("#salarytypelbl").html(value.SalaryType);
                        $("#nontaxableamountlbl").html(value.NonTaxableAmount);
                        $("#descriptionlbl").html(value.Description);
                        
                        value.SalaryType == "Earnings" ? $("#nonetaxabletr").show() : $("#nonetaxabletr").hide();
                    ...
                    action_links = `
                        <li>
                            <a class="dropdown-item viewSalaryCompAction" onclick="viewSalaryCompFn(${recordId})" data-id="viewactionbtn${recordId}" id="viewactionbtn${recordId}" title="View user log">
                        ...
                        <li>
                            <a class="dropdown-item salarytypeEdit" onclick="salarytypeEdityFn(${recordId})" data-id="editlinkbtn${recordId}" id="editlinkbtn${recordId}" title="Open salary component edit form">
                        ...
                        <li>
                            <a class="dropdown-item salarytypeDelete" onclick="salarytypeDeleteFn(${recordId})" data-id="deletelinkbtn${recordId}" id="deletelinkbtn${recordId}" title="Open salary component delete confirmation">
                    ...
                    $("#salarycomp_action_ul").empty().append(action_links);
                }
            });            
        }

        function viewSalaryCompFn(recordId){
            $("#action-log-title").html("User Log Information");
            $("#action-log-universal-modal").modal('show');
        }

        function salarytypeDeleteFn(recordId) { 
            if(parseInt(recordId) <= 10){
                toastrMessage('error',"Unable to delete system salary component.","Error");
            }
            else{
        ...
        function salaryTypeNameFn() {
            $('#name-error').html('');
        }

        function salaryTypeFn() {
            var comptype = $('#SalaryType').val();
            $("#nontaxablediv").hide();
            $("#NonTaxableAmount").val("");
            if(comptype == "Earnings"){
                $("#nontaxablediv").show();
            }
            $('#salarytype-error').html('');
            $('#nontaxableamount-error').html('');
        }

        function nonTaxableAmountFn() {
            $('#nontaxableamount-error').html('');
        }
        ...
        function refreshSalaryCompDataFn(){
            var oTable = $('#laravel-datatable-crud').dataTable();
            oTable.fnDraw(false);
        }

        function resetSalaryCompFn(){
            $('.reg_form').val("");
            $('.errordatalabel').html("");
            $('#SalaryType').val(null).select2
            ({
                placeholder: "Select component type here",
            ...
            $('#nontaxablediv').hide();
            $("#modaltitle").html("Add Salary Component");
        }
    </script>
@endsection
