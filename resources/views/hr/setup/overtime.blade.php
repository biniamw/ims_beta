...
@section('content')
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align: left !important;align-items: center;padding: 10px 5px;">
                                        <h3 class="card-title form_title">Overtime Level</h3>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align: right !important;align-items: center;padding: 10px 5px;">
                                        <button type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-info waves-effect btn-sm" onclick="refreshOtDataFn()"><i class="fas fa-sync-alt"></i></button>
                                        @if (auth()->user()->can('Overtime-Level-Add'))
                                        <button type="button" class="btn btn-gradient-info btn-sm addovertime header-prop" id="addovertime"><i class="fas fa-plus"></i><span class="header-text">&nbsp Add</span></button>
                                        @endcan 
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="laravel-datatable-crud" class="display table-bordered table-striped table-hover dt-responsive defaultdatatable mb-0 mobile-dt" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:3%;">#</th>
                                            <th style="width:31%;">Overtime Level Name</th>
                                            <th style="width:31%;">Work Hour Rate %</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title form_title">Overtime Level Information</h4>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <table class="infotbl" style="width: 100%;font-size:12px">
                                    <tr>
                                        <td><label class="info_lbl">Overtime Level Name</label></td>
                                        <td><label class="info_lbl" id="overtimelevelnamelbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="info_lbl">Work Hour Rate</label></td>
                                        <td><label class="info_lbl" id="workhourlbl" style="font-weight:bold;"></label></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6" style="text-align:left">
                                    <div class="btn-group dropdown">
                                        ...
                                        <ul class="dropdown-menu" id="ot_action_ul"></ul>
                                    </div>
                                </div>
    ...
    <div class="modal fade text-left fit-content" id="inlineForm" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="overtimelbl" aria-hidden="true" style="overflow-y: scroll;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title form_title" id="modaltitle">Add Overtime Level</h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Overtime Level Name<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" placeholder="Overtime Level Name" class="form-control mainforminp reg_form" name="OvertimeLevelName" id="OvertimeLevelName" onkeyup="overtimelevelFn()"/>
                                <span class="text-danger">
                                    <strong id="name-error" class="errordatalabel"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
                                <label class="form_lbl">Work Hour Rate %<b style="color: red; font-size:16px;">*</b></label>
                                <input type="text" id="WorkHourRate" name="WorkHourRate" class="form-control mainforminp reg_form" placeholder="Work Hour Rate %" onkeyup="workhourreteFn()" onkeypress="return ValidateNum(event);"/>
                                <span class="text-danger">
                                    <strong id="workhourrate-error" class="errordatalabel"></strong>
                                </span>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-1">
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function () {
            ...
            var ctable = $('#laravel-datatable-crud').DataTable({
                ...
                columns: [
                    ...
                    { data: 'OvertimeLevelName', name: 'OvertimeLevelName',width:"31%"},
                    { data: 'WorkhourRate', name: 'WorkhourRate',width:"31%"},
                    ...
                    { data: 'action', name: 'action',
                        "render": function ( data, type, row, meta ) {
                            return `<div class="text-center"><a class="overtimeInfo" href="javascript:void(0)" onclick="overtimeInfoFn(${row.id})" data-id="overtime_id${row.id}" id="overtime_id${row.id}" title="Open overtime-level information form"><i class="fa-sharp fa-regular fa-circle-info fa-xl" style="color: #00cfe8;"></i></a></div>`;
                        },
                        width:"4%"
                    }
                ],
        ...
        $('.record-save').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.errors) {
                        if (data.errors.OvertimeLevelName) {
                            $('#name-error').html(data.errors.OvertimeLevelName[0]);
                        }
                        if (data.errors.WorkHourRate) {
                            $('#workhourrate-error').html(data.errors.WorkHourRate[0]);
                        }
        ...
        function overtimeEditFn(recordId) { 
            resetOvertimeFormFn();
            $.ajax({
                type: "get",
                url: "{{url('showOvertime')}}"+'/'+recordId,
                dataType: "json",
                beforeSend: function () { 
                    cardSection.block({
                        message:
                ...
                success: function (data) {
                    $.each(data.overtimesdata, function(key, value) {
                        $("#recId").val(recordId);
                        $('#OvertimeLevelName').val(value.OvertimeLevelName);
                        $('#WorkHourRate').val(value.WorkhourRate);
            ...
            $("#modaltitle").html("Edit Overtime Level");
        ...
        function overtimeInfoFn(recordId){
            createOvertimeInfoFn(recordId);
            $("#informationmodal").modal('show');
        }

        function createOvertimeInfoFn(recordId) { 
            var action_log = "";
            var action_links = "";
            var lidata = "";
            $.ajax({
                ...
                success: function (data) {
                    $.each(data.overtimesdata, function(key, value) {
                        $("#overtimelevelnamelbl").html(value.OvertimeLevelName);
                        $("#workhourlbl").html(value.WorkhourRate+" %");
                    ...
                    action_links = `
                        <li>
                            <a class="dropdown-item viewOvertimeAction" onclick="viewOvertimeFn(${recordId})" data-id="viewactionbtn${recordId}" id="viewactionbtn${recordId}" title="View user log">
                            <span><i class="fa-solid fa-eye"></i> View User Log</span>  
                            </a>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        @can("Overtime-Level-Edit")
                        <li>
                            <a class="dropdown-item overtimeEdit" onclick="overtimeEditFn(${recordId})" data-id="editlinkbtn${recordId}" id="editlinkbtn${recordId}" title="Open overtime level edit form">
                            <span><i class="fa-solid fa-pencil"></i> Edit</span>  
                            </a>
                        </li>
                        @endcan
                        @can("Overtime-Level-Delete")
                        <li>
                            <a class="dropdown-item overtimeDelete" onclick="overtimeDeleteFn(${recordId})" data-id="deletelinkbtn${recordId}" id="deletelinkbtn${recordId}" title="Open overtime level delete confirmation">
                    ...
                    $("#ot_action_ul").empty().append(action_links);
                }
            });
        }

        function viewOvertimeFn(recordId){
        ...
        function deleteOvertimeFn(recordId){
        ...
        function overtimelevelFn() {
            $('#name-error').html('');
        }

        function workhourreteFn() {
            $('#workhourrate-error').html('');
        }
        ...
        function refreshOtDataFn(){
            var oTable = $('#laravel-datatable-crud').dataTable();
            oTable.fnDraw(false);
        }

        function resetOvertimeFormFn(){
            $('.reg_form').val("");
            $('.errordatalabel').html("");
            ...
            $("#modaltitle").html("Add Overtime Level");
        }
    </script>
@endsection
