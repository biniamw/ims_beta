...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('customcss/jquery.multiselect.css') }}" />
...
<body class="vertical-layout vertical-menu-modern menu-expanded pace-done footer-fixed navbar-sticky" data-open="click" data-menu="vertical-menu-modern" data-col="" id="page-block">
    ...
    auth()->user()->can('DeadStock-View'))
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            @if (auth()->user()->can('Receiving-View') || auth()->user()->can('Hold-View'))
                                <li>
                                    <a class="d-flex align-items-center" href="receiving"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @can('Requisition-View')
                                <li>
                                    <a class="d-flex align-items-center" href="requisition"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @can('Transfer-View')
                                <li>
                                    <a class="d-flex align-items-center" href="transfer"><i data-feather="circle"></i><span
                            ...
                            @if (auth()->user()->can('Approver-Transfer-View') || auth()->user()->can('Approver-Requisition-View'))
                                <li>
                                    <a class="d-flex align-items-center" href="approver"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @if (auth()->user()->can('Issue-Transfer-View') ||auth()->user()->can('Issue-Requisition-View'))
                                <li>
                                    <a class="d-flex align-items-center" href="issue"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @can('Adjustment-View')
                                <li>
                                    <a class="d-flex align-items-center" href="adjustment"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @can('Begining-View')
                                <li>
                                    <a class="d-flex align-items-center" href="begining"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="StoreBegining">Store Begining</span></a>
                                </li>
                            @endcan
                            @can('Begining-View')
                                <li>
                            ...
                            @can('StoreBalance-View')
                                <li>
                                    <a class="d-flex align-items-center" href="stockbalance"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                                            data-i18n="stockbalance">Store Balance</span></a>
                                </li>
                            @endcan
                            ...
                            <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item text-truncate" style="color:#ea5455;" data-i18n="DS">DS</span></a>
                                <ul class="menu-content">
                                    @can('DeadStock-View')
                                        <li>
                                            <a class="d-flex align-items-center" href="deadstock"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Dead Stock" style="color:#ea5455;">Dead Stock</span></a>
                                        </li>
                                    @endcan
                                    @can('DS-Beginning')
                                        <li>
                ...
                @endif
                @if (auth()->user()->can('Settlement-View'))
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            @can('Settlement-View')
                                <li>
                                    <a class="d-flex align-items-center" href="settlement"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                                            data-i18n="Settlement">Settlement</span></a>
                                </li>
                            @endcan
                                <li>
                                    <a class="d-flex align-items-center" href="closing"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                                            data-i18n="Closing">Closing</span></a>
                                </li>
                        </ul>
                    </li>
                @endif
                @if (auth()->user()->can('Invoice-View'))
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='package'></i><span class="menu-title text-truncate"
                        ...
                        <ul class="menu-content">
                            @if (auth()->user()->can('Invoice-View'))
                                <li>
                                    <a class="d-flex align-items-center" href="application"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Fitness Form">Fitness Form</span></a>
                                </li>
                            @endif
    ...
    auth()->user()->can('Brand-View')||auth()->user()->can('Service-View')||auth()->user()->can('Client-View')||auth()->user()->can('Employee-View'))
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                        ...
                        <ul class="menu-content">
                            @can('Category-View')
                                <li>
                                    <a class="d-flex align-items-center" href="category"><i data-feather="circle"></i><span
                                            class="menu-item text-truncate" data-i18n="Category">Category</span></a>
                                </li>
                            @endcan
                            @if (auth()->user()->can('UOM-View') || auth()->user()->can('Conversion-view'))
                                <li>
                                    <a class="d-flex align-items-center" href="uom"><i data-feather="circle"></i><span
                            ...
                            @if (auth()->user()->can('Customer-View') ||auth()->user()->can('Blacklist-View'))
                                <li>
                                    <a class="d-flex align-items-center" href="customer"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @can('Store-View')
                                <li>
                                    <a class="d-flex align-items-center" href="store"><i data-feather="circle"></i><span
                                            class="menu-item text-truncate" data-i18n="Store">Store</span></a>
                                </li>
                            @endcan
                            @can('Brand-View')
                                <li>
                                    <a class="d-flex align-items-center" href="brand" style="display:none;"><i
                                            data-feather="circle"></i><span class="menu-item text-truncate"
                            ...
                            @can('Service-View')
                                <li>
                                    <a class="d-flex align-items-center" href="service"><i data-feather="circle"></i><span
                                            class="menu-item text-truncate" data-i18n="Services">Services</span></a>
                                </li>
                            @endcan
                            @can('Client-View')
                                <li>
                                    <a class="d-flex align-items-center" href="membership"><i data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="Membership">Client</span></a>
                                </li>
                            @endcan
                            @can('Employee-View')
                                <li>
                                    <a class="d-flex align-items-center" href="employee"><i data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="Employee">Employee</span></a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                @if (auth()->user()->can('GeneralSales-View') || auth()->user()->can('SalesDetial-View') ||auth()->user()->can('SalesByCustomer-View') ||auth()->user()->can('SalesByItem-View') ||auth()->user()->can('Withold-&-VAT') ||auth()->user()->can('GeneralPurchase-View') ||auth()->user()->can('PurchaseDetail-View') ||auth()->user()->can('PurchaseBySupplier-View') ||auth()->user()->can('PurchaseByItem-View') ||auth()->user()->can('ItemMovement-View') ||auth()->user()->can('StoreBalanceReport-View')||auth()->user()->can('Inventory-Value-View')||auth()->user()->can('Reorder-View')||auth()->user()->can('Item-Sales-History-By-Customer-View'))
                    <li class="nav-item">
                                ...
                                <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                                    ...
                                    <ul class="menu-content">
                                        @can('GeneralPurchase-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="{{url('purchaseui')}}"><i
                                                        data-feather="circle"></i><span class="menu-item text-truncate"
                        ...
                        @if (auth()->user()->can('GeneralSales-View') ||auth()->user()->can('SalesDetial-View') ||auth()->user()->can('SalesByCustomer-View') ||auth()->user()->can('SalesByItem-View') ||auth()->user()->can('Withold-&-VAT')||auth()->user()->can('Item-Sales-History-By-Customer-View'))
                            <ul class="menu-content">
                                <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                                            data-feather="file"></i><span class="menu-title text-truncate"
                                    ...
                                    <ul class="menu-content">
                                        ...
                                        @can('ERCA-Sales-Report-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="{{url('custom')}}"><i
                                                        data-feather="circle"></i><span class="menu-item text-truncate"
                                ...
                                <li>
                                    ...
                                    <ul class="menu-content">
                                        @can('ItemMovement-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="movementui"><span
                                        ...
                                        @can('StoreBalanceReport-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="balanceui"><span
                                        ...
                                        @can('Inventory-Value-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="value"><span
                                                    class="menu-item text-truncate"
                                        ...
                                        @can('Reorder-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="reorder"><span
                                                        class="menu-item text-truncate"
                                        ...
                                        @can('FSNAnalysis-View')
                                            <li>
                                                <a class="d-flex align-items-center" href="fsn"><span
                                                        class="menu-item text-truncate"
                                        ...
                                        <li><a class="d-flex align-items-center" href="#"><span class="menu-item text-truncate" style="color:#ea5455;" data-i18n="DS">DS</span></a>
                                            <ul class="menu-content">
                                                ...
                                                @can('DS-General-HandIn')
                                                    <li>
                                                        <a class="d-flex align-items-center" href="dsgenhi"><span class="menu-item text-truncate" data-i18n="DS General HandIn Report">DS General HandIn Report</span></a>
                                                    </li>
                                                @endcan
                                                ...
                                                @can('DS-Store-Balance')
                                                    <li>
                                                        <a class="d-flex align-items-center" href="dsbalance"><span class="menu-item text-truncate" data-i18n="DS Store Balance Report">DS Store Balance Report</span></a>
                                                    </li>
                                                @endcan
                                                @can('DS-Inventory-Value')
                                                    <li>
                                                        <a class="d-flex align-items-center" href="dsvalue"><span class="menu-item text-truncate" data-i18n="DS Inventory Value Report">DS Inventory Value Report</span></a>
                                                    </li>
                                                @endcan
                                            </ul>
                                        </li>
            ...
            @can('Setting-Change')
                <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        @can('Setting-Change')
                            <li>
                                <a class="d-flex align-items-center" href="setting"><i data-feather="circle"></i><span
            ...
            @if (auth()->user()->can('User-View') || auth()->user()->can('Role-View'))
                <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        @can('User-View')
                            <li>
                                <a class="d-flex align-items-center" href="/user"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Users">Users</span></a>
                            </li>
                        @endcan
                        @can('Role-View')
                            <li>
                                <a class="d-flex align-items-center" href="/role"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Role">Role</span></a>
                            </li>
                        @endcan
                    </ul>
                </li>
