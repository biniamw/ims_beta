                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Payment Request Report</h3>
                        </div>
                                ...
                                <div style="width:98%; margin-left:2%; margin-top:2%;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 col-sm-12 mb-2 errorclear">
                                            ...
                                            <select class="selectpicker form-control sp suplier" name="supplier[]" id="supplier" data-live-search="true" data-selected-text-format="count" data-actions-box="true" data-count-selected-text="({0}) Selected" data-live-search-placeholder="search supplier type" title="Select supplier" multiple >
                                        ...
                                        <div class="col-xl-2 col-md-6 col-sm-12 mb-2 errorclear">
                                            ...
                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2 errorclear">
                                                <label strong style="font-size: 14px;color">Payment Reference</label> <b style="color:red;">*</b>
                                                <div>
                                                <select class="selectpicker form-control sp pref" name="paymentreference[]" id="paymentreference" data-live-search="true" data-selected-text-format="count" data-actions-box="true" data-count-selected-text=" ({0}) Selected" data-live-search-placeholder="search Payment Reference" title="Select Reference" multiple>
                                                        
                                                </select>
                                                    </div>
                                                    <span class="text-danger">
                                                <strong id="paymentreference-error"></strong>
                                                </span>
                                            </div>
                                            ...
                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2 errorclear" style="display: none">
                                                <label strong style="font-size: 14px;color">Supplier Clone</label> <b style="color:red;">*</b>
                                                <div>
                                                <select class="selectpicker form-control" name="supplierclone" id="supplierclone" data-live-search="true" data-selected-text-format="count" data-actions-box="true" data-count-selected-text=" ({0}) Selected" data-live-search-placeholder="search Supplier clone" title="Select Supplier">
                                                    ...
                                                    <span class="text-danger">
                                                <strong id="supplierclone-error"></strong>
                                                </span>
                                            </div>

                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2 errorclear" style="display: none;">
                                                <label strong style="font-size: 14px;color">PO Clone</label> <b style="color:red;">*</b>
                                            
                                                <select class="selectpicker form-control" name="poclone" id="poclone" data-live-search="true" data-selected-text-format="count" data-actions-box="true" data-count-selected-text=" ({0}) Selected" data-live-search-placeholder="search purchase clone" title="Select purchase clone">
                                                        <option value="1">Direct</option>
                                                    @foreach ($purchaseorder as $key)
                                                            <option value="{{ $key->id }}">{{ $key->porderno }}</option>
                                                        @endforeach
                                                </select>
                                                
                                                    <span class="text-danger">
                                                <strong id="poclone-error"></strong>
                                                </span>
                                            </div>

                                            <div class="col-xl-2 col-md-6 col-sm-12 mb-2 errorclear" style="display: none;">
                                                <label strong style="font-size: 14px;color">Payment Reference Clone</label> <b style="color:red;">*</b>
                                            
                                                <select class="selectpicker form-control sp pref" name="paymentreferenceclone[]" id="paymentreferenceclone" data-live-search="true" data-selected-text-format="count" data-actions-box="true" data-count-selected-text=" ({0}) Selected" data-live-search-placeholder="search Payment Reference" title="Select Reference" multiple>
                                                        <option value="PO">Purchase Order</option>
                                                        <option value="GRV">Good Reciving</option>
                                        ...
                                        <div class="col-12">
                                            <table id="salesReportByCustomer" class="display"  cellspacing="0" name="table" style="width: 100%;color:black;">
                                                <thead>
                                                        ...
                                                        <th style="color:white; border: 1px solid white;background-color:#00cfe8;">Document#</th>
                                                        ...
                                                        <th style="color:white; border: 1px solid white;background-color:#00cfe8;">Paid Amount</th>
                                                        <th style="color:white; border: 1px solid white;background-color:#00cfe8;">poid</th>
                                                        <th style="color:white; border: 1px solid white;background-color:#00cfe8;">pyrid</th>
                                                ...
                                                <tfoot>
                                                    <tr style="color: black;">
                                                        <th colspan="16" style="background:#f2f3f4;border: 0.1px solid black;"><h6 style="text-align: right;color:black;font-weight:bold;font-size:13px;">Grand Total Paid Amount</h6></th>
...
$('#printtable').click(function(){
    ...
    $('#customCheck1').click(function(){
        ...
        function makeitselectall() {
                ...
                $('#paymentreference').selectpicker('selectAll').selectpicker('refresh'); //Refresh UI
        ...
        function undomakeitselectall() {
                ...
                $('#status').selectpicker('selecdeselectAllAll').selectpicker('refresh'); //Refresh UI
        }
...
function referencefilters(selectedvalues) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var $originalSelect = $('#poclone');
            var $destination = $('#po');
            $destination.empty(); // Clear the destination select
            $destination.html($originalSelect.html());
            // Remove options not in allowedValues from destination select
            $destination.find('option').each(function() {
                if (!allowedValues.includes(parseInt($(this).val(), 10))) {
                $(this).remove();
                }
            });
            $destination.selectpicker('refresh');  // Refresh the selectpicker
            if($('#customCheck1').is(':checked')) {
                    $('#po').selectpicker('selectAll').selectpicker('refresh'); //Refresh UI
                } else{
                    $('#po').selectpicker('deselectAll').selectpicker('refresh'); //Refresh UI
        ...
        $.ajax({
            ...
            success: function (response) {
                    ...
                    $.each(response.paymentreference, function (index, value) { 
                        allowedValues.push(value.paymentreference);
                    });
                    
                    var $originalSelect = $('#paymentreferenceclone');
                    var $destination = $('#paymentreference');
                    $destination.empty(); // Clear the destination select
                    $destination.html($originalSelect.html());
                    // Remove options not in allowedValues from destination select
                    $destination.find('option').each(function() {
                        var optionValue = $(this).val(); // Get the option value as a string
                        if (!allowedValues.includes(optionValue)) {
                            $(this).remove(); // Remove if the value is not allowed
                        }
                    });
                    $destination.selectpicker('refresh');  // Refresh the selectpicker
                    if ($('#customCheck1').is(':checked')) {
    ...
    drp.on('cancel.daterangepicker', function(ev, picker) {
        ...
        $(function () {
                ...
                function filtersuppliterwithranges(from,to) {
                    $.ajax({
                        type: "GET",
                        url: "{{ url('filtersupplier') }}/"+from+"/"+to,
                            beforeSend: function () { 
                                    cardSection.block({
                                        message:
                                        '<div class="d-flex justify-content-center align-items-center"><p class="mr-50 mb-50">Loading Please Wait...</p><div class="spinner-grow spinner-grow-sm text-white" role="status"></div> </div>',
                        ...
                        success: function (response) {
                                ...
                                if (Array.isArray(response.supplier)) {
                                    if (response.supplier.length === 0) {
                                            const reportRangeSpan = $('#reportrange span'); // Cache the span element
                                            reportRangeSpan.text(""); // Clear any initial text
                                            var $destination = $('#supplier');
                                            $destination.empty()
                                            $destination.selectpicker('refresh');
                                            $('#customCheck1').prop('disabled', true);
                                            toastrMessage('error','No Supplier Found','Error!');
                                    } else { //Array is not empty.
                                        $.each(response.supplier, function (index, value) { 
                                            option+= "<option value='"+value.id+"'>"+value.Code+ ","+ value.Name+ ","+ value.TinNumber+ "</option>";
                                            allowedValues.push(value.id);
                                        });
                                        var $originalSelect = $('#supplierclone');
                                        var $destination = $('#supplier');
                                        $destination.empty(); // Clear the destination select
                                        $destination.html($originalSelect.html());
                                        // Remove options not in allowedValues from destination select
            ...
            table = $("#salesReportByCustomer").DataTable({
                    ...
                    language: {
                        ...
                        ajax: {
                                ...
                                type: "POST",
                                url: "{{ url('paymentrequestreportdispaly') }}",
                                        data: function (d) {
                                            Object.assign(d, {
                                                fiscalYear,
                                                from,
                            ...
                            columns: [
                                    ...
                                    {data: "GRV", className: 'GRV',"sortable": false,"searchable":false},
                                    {data: "PIV", className: 'PIV',"sortable": false,"searchable":false},
                                    ...
                                    {data: "bagwieght", className: 'bagwieght',"sortable": false,searchable:false},
                                    ...
                                    {data: "PaidAmount", className: 'PaidAmount',"sortable": false,'visible':false,searchable:false},
                                    {data: "poid", className: 'poid',"sortable": false,'visible':false,"searchable":false,searchable:false},
                                    {data: "pyrid", className: 'pyrid',"sortable": false,'visible':false,"searchable":false,searchable:false},
                                    {data: "grn", className: 'grn',"sortable": false,'visible':false,searchable:false},
                                    {data: "piv", className: 'piv',"sortable": false,'visible':false,searchable:false},
                            ],
                            initComplete: function() {
                                const api = this.api();
                                const $filterContainer = $(api.table().container()).find('.dataTables_filter');
                                const $infoIcon = $('<span class="filter-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Purchase Order, Document#, Supplier with TIN, are only searchable columns"><i class="info-icon fa fa-info-circle text-primary"></i></span>'); // Tooltip attributes added here
                                const $filterLabel = $filterContainer.find('label');
                                const $searchInput = $filterContainer.find('input[type="search"]');

                                if ($filterLabel.length) {
                                    $infoIcon.insertBefore($filterLabel);
                                } else {
                                    $filterContainer.prepend($infoIcon);
                                }

                                feather.replace();

                                // Initialize tooltips AFTER the icon is in the DOM and Feather has replaced it
                                ...
                                $searchInput.off('input').on('input', function() {
                                    ...
                                    let previousSearch = api.search();
                                    if (searchTerm === "" || allowedCharsRegex.test(searchTerm)) {
                                        api.search(searchTerm).draw();
                                    } else {
                                        this.value = searchTerm.slice(0, -1);
                                        if (previousSearch !== "" && allowedCharsRegex.test(previousSearch)) {
                                                api.search(previousSearch).draw(); // Redraw with the previous search term
                                            } else {
                                                api.search("").draw();//Clear the search and table
                                            }
                                    }
                                });
                            },
                            columnDefs: [
                                ...
                                rowGroup: {
                                        dataSrc: ['SupplierName','PoNo','DocumentNo'],
                                            startRender: function ( rows, group,level) {
                                                var color = 'style="color:black;font-weight:bold;"';

                                                if(level===0){
                                                    return $('<tr ' + color + '/>')
                                                    .append('<th colspan="18" style="text-align:center;border:1px solid;background:#ccc; font-size:12px;"> Supplier: ' + group + '</th>')
                                                }
                                                else if(level==1){
                                                        var ga='';
                                                    switch (group) {
                                                    ...
                                                    return $('<tr ' + color + '/>')
                                                    .append('<th colspan="18" style="text-align:left;border:0.1px solid;background:#f2f3f4;font-size:12px;">Reference: ' + ga + '</th>')
                                                }
                                                else{
                                                    return $('<tr ' + color + '/>')
                                                    .append('<th colspan="18" style="text-align:left;border:0.1px solid;background:#f2f3f4;font-size:12px;">' + group +  '</th>')
                                                }
                                            },
                                            ...
                                            .append('<th colspan="18" style="text-align:right;border: 1px solid black;background:#f2f3f4;font-size:12px;">Total Paid of '+group+': <b> '+numberendering(groupSum)+ ' </b></th>')
                                                ...
                                                const words = group.match(new RegExp(`\\b${letter}\\w*/\\d+-\\d+\\b`, 'gi'));
                                                    ...
                                                    rows.data().each(row => {
                                                            ...
                                                            var links = '<a href="#" onclick="viewpyrinformation('+pyrid+');"><u>'+words+'</u></a>';
                                                return $('<tr ' + color + '/>')
                                                .append('<th colspan="18" style="text-align:right;border: 1px solid black;background:#f2f3f4;font-size:12px;">Paid of Payment Request#: ' +links+': <b>'+ numberendering(groupSum) +'</b></th>');
                                                    }
                                                }
