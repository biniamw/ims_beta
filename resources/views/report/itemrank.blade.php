                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Sales Rank By Item Report</h3>
                            </div>
                                    ...
                                    <form id="profitandlossform">
                                        ...
                                        <div style="width:98%; margin-left:1%; margin-top:2%;">
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                                    <label strong style="font-size: 14px;">No. of Items</label>
                                                    <div>
                                                        <input type="number" placeholder="# of items" class="form-control" name="NumberOfItems" id="NumberOfItems" onkeypress="return ValidateOnlyNum(event);" onkeyup="numofitem()" ondrop="return false;" onpaste="return false;" />
                                                    </div>
                                                    <span class="text-danger">
                                                        <strong id="numofitem-error"></strong>
                                                    </span>
                                                </div>
                                                <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                        ...
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                                <div style="width:98%; margin-left:2%; margin-top:2%;">
                                                    <table id="itemrankdatatbl" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr id="daterangetr" style="display: none;">
                                                                <th colspan="10">
                                                                    <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Sales Rank By Item Report</b></p></h4>
                                                                </th>
                                                            </tr>
                                                            ...
                                                            <tr class="paymenttr" style="display: none;">
                                                                <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">Rank By</label></th>
                                                                <th colspan="2" style="border: 1px solid black;"><label id="selectedrankbylbl" strong style="font-size: 14px;"></label></th>
                                                                <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">Sort By</label></th>
                                                                <th colspan="4" style="border: 1px solid black;"><label id="selectedsortedbylbl" strong style="font-size: 14px;"></label></th>
                                                            </tr>
                                                            <tr class="paymenttr" style="display: none;">
                                                                <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">Point of Sales</label></th>
                                                                <th colspan="8" style="border: 1px solid black;text-align:left;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></th>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="width:15%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Category</th>
                                                                <th style="width:15%;color:white; border: 0.1px solid white;background-color:#00cfe8;">UOM</th>
                                                                <th style="width:15%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Sold Quantity</th>
...
<script type="text/javascript">
    ...
    $('#reportbutton').click(function() {
        ...
        var numofitemval = $('#NumberOfItems').val();
        var selectedstore="";
        var selecteditemgrp="";
        ...
        var rankbytotal="";
        var sortbytotal="";
        if(storeval==''||storeval=='0'||storeval==null||fiscalyears==''||fr==''||tr==''||itgrp == ''||paytype == ''||rankbyval == ''||sortbyval == ''||numofitemval == ''||numofitemval == '0'){
            ...
            if (numofitemval == '') {
                $('#numofitem-error').html('Number of items is required');
            }
            if (numofitemval == '0') {
                $('#numofitem-error').html('Number of items cannot be zero');
            }
            ...
            var table = $("#itemrankdatatbl").DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                paging: false,
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/itemranktbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+rankbyval+'/'+sortbyval+'/'+numofitemval,
                        type: 'POST',
                        dataType: "json",
                        beforeSend: function () { 
                            cardSection.block({
                    ...
                    columns: [{
                        ...
                        {
                            data: "ItemGroup", name: "ItemGroup",  width:"10%",
                        },
                        {
                            data: "CategoryName", name: "CategoryName", width:"10%",
                        },
                        {
                            data: "UOM", name: "UOM", width:"10%",
                        },
                        {
                            data: "QuantitySold", name: "QuantitySold", width:"12%",
                        },
                        {
                            data: "Revenue", name: "Revenue", width:"12%",
                        },
                        {
                            data: "GrossProfit",  name: "GrossProfit", width:"15%",
                        },
    ...
    $("#downloatoexcel").click(function(){
        ...
        let tbl = document.getElementById('itemrankdatatbl');
        ...
        $("#itemrankdatatbl").table2excel({
            name: "Worksheet Name",
            filename: "ItemRankReport "+datefrom+' to '+dateto, //do not include extension
    ...
    $('#printtable').click(function(){
        ...
        var divToPrint=document.getElementById("itemrankdatatbl");
        var htmlToPrint = '' +
            '<style type="text/css">' +
            'table th, table td {' +
