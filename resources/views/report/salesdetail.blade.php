...
<body>
        ...
        <h3><p style="text-align:center; margin:top:-10px;color:#00cfe8; font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Sales Detail Report</b></p></h3>

        <table id="t2" style="margin-bottom:10px;">
            <tr>
                <td style="width:17%">Date Range</td>
                <td style="font-weight:bold;">{{$from}} to {{$to}}</td>
                <td style="width:15%" rowspan="2">Point of Sales</td>
