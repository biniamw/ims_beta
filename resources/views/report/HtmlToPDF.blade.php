...
<body>
          ...
          <table id="t1" style="width:100%;border:none;border-collapse:collapse;cellspacing:0;cellpadding:0;">
              <tr style="border:none;">
                ...
                <td rowspan="4" style="width:15%;border:none;">
                   ...
                   // echo '<img src="data:image/jpeg;base64,' .base64_encode($compInfo->Logo).'" width="60" height="60" />';
                  // echo '<img src="data:image/jpeg;base64,'.base64_encode($compInfo->Logo).'"  width="60" height="60"/>';
        ...
        <h3><p style="text-align:center; margin:top:-10px;color:#00cfe8; font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>General Sales Report</b></p></h3>

        <table id="t2" style="margin-bottom:10px;">
            <tr>
                <td style="width:17%">Date Range</td>
                <td style="font-weight:bold;">{{$from}} to {{$to}}</td>
                <td style="width:15%">Point of Sales</td>
                <td style="font-weight:bold;">@foreach($storename as $storename) {{$storename->StoreName}} @endforeach</td>
            </tr>
            
            <tr>
                <td style="width:17%">Payment Type</td>
                <td style="font-weight:bold;">{{$paymentypes}}</td>
                <td style="width:15%">Item Group</td>
                <td style="font-weight:bold;">{{$itemgroups}}</td>
            </tr>
        </table>
