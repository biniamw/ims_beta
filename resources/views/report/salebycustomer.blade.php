                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Customer Sales Details Report</h3>
                        </div>
...
{    
    ...
    $.get('/salesdetailreportbycustomer/'+customer+'/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+itemgroup  , function (data) 
    {
    var link='/salesdetailreportbycustomer/'+customer+'/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+itemgroup;
