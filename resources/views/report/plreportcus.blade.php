                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Profit & Loss By Customer Report</h3>
                            </div>
                                                    ...
                                                    <table id="plreporttable" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr id="daterangetr" style="display: none;">
                                                                <th colspan="12">
                                                                    <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Profit & Loss By Customer Report</b></p></h4>
                                                                </th>
                                                            </tr>
...
<script type="text/javascript">
    ...
    $('#store').change(function() {
        ...
        var formData = registerForm.serialize();
        $.ajax({
            url:'getCusBySelectedStorePl/'+str+'/'+fy,
            type:'DELETE',
            data:formData,
            beforeSend: function () { 
                itemSection.block({
    ...
    $('#reportbutton').click(function() {
        ...
        var paymenttypevals="";
        var profitlosstype="";
        if(storeval==''||storeval=='0'||storeval==null||fiscalyears==''||fr==''||tr==''||itgrp == ''||paytype == ''||cust==''||pltype == ''){
            ...
            var table = $("#plreporttable").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/plreportcustbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+pltype,
                        type: 'POST',
                        dataType: "json",
                        data:{
                    ...
                    rowGroup: {
                        startRender: function ( rows, group,level ) {
                            ...
                            if(level===0){
                                ...
                                return $('<tr ' + color + '>')
                                .append('<td colspan="12" style="text-align:left;border:0.1px solid;">Customer : ' + group + '</td></tr>')
                            }                            
                        },
                        endRender: function (rows,group,level) {
                            ...
                            if(level===0){
                                return $('<tr ' + color + '/>')
                                .append('<td colspan="8" style="text-align:right;border:0.1px solid;">Total of ' + group+ ' </td><td style="border:0.1px solid;">'+numformat(revenueval.toFixed(2))+'</td><td style="border:0.1px solid;">'+numformat(cogsval.toFixed(2))+'</td><td style="border:0.1px solid;">'+numformat(grossprofitval.toFixed(2))+'</td><td style="border:0.1px solid;">'+numformat(profitmargin.toFixed(2))+' %</td>');     
                            } 
                            else if(level==1){
                                return $('<tr ' + color + '/>')
                                .append('<td colspan="8" style="text-align:right;border:0.1px solid;">Total of ' + group+ ' </td><td style="border:0.1px solid;">'+numformat(revenueval.toFixed(2))+'</td><td style="border:0.1px solid;">'+numformat(cogsval.toFixed(2))+'</td><td style="border:0.1px solid;">'+numformat(grossprofitval.toFixed(2))+'</td><td style="border:0.1px solid;">'+numformat(profitmargin.toFixed(2))+' %</td>');     
                        ...
                        dataSrc: ['StoreName','PaymentType','CustomerName']
                    },
    ...
    $("#downloatoexcel").click(function(){
        ...
        name: "Worksheet Name",
        filename: "Profit&LossReportbyCustomers "+datefrom+' to '+dateto, //do not include extension
