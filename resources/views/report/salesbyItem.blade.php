                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Sales By Item Report</h3>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                            <label strong style="font-size: 14px;color">Items</label>
                                             <div>
                                                <select class="form-control" id="item" multiple="multiple">
...
{    
    ...
    $.get('/salesdetailreportbyitem/'+item+'/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+itemgroup  , function (data) 
    {
    var link='/salesdetailreportbyitem/'+item+'/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+itemgroup;
    window.open(link, 'Sales by Item', 'width=1400,height=800,scrollbars=yes');
    });
    }
