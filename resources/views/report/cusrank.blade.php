                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Sales Rank By Customer Report</h3>
                            </div>
                                                    ...
                                                    <table id="cusrankdatatbl" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr class="paymenttr" style="display: none;">
                                                                ...
                                                                <th colspan="3" style="border: 1px solid black;"><label id="selectedsortedbylbl" strong style="font-size: 14px;"></label></th>
                                                            </tr>
                                                            <tr class="paymenttr" style="display: none;">
                                                                <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">Point of Sales</label></th>
                                                                <th colspan="6" style="border: 1px solid black;text-align:left;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></th>
                                                            </tr>
                                                            <tr>
...
<script type="text/javascript">
    ...
    $('#reportbutton').click(function() {
        ...
        var rankbytotal="";
        var sortbytotal="";
        if(storeval==''||storeval=='0'||storeval==null||fiscalyears==''||fr==''||tr==''||itgrp == ''||paytype == ''||rankbyval == ''||sortbyval == ''||numofcusval == ''||numofcusval == '0'){
            ...
            var table = $("#cusrankdatatbl").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/cusranktbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+rankbyval+'/'+sortbyval+'/'+numofcusval,
                        type: 'POST',
                        dataType: "json",
                        beforeSend: function () { 
                            cardSection.block({
    ...
    $("#downloatoexcel").click(function(){
        ...
        $("#cusrankdatatbl").table2excel({
            name: "Worksheet Name",
            filename: "CustomerRankReport "+datefrom+' to '+dateto, //do not include extension
