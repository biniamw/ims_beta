                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Sales Deduct Withold & VAT Report</h3>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                            <label strong style="font-size: 14px;color">Customer</label>
                                             <div>
                                                <select class="form-control" id="customer" multiple="multiple">
                                        ...
                                        <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                            <label strong style="font-size: 14px;color">Settlement Status</label>
                                            <div>   
...
{    
    ...
    var customer=$('#customer').val();   
     ...
     {
        $( '#status-error' ).html('Item group is required');
     }
    ...
    $.get('/witholdandvatreport/'+customer+'/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+status  , function (data) 
    {
    var link='/witholdandvatreport/'+customer+'/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+status;
    window.open(link, 'Sales by Customer', 'width=1200,height=800,scrollbars=yes');
    });
    }
