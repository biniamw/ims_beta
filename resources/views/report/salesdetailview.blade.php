...
{    
    ...
    $.get('/salesdetailreportmain/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+customer  , function (data) 
    {
    var link='/salesdetailreportmain/'+$fr+'/'+$tr+'/'+storeval+'/'+paymenttype+'/'+customer;
    window.open(link, 'SalesDetail', 'width=1400,height=800,scrollbars=yes');
    });
    }
