                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Profit & Loss General Report</h3>
                            </div>
                                                    ...
                                                    <table id="plreporttable" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr id="daterangetr" style="display: none;">
                                                                <th colspan="12">
                                                                    <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Profit & Loss General Report</b></p></h4>
                                                                </th>
                                                            </tr>
    ...
    $('#reportbutton').click(function() {
            ...
            var table = $("#plreporttable").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/plreportbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+pltype,
                        type: 'POST',
                        dataType: "json",
                        beforeSend: function () { 
                            cardSection.block({
                    ...
                    rowGroup: {
                        startRender: function ( rows, group,level ) {
                            ...
                            if(level===0){
                                ...
                                return $('<tr style="color:black" >')
                                .append('<td colspan="12" style="text-align:center;border: 0.1px solid;"><b>Payment Type : ' + group + '</b></td></tr>')
                            }
                            else{
                                return $('<tr ' + color + '>')
                        ...
                        endRender: function (rows,group,level) {
                            ...
                            var numberenderings = $.fn.dataTable.render.number( ',', '.', 2, ).display;
                            var color = 'style="color:black;font-weight:bold;background:#f2f3f4;"';
                            if(level===0){
                                return $('<tr ' + color + '/>')
                                .append('<td colspan="8" style="text-align:right;border:0.1px solid;">Total of ' + group+ ' </td><td style="border:0.1px solid;">'+numberenderings(revenueval)+'</td><td style="border:0.1px solid;">'+numberenderings(cogsval)+'</td><td style="border:0.1px solid;">'+numberenderings(grossprofitval)+'</td><td style="border:0.1px solid;">'+numberenderings(profitmargin)+' %</td>');     
                            } 
                            else if(level==1){
                                return $('<tr ' + color + '/>')
                                .append('<td colspan="8" style="text-align:right;border:0.1px solid;">Total of ' + group+ ' </td><td style="border:0.1px solid;">'+numberenderings(revenueval)+'</td><td style="border:0.1px solid;">'+numberenderings(cogsval)+'</td><td style="border:0.1px solid;">'+numberenderings(grossprofitval)+'</td><td style="border:0.1px solid;">'+numberenderings(profitmargin)+' %</td>');     
                    ...
                    "footerCallback": function ( row, data, start, end, display ) {
                        ...
                        var tf='<tr style="color:black;"><td colspan="8" class="text-right" style="color: black; font-weight:bold;border:0.1px solid;background:#f2f3f4;">Grand Total</td>'+
                                '<td style="font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;">'+numberendering(revenuegt)+'</td>'+
                                '<td style="font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;">'+numberendering(cogsgt)+'</td>'+
                                '<td style="font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;">'+numberendering(grossprofitgt)+'</td>'+
                                '<td style="font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;">'+numberendering(profitmargingt)+' %</td>'+
                                '</tr>';
        ...
        $("#downloatoexcel").click(function(){
            ...
            $("#plreporttable").table2excel({
                name: "Worksheet Name",
                filename: "Profit&LossReport "+datefrom+' to '+dateto, //do not include extension
