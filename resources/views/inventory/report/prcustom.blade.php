                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">ERCA Purchase Report</h3>
                            </div>
                                        ...
                                        <div style="width:98%; margin-left:1%; margin-top:2%;">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-12 mb-2" id="storediv">
                                                    <label strong style="font-size: 14px;">Store/Shop</label>
                                                    <select class="selectpicker form-control" id="store" name="store[]" multiple data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Stores ({0})" onchange="storeVal()">
                                                    ...
                                                    <table id="itemsaleshistory" class="display table-bordered table-striped table-hover dt-responsive mb-0" style="width: 100%;color:black;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="width:9%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Supplier Name</th>
                                                                ...
                                                                <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Unit Cost</th>
                                                        ...
                                                        <tfoot>
                                                            <tr style="background-color: #f2f3f4">
                                                                <td colspan="8" style="text-align: right;border-color:black;">
                                                                    <label style="font-size: 16px;font-weight: bold;color:black;">Total</label>
                                                                </td>
                                                                <td style="border-color:black;">
                                                                    <label id="totalbeforetaxlbl" style="font-size: 16px;font-weight:bold;color:black;"></label>
                                                                </td>
                                                                <td style="border-color:black;">
                                                                    <label id="totaltaxlbl" style="font-size: 16px;font-weight: bold;color:black;"></label>
                                                                </td>
...
<script type="text/javascript">
    ...
    $("#downloatoexcel1").click(function(){
        ...
        $("#itemsaleshistory").table2excel({
            name: "Worksheet Name",
            filename: "PurchaseDataCollection", //do not include extension
    ...
    $(document).on('click', '#downloatoexcel', function() {
        ...
        const worksheet = workbook.addWorksheet('purchase_erca');
        ...
        const titleRow = worksheet.addRow(['ERCA Purchase Report']);
        ...
        workbook.xlsx.writeBuffer().then(function(buffer) {
            ...
            link.download = 'purchase_data.xlsx';
            link.click();
        });
    });
