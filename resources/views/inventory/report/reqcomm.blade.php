...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table> 
            ...
            <tr>
                <td colspan="3" class="headers doctitle"><b>Stock Requisition & Issue Voucher</b></td>
            </tr>
            <tr>
                <td style="width: 55%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 38%;" class="bordertables"><b>Requisition Doc. No.</b></td>
                                <td style="width: 62%;" class="bordertables">{{$docnum}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="bordertables"><b>Buyer</b></td>
                                <td class="bordertables">{{$cusrecname}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Request Reason</b></td>
                                <td class="bordertables">{{$reqreason}}</td>
                            </tr>
                ...
                <td style="width: 45%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 45%;" class="bordertables"><b>Date</b></td>
                                <td style="width: 55%;" class="bordertables">{{$dateval}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Reference</b></td>
                                <td class="bordertables">{{$referenceno}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Booking No.</b></td>
                                <td class="bordertables">{{$bookingno}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="bordertables"><b>Labratory Location</b></td>
                                <td class="bordertables">{{$labstation}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    ...
                    <th style="width:6%" title="Production Certificate Number">Production Certificate No.</th>
                    <th style="width:5%" title="Export Certificate Number">Export Certificate No.</th>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 33%">
                                <table style="width: 100%">
                                    <tr>
                                        <td class="headers bordertables" style="height:15px;" colspan="2"><div style="height:15px;"><b>Reviewed By</b></div></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><b>Name: </b><u>{{$reviewedby}}</u></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><b>Date: </b><u>{{$revieweddate}}</u></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
