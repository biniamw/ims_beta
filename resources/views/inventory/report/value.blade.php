...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Inventory Value Report</h3>
                            </div>
                                   ...
                                   <div style="width:98%; margin-left:1%; margin-top:2%;">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-md-6 col-sm-12 mb-2" id="storediv">
                                                    ...
                                                    <select class="selectpicker form-control" id="store" name="store[]" data-live-search="true" multiple="multiple" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Stores/Shop ({0})"></select>
                                                    <span class="text-danger">
                            ...
                            <div class="card-datatable">
                                ...
                                <table id="balancetable" class="display" style="width: 100%;">
                                    <thead>
                                        ...
                                        <tr style="display: none;" class="compinfotr">
                                            <td colspan="12">
                                                <h3><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Inventory Value Report</b></p></h3>
                                            </td>
                                        </tr>
                                        <tr id="daterangetr" style="display: none;">
                                            <td colspan="2" style="border: 0.1px solid black;"><label strong style="font-size: 14px;">Fiscal Year</label></td>
                                            ...
                                            <td colspan="4" style="border: 0.1px solid black;"><label id="daterange" strong style="font-size: 14px;"></label></td>
                                        </tr>
                                        <tr id="titletr" style="display: none;">
                                            ...
                                            <td colspan="4" style="border: 1px solid black;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></td>
                                        ...
                                        <tr id="paymenttr" style="display: none;">
                                            <td colspan="12" style="color:black; border-bottom-color: white;background-color:white;"></td>
                                        </tr>
                                        <tr>
    ...
    $("#downloatoexcel").click(function(){
        ...
        name: "Worksheet Name",
        filename: "InventoryValueReport"+datefrom+' to '+dateto, //do not include extension
    ...
    $('#store').change(function() {
        ...
        var formData = registerForm.serialize();
        $.ajax({
            url:'getItemsBySelectedStore/'+stores+'/'+fy,
            type:'DELETE',
            data:formData,
            beforeSend: function () { 
                itemSection.block({
    ...
    {    
        ...
        {   
            ...
            var table = $("#balancetable").DataTable({
                ...
                searchHighlight: true,
                    ...
                    ajax: {
                        ...
                        url: '/valuereports/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears,
                        type: 'POST',
                        dataType: "json",
                        data:{
                    ...
                    rowGroup: {
                        ...
                        .append('<td colspan="9" style="text-align:center;border: 0.1px solid black; background:#ccc;font-size:12px;"><b>Category of : ' + group + '</b></td></tr>')
                        }
                        else{
                            return $('<tr ' + color + '>')
                            .append('<td colspan="9" style="text-align:left;border:0.1px solid;font-size:12px;">' + group + '</td></tr>')
                        }  
                    },
                ...
                if(level===0){
                    ...
                    .append('<td style="text-align:left;border:0.1px solid;font-size:12px;"></td>')
                    .append('<td style="text-align:left;border:0.1px solid;font-size:12px;">' + numformat(totalvalue.toFixed(2))+'</td></tr>'); 
                }
                else{
                    return $('<tr ' + color + '/>')
                    .append('<td colspan="7" style="text-align:right;border:0.1px solid;font-size:12px;">Total of : '+group+' Item</td>')
                    .append('<td style="text-align:left;border:0.1px solid;font-size:12px;">' + numformat(totalquantity.toFixed(2))+'</td>')
                    .append('<td style="text-align:left;border:0.1px solid;font-size:12px;">' + numformat(totalvalue.toFixed(2))+'</td></tr>');
                }        
            }, 
            ...
            allcogs = api
                ...
                '<td style="text-align: left; font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;font-size:12px;"></td>'+
                '<td style="text-align: left; font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;font-size:12px;">'+numformat(allvalue.toFixed(2))+'</td>'+
                '</tr>';
