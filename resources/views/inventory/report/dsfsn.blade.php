...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">DS FSN <i>(Fast-Moving,Slow-Moving,Non-Moving)</i> Analysis Report</h3>
                            </div>
                                     ...
                                     @csrf
                                        <div style="width:98%; margin-left:1%; margin-top:2%;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 col-md-6 col-sm-12 mb-2 itemdiv" id="itemdiv">
                                            ...
                                            <div class="table-responsive">
                                               <table id="fsntable" class="table" style="width: 100%;">
                                                    <thead>
                                                        ...
                                                        <tr style="display: none;" class="compinfotr">
                                                            <td colspan="13">
                                                                <h3><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>DS FSN Analysis Report</b></p></h3>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="titletr" style="display: none;">
                                                            <th style="border: 1px solid black;"><label strong style="font-size: 14px;">PullOut Type</label></th>
                                                            <th colspan="4" style="border: 1px solid black;"><label id="potypelbl" strong style="font-size: 14px;"></label></th>
                                                            <td colspan="3" style="border: 0.1px solid black;"><label strong style="font-size: 14px;">Item Group</label></td>
                                                            <td colspan="5" style="border: 1px solid black;"><label id="itemgrp" strong style="font-size: 14px;"></label></td>
                                                        </tr>
                                                        <tr id="paymenttr" style="display: none;">
                                                            <td style="border: 0.1px solid black;"><label strong style="font-size: 14px;">FSN Classification</label></td>
                                                            <td colspan="4" style="border: 1px solid black;"><label id="fsnclassification" strong style="font-size: 14px;"></label></td>
                                                            <td colspan="3" style="border: 0.1px solid black;"><label strong style="font-size: 14px;">Store/Shop</label></td>
                                                            <td colspan="5" style="border: 1px solid black;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></td>
                                                        </tr>
                                                        <tr>
    ...
    $(document).ready(function () 
    {
        ...
        $.ajax({
            url:'dsgetStoreBySelectedFyearFsn/'+fy,
            type:'DELETE',
            data:formData,
    ...
    $('#store').change(function() {
        ...
        var formData = registerForm.serialize();
        $.ajax({
            url:'dsgetItemsBySelectedStoreFsn/'+stores+'/'+fy,
            type:'DELETE',
            data:formData,
            beforeSend: function () { 
                itemSection.block({
    ...
    {    
        ...
        if(storeval==''||fiscalyears==''||items==''||fr==''||tr==''||itemsgrp==''||fsnclassification==''||potype == ''){
            if(storeval=='')
            {
            ...
            var table = $("#fsntable").DataTable({
                ...
                contentType: false, 
                    ...
                    ajax: {
                        ...
                        url: '/dsfsnreport/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears,
                        type: 'POST',
                        data:{
