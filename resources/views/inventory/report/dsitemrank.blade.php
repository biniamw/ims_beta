                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">DS Sales Rank By Item Report</h3>
                            </div>
                                    ...
                                    <form id="profitandlossform">
                                        ...
                                        <div style="width:98%; margin-left:1%; margin-top:2%;">
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                                    <label strong style="font-size: 14px;">Number of Items</label>
                                                    <div>
                                                    ...
                                                    <table id="itemrankdatatbl" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr id="daterangetr" style="display: none;">
                                                                <th colspan="10">
                                                                    <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>DS Sales Rank By Item Report</b></p></h4>
                                                                </th>
                                                            </tr>
...
<script type="text/javascript">
    ...
    $('#reportbutton').click(function() {
        ...
        if(storeval==''||storeval=='0'||storeval==null||fiscalyears==''||fr==''||tr==''||itgrp == ''||paytype == ''||rankbyval == ''||sortbyval == ''||numofitemval == ''||numofitemval == '0'||potype == ''){
            ...
            var table = $("#itemrankdatatbl").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/dsitemranktbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+rankbyval+'/'+sortbyval+'/'+numofitemval,
                        type: 'POST',
                        dataType: "json",
                        data:{
    ...
    $("#downloatoexcel").click(function(){
        ...
        $("#itemrankdatatbl").table2excel({
            name: "Worksheet Name",
            filename: "DSItemRankReport "+datefrom+' to '+dateto, //do not include extension
