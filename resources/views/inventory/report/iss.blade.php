...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table>
            <tr>
                <td colspan="3" class="headers doctitle"><b>Stock Issue Voucher / SIV</b></td>
            </tr>
            <tr>
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 55%;" class="bordertables"><b>Issue Document No.</b></td>
                                <td style="width: 45%;" class="bordertables">{{$docnum}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Requistion Document No.</b></td>
                                <td class="bordertables"><a href="req/{{$trid}}" target="popup">{{$reqdocnum}}</a></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 40%;"  class="bordertables"><b>Source Store/Shop</b></td>
                                <td style="width: 60%;" class="bordertables">{{$storename}}</td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                            <td>
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2" class="bordertablessign"><b>Date: </b><u>{{$requesteddate}}</u></td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                            ...
                            <td>
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><b>Name: </b>_______________</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="bordertablessign"><b>Date: </b>_______________</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
