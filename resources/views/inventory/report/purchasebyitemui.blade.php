...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Purchase By Item Report</h3>
                            </div>
                            <div class="card-datatable">
                                <div style="width:100%;">
                                    <div style="width:100%;">
                                        <div style="width:99.5%; margin-left:0.5%; margin-top:2%;">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                                    <label strong style="font-size: 14px;color">Items</label>
                                                    <div>
                                                        <select class="selectpicker form-control" id="item" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Items ({0})" onchange="clearitemsval()">
                                                ...
                                                <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                                    ...
                                                    <div>
                                                        <select class="selectpicker form-control" id="store" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Stores/Shop ({0})" onchange="clearstoreval()">
                                    ...
                                    <div class="col-xl-12 col-md-6 col-sm-12 mb-2">
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                                <table id="ipurchasetable" class="table" style="width: 100%;color:black;">
                                                    <thead>
                                                        ...
                                                        <tr id="daterangetr" style="display: none;">
                                                            <th colspan="11">
                                                                <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>Purchase By Supplier Report</b></p></h4>
                                                            </th>
                                                        </tr>
                                                        ...
                                                        <tr style="color:black; border: 0.1px solid white;">
                                                            ...
                                                            <th style="width:10%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Payment Type</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">UOM</th>
                                                            <th style="width:10%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Store/Shop Name</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Quantity</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Unit Cost</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Sub Total</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Tax</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Total Cost</th>
    ...
    $("#downloatoexcel").click(function(){
        ...
        let tbl = document.getElementById('ipurchasetable');
        ...
        $("#ipurchasetable").table2excel({
        name: "Worksheet Name",
        filename: "PurchaseByItemReport"+fr+' to '+tr, //do not include extension
    ...
    $('#printtable').click(function(){
        ...
        var divToPrint=document.getElementById("ipurchasetable");
        var htmlToPrint = '' +
            '<style type="text/css">' +
            'table th, table td {' +
    ...
    $(function() {
        ...
        $('#reportbutton').click(function() {
            ...
            var table = $("#ipurchasetable").DataTable({
            destroy: true,
            processing: true,
            serverSide: true,
            paging: false,
            ...
            responsive:true,
                ...
                ajax: {
                    ...
                    url: '/purchasebyitem/'+ fr + '/' + tr + '/' + storeval + '/' + paymenttype,
                    type: 'POST',
                    data:{
                        itemnames: $('#item').val(),
                    },
                ...
                rowGroup: {
                            ...
                            .append('<td colspan="11" style="text-align:center;border: 0.1px solid black; background:#ccc;"><b>' + group + ' Purchase </b></td></tr>')
                                ...
                                return $('<tr ' + color + '>')
                                .append('<td colspan="11" style="text-align:left;border:0.1px solid;">Supplier : ' + group + '</td></tr>')
                            }   
                },
            ...
            grandtotal = api
                ...
                // calculate total cash and credit sales
                    var totalcash = api.column(7)
                        .data()
                        .reduce(function (a, b) {
                                var cur_index = api.column(7).data().indexOf(b);
                                if (api.column(2).data()[cur_index] == "Cash") {
                                return intVal(a) + intVal(b);
                            }
                            else { return intVal(a); }
                        }, 0);
                        var totalcredit = api.column(7)
                        .data()
                        .reduce(function (a, b) {
                                var cur_index = api.column(7).data().indexOf(b);
                                if (api.column(2).data()[cur_index] == "Credit") {
                                return intVal(a) + intVal(b);
                            }
                            else { return intVal(a); }
                        }, 0);
                    // calculate tax cash and credit sales
                    var taxcash = api.column(8)
                        .data()
                        .reduce(function (a, b) {
                        ...
                        var grandtotalcash = api.column(9)
                        .data()
                        .reduce(function (a, b) {
                        ...
                        var grandtotalcredit = api.column(9)
                        .data()
                        .reduce(function (a, b) {
                                var cur_index = api.column(9).data().indexOf(b);
                                if (api.column(2).data()[cur_index] == "Credit") {
