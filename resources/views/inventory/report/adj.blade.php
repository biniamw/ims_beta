...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table>
            <tr>
                <td colspan="3" class="headers doctitle"><b>Adjustment Voucher</b></td>
            </tr>
            <tr>
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 50%;" class="bordertables"><b>Document Number</b></td>
                                <td style="width: 50%;" class="bordertables">{{$docnum}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Adjustment Type</b></td>
                                <td class="bordertables">{{$type}} <b>(-)</b></td>
                            </tr>
                            <tr>
                ...
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 25%;" class="bordertables"><b>Store/Shop</b></td>
                                <td style="width: 75%;" class="bordertables">{{$storename}}</td>
                            </tr>
                            {{-- <tr>
                            ...
                            <tr>
                                ...
                                <td class="bordertables">{{$reqdate}}</td>
                            </tr>
                            <tr>
                                <td style="width: 30%;" class="bordertables"><b>Memo</b></td>
                                <td style="width: 70%;" class="bordertables">{{$memo}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table style="width: 100%" class="headers bordertables">
            <thead>
                <tr>
                    ...
                    <th style="width: 14%;text-align: center" class="bordertables">Item Code</th>
                    <th style="width: 25%;text-align: center" class="bordertables">Item Name</th>
                    <th style="width: 13%;text-align: center" class="bordertables">SKU No.</th>
                    <th style="width: 9%;text-align: center" class="bordertables">UOM</th>
                    <th style="width: 8%;text-align: center" class="bordertables">Stock Out</th>
                    <th style="width: 8%;text-align: center" class="bordertables">Value</th>
                    <th style="width: 8%;text-align: center" class="bordertables">Total Value</th>
                    <th style="width: 9%;text-align: center" class="bordertables">Reason</th>
                    <th style="width: 15%;text-align: center" class="bordertables">Remark</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tr>           
                ...
                <td style="text-align: center" class="bordertables">{{$item->StockOut}}</td>
                <td style="text-align: center" class="bordertables">{{$item->StockOutUnitCost}}</td>
                <td style="text-align: center" class="bordertables">{{$item->StockOutBeforeTaxCost}}</td>
            ...
            <tfoot>
                <tr>
                    <td colspan="7" style="text-align: right;" class="bordertables"><b>Sub Total</b></td>
                    <td colspan="3" style="text-align: left;" class="bordertables">{{$totalvals}}</td>
                </tr>
            </tfoot>
        </table>
        <br/>
                        ...
                        <tr>
                            <td>
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><b>Name: </b><u>{{$adjustedby}}</u></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="bordertablessign"><b>Date: </b><u>{{$reqdate}}</u></td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td>
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><b>Name: </b><u>{{$confirmby}}</u></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="bordertablessign"><b>Date: </b><u>{{$confirmdate}}</u></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="bordertablessign"><b>Signature: </b>____________________</td>
                                    </tr>
