...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table>
            <tr>
                <td colspan="3" class="headers doctitle"><b>Inventory Ending Note</b></td>
            </tr>
            <tr>
                <td colspan="3">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 50%;" class="bordertables"><b>IEN Number</b></td>
                                <td style="width: 50%;" class="bordertables"><b>Store/Shop</b></td>
                                <td style="width: 50%;" class="bordertables"><b>Fiscal Year</b></td>
                                <td style="width: 30%;" class="bordertables"><b>Date</b></td>
                                
                            </tr>
                            <tr>
                                <td style="width: 50%;" class="bordertables">{{$docnum}}</td>
                                <td style="width: 50%;" class="bordertables">{{$storename}}</td>
                                <td style="width: 50%;" class="bordertables">{{$fiscalyear}}</td>
                                <td style="width: 70%;" class="bordertables">{{$date}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    ...
                    <th style="width: 15%;text-align: center" class="bordertables">SKU No.</th>
        ...
        <table>
            <tr>
                <td colspan="2"></td>
                <td style="text-align: right;"><b>Total Value : </b><label style="font-size: 16px;" id="totalcostvallbl"><u>{{$prices}}</u></label></td>
            </tr>
            <tr>
                <td colspan="3">
                    <table style="width: 100%">
