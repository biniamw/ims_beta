                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Purchase By Supplier Report</h3>
                        </div>
                                    ...
                                    <div style="width:98%; margin-left:1%; margin-top:2%;">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-6 col-sm-12 mb-2">
                                                ...
                                                <div>
                                                    <select class="selectpicker form-control" id="customer" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Suppliers ({0})" onchange="clearsupplierval()">
                                    ...
                                    <div class="col-xl-12 col-md-6 col-sm-12 mb-2">
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                                <table id="spurchasetable" class="table" style="width: 100%;color:black;">
                                                    <thead>
...
$("#downloatoexcel").click(function(){
    ...
    let tbl = document.getElementById('spurchasetable');
    ...
    // $("#spurchasetable").table2excel({
    //     name: "Worksheet Name",
    //     filename: "PurchaseBySupplierReport"+fr+' to '+tr, //do not include extension
...
$('#printtable').click(function(){
        ...
        var divToPrint=document.getElementById("spurchasetable");
        var htmlToPrint = '' +
            '<style type="text/css">' +
            'table th, table td {' +
...
{    
    ...
    var selectedptype="";
    var customerid="";
    if(customer==''||storeval==''||paymenttype==''){
        if(customer=='')
        {
    ...
    {   
        ...
        var table = $("#spurchasetable").DataTable({
            destroy: true,
            processing: true,
            serverSide: true,
            paging: false,
            ...
            responsive:true,
                ...
                ajax: {
                    ...
                    url: '/purchasebysupplier/'+ fr + '/' + tr + '/' + storeval + '/' + paymenttype,
                    type: 'POST',
                    data:{
