                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Stock Value Report</h3>
                            </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div style="width: 99%;margin-left:0.5%; margin-top:0.5%;">
                                                <div class="table-responsive">
                                                    <table id="stockvaluereporttable" class="display table-bordered defaultdatatable nowrap" style="text-align:left;width: 100%">
                                                        <thead>
                                                            <tr style="color:white; border: 0.1px solid black;">
                                                                ...
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Store/ Station">Store/ Station</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Floor Map">Floor Map</th>
                                                                <th style="width:8%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Commodity Type">Commodity Type</th>
                                                                <th style="width:8%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Commodity">Commodity</th>
                                                                <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Grade">Grade</th>
                                                                <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Crop Year">Crop Year</th>
                                                                <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Process Type">Process Type</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="UOM/ Bag">UOM/ Bag</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Number of Bag">No. of Bag</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="TON">TON</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Feresula">Feresula</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Net KG">Net KG</th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Average Cost">Average Cost   <label id="unitcostdesc" style="color: #FFFFFF" title="Per Net KG"><i class="fa-solid fa-circle-info"></i></label></th>
                                                                <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Total Cost">Total Cost   <label id="totalcostdisc" style="color: #FFFFFF" title="Total Cost= Average Cost * Net KG"><i class="fa-solid fa-circle-info"></i></label></th>
                                                                <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;border-right:1px solid black" title="Allocated Amount">Allocated Amount <i>(by KG)</i></th>
                                                        ...
                                                        <tfoot style="font-size: 13px;background-color:#ccc;color:#000000">
                                                            <tr>
                                                                ...
                                                                <th id="reptotalavcost" style="text-align:left;padding-left:6px;border: 1px solid black;"></th>
                                                                <th id="reptotalvalue" style="text-align:left;padding-left:6px;border: 1px solid black;"></th>
                                                                <th id="reptotalallocated" style="text-align:left;padding-left:6px;border: 1px solid black;"></th>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
...
@endcan
    ...
    <!--Start Cost History Information Modal -->
    <div class="modal modal-slide-in event-sidebar fade" id="detailcostmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true" style="overflow-y: scroll;">
        <form id="DetailCostHitoryForm">
        {{ csrf_field() }}
            <div class="modal-dialog sidebar-xl" style="width:98%;">
                <div class="modal-content p-0">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #ea5455 !important;font-weight:bold;">x</button>
                    <div class="modal-header">
                        <h4 class="modal-title">Cost History Information</h4>
                        <div style="text-align: center;padding-right:30px;">
                            <button id="printcosttable" type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-info waves-effect btn-sm" title="Print the entire item table"><i class="fa-solid fa-print fa-lg" aria-hidden="true"></i></button>
                            <button id="downloadcosttoexcel" type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-info waves-effect btn-sm" title="Export the entire table to excel"><i class="fa-solid fa-file-excel fa-lg" aria-hidden="true"></i></button>
                            <button id="downloadcosttopdf" type="button" class="btn btn-icon btn-icon rounded-circle btn-flat-info waves-effect btn-sm" title="Export the entire table to pdf"><i class="fa-solid fa-file-pdf fa-lg" aria-hidden="true"></i></button>
                    ...
                    <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <section id="collapsible">
                                        <div class="card collapse-icon">
                                            <div class="collapse-default">
                                                <div class="card">
                                                    <div id="headingCollapse0" class="card-header" data-toggle="collapse" role="button" data-target=".infocost" aria-expanded="false" aria-controls="collapse0">
                                                        <span class="lead collapse-title">Commodity & Company Information</span>
                                                    </div>
                                                    <div id="collapse0" role="tabpanel" aria-labelledby="headingCollapse0" class="collapse infocost">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-6" style="border-right-style: solid;border-right-color:rgba(34, 41, 47, 0.2);border-right-width: 1px;">
                                                                    <table style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 25%;"><label style="font-size: 14px;">Commodity</label></td>
                                                                            <td style="width: 75%;"><label id="cstorigininfolbl" style="font-size:14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><label style="font-size: 14px;"></label></td>
                                                                            <td><label id="cstuominfolbl" style="font-size:14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-6">
                                                                    <table id="customerinfotbl" class="customerinfotbl" style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 25%"><label style="font-size: 14px;">Customer Code</label></td>
                                                                            <td style="width: 75%"><label id="cstinfocustomercode" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><label style="font-size: 14px;">Customer Name</label></td>
                                                                            <td><label id="cstinfocustomername" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><label style="font-size: 14px;">Customer TIN</label></td>
                                                                            <td><label id="cstinfocustomertin" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><label style="font-size: 14px;">Customer Phone</label></td>
                                                                            <td><label id="cstinfocustomerphone" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><label style="font-size: 14px;">Customer Email</label></td>
                                                                            <td><label id="cstinfocustomeremail" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <table id="costdetailtbl" class="display table-bordered table-striped table-hover dt-responsive mb-0 infodatatbl" style="width: 100%">
                                        <thead>         
                                            <tr>
                                                <th style="width:2%;" title="No.">#</th>
                                                <th style="width:5%;" title="Floor Map">Store/ Station</th>
                                                <th style="width:5%;" title="Floor Map">Floor Map</th>
                                                <th style="width:5%;" title="Commodity Type">Commodity Type</th>
                                                <th style="width:5%;" title="Commodity">Commodity</th>
                                                <th style="width:4%;" title="Grade">Grade</th>
                                                <th style="width:5%;" title="Crop Year">Crop Year</th>
                                                <th style="width:5%;" title="Process Type">Process Type</th>
                                                <th style="width:5%;" title="UOM/ Bag">UOM/ Bag</th>
                                                <th style="width:5%;" title="Number of Bag">No. of Bag</th>
                                                <th style="width:4%;" title="TON">TON</th>
                                                <th style="width:5%;" title="Feresula">Feresula</th>
                                                <th style="width:5%;" title="Net KG">Net KG</th>
                                                <th style="width:5%;" title="Unit Cost">Unit Cost <label id="unitcostdesc" title="Per Net KG"><i class="fa-solid fa-circle-info"></i></label></th>
                                                <th style="width:5%;" title="Total Cost">Total Cost <label id="totalcostdesc" title="Total Cost= Net KG * Unit Cost"><i class="fa-solid fa-circle-info"></i></label></th>
                                                <th style="width:5%;" title="Running Average Cost">Running Average Cost</th>
                                                <th style="width:5%;" title="Transaction Type">Transaction Type</th>
                                                <th style="width:5%;" title="Transaction Type Document Number">Document No.</th>
                                                <th style="width:5%;" title="Purchase Order Number">PO No.</th>
                                                <th style="width:5%;" title="Purchase Invoice Number">PIV No.</th>
                                                <th style="width:5%;" title="Transaction Date">Date</th>
                                            </tr>
                                        </thead>
                                        <tbody class="table table-sm"></tbody>
                                        <tfoot>
                                            <tr style="background-color: #cccccc;color:#000000;font-size:16px;">
                                                ...
                                                <th id="reptotalnumberofbag" style="text-align:left;"></th>
                                                <th id="reptotalton" style="text-align:left;"></th>
                                                <th id="reptotalferesula" style="text-align:left;"></th>
                                                <th id="reptotalnetkg" style="text-align:left;"></th>
                                                <th id="repunitcost" style="text-align:left;"></th>
                                                <th id="reptotalcost" style="text-align:left;"></th>
                    ...
                    <div class="modal-footer">
                        <button id="closebuttoncost" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        </form>
    </div>
    <!--End Cost History Information Modal -->
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('#printtable').click(function(){
            var divToPrintBody = document.getElementById("stockvaluereporttable");
                            ...
                            <table class="table table-sm" style="width:100%;border: none !important;">
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:center;vertical-align: middle;border: none !important;padding:2px;">
                                        <h3><p style="color:#00cfe8;padding-top:8px;"><b>Stock Value Report</b></p></h3>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        $("#downloatoexcel").click(function () {
            ...
            var table = document.getElementById("stockvaluereporttable");
            var workbook = new ExcelJS.Workbook();
            var worksheet = workbook.addWorksheet("Stock_Value_Report");

            let mergeCells = [];
            let maxColumnWidths = {}; // Store max column widths

            let titleRow = worksheet.addRow(["Stock Value Report ("+fromdate+" to "+todate+")"]);
            titleRow.font = { bold: true, size: 16, color: { argb: "000000" } };
            titleRow.alignment = { horizontal: "center", vertical: "middle" };

            worksheet.mergeCells(1, 1, 1, 16); // 🔹 Merge across all columns
            ...
            workbook.xlsx.writeBuffer().then((data) => {
                ...
                saveAs(blob,"Stock_Value_Report_from_"+fromdate+"_to_"+todate+".xlsx");
            });
        });
        ...
        $("#downloadtopdf").click(function () {
            ...
            $("#stockvaluereporttable thead tr").each(function () {
                let rowData = [];
            ...
            $("#stockvaluereporttable tbody tr").each(function (rowIndex) {
                let rowData = [];
            ...
            const titleText = "Stock Value Report ("+fromdate+" to "+todate+")";
            ...
            doc.save("Stock_Value_Report_from_"+fromdate+"_to_"+todate+".pdf");
        });
        ...
        $('#reportbutton').on('click', function() {
            var registerForm = $('#stockvaluereportform');
            var formData = registerForm.serialize();

            $.ajax({ 
                url: "{{url('stockValueReport')}}",
                type: 'POST',
                data: formData,
                beforeSend: function() {
                    cardSection.block({
                ...
                success: function(data) {
                    ...
                    if(data.success) {
                        ...
                        var table = $("#stockvaluereporttable").DataTable({ 
                            destroy: true,
                            processing: true,
                            serverSide: true,
                            paging: false,
                                ...
                                },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        if(parseFloat(data)==0){
                                            ...
                                            return '<a style="text-decoration:underline;color:blue;" onclick=openCostHistoryInfoFn("'+row.woredaId+'","'+row.StoreId+'","'+row.LocationId+'","'+row.CommTypeId+'","'+row.Grade+'","'+row.ProcessType+'","'+row.CropYear+'","'+row.uomId+'","'+row.customers_id+'",2)>'+numformat(parseFloat(data).toFixed(2))+'</a>';
                                        }
                                    },
                                    width:"6%" //13
                                },
                                ...
                                },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        if(parseFloat(data)==0){
                                            ...
                                            return '<a style="text-decoration:underline;color:blue;" onclick=openAllocModalFn("'+row.woredaId+'","'+row.StoreId+'","'+row.LocationId+'","'+row.CommTypeId+'","'+row.Grade+'","'+row.ProcessType+'","'+row.CropYear+'","'+row.uomId+'","'+row.customers_id+'")>'+numformat(parseFloat(data).toFixed(2))+'</a>';
                                        }
                                    },
                                    width:"6%" //15
                                },
                            ...
                            rowGroup: {
                                startRender: function ( rows, group,level ) {
                                    if(level===0){
                                        ...
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#ccc;"><td colspan="16" style="text-align:left;border:0.1px solid black;"><b>'+cusorowner+group+'</b></td></tr>');
                                    } 
                                    if(level===1){
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#f2f3f4;"><td colspan="16" style="text-align:center;border:0.1px solid black;"><b>Store/ Station: '+group+'</b></td></tr>');
                                    } 
                                    if(level===2){
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#f2f3f4;"><td colspan="16" style="text-align:left;border:0.1px solid black;"><b>Commodity Type: '+group+'</b></td></tr>');
                                    }
                                },
                                endRender: function ( rows, group,level ) {
                                    ...
                                    if(level===0){
                                        ...
                                        return $('<tr style="color:#000000;background:#ccc">')
                                            ...
                                            .append('<td style="text-align:left;border:0.1px solid;"><b>'+ numformat(parseFloat(netkg).toFixed(2))+'</b></td>')
                                            .append('<td style="text-align:left;border:0.1px solid;"></td>')
                                            .append('<td style="text-align:left;border:0.1px solid;"><b>'+ numformat(parseFloat(totalvalue).toFixed(2))+'</b></td>')
                                            .append('<td style="text-align:left;border:0.1px solid;"><b>'+ numformat(parseFloat(allocatedqty).toFixed(2))+'</b></td>')
                                            .append('</tr>'); 
                                    }
                                    if(level===1){
                                ...
                                dataSrc: ['CustomerOwner','StoreName','CommodityType']
                            },
                            "footerCallback": function ( row, data, start, end, display ) {
                                ...
                                $('#reptotalnetkg').html(totalnetkg === 0 ? '' : numformat(parseFloat(totalnetkg).toFixed(2)));
                                $('#reptotalvalue').html(totalvaluefooter === 0 ? '' : numformat(parseFloat(totalvaluefooter).toFixed(2)));
                                $('#reptotalallocated').html(totalallocationqty === 0 ? '' : numformat(parseFloat(totalallocationqty).toFixed(2)));
                                ...
                                $(api.column(15).footer()).html(totalallocationqty.toLocaleString());
                            },
                            drawCallback: function(settings) {
                                ...
                                api.rows({ page: 'current', search: 'applied' }).every(function() {
                                    ...
                                    if (rowData) {
                                        var group = rowData['CustomerOwner','StoreName','CommodityType']; // Assuming 'group_column' is the name of the column used for grouping
        ...
        function openCostHistoryInfoFn(comm,str,flrmap,commtype,grade,prctype,crpyr,uomid,cusid,flag){
            let fiscalyearpost="";
            let startdatepost="";
            let enddatepost="";
            let companytypepost="";
            let customerorownerpost="";
            let storepost="";
            let producttypepost="";
            let commoditytypepost="";
            let commoditypost="";
            let gradepost="";
            let processtypepost="";
            let cropyearpost="";
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data.orgdata, function(key, value) {
                        $('#cstorigininfolbl').html(value.Origin);
                        $('#cstorigininfolbl').html(value.Origin);
                        $('#cstuominfolbl').html("");
                    });

                    $.each(data.customerdata, function(key, value) {
                        $('#cstinfocustomercode').html(value.CustomerCode);
                        $('#cstinfocustomername').html(value.CustomerName);
                        $('#cstinfocustomertin').html(value.TinNumber);
                        $('#cstinfocustomerphone').html(value.PhoneNumber+",    "+value.OfficePhone);
                        $('#cstinfocustomeremail').html(value.EmailAddress);
            ...
            var costdttable = $("#costdetailtbl").DataTable({ 
                destroy: true,
                processing: true,
                serverSide: true,
                paging: false,
        ...
        $('#printcosttable').click(function(){
            var divToPrintBody = document.getElementById("costdetailtbl");
            var htmlToPrint = `<html>
                <head>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <table class="table table-sm" style="width:100%;border: none !important;">
                                <tr>
                                    <td colspan="7" style="text-align:center;vertical-align: middle;border: none !important;padding:2px;">
                                        <h3><p style="color:#00cfe8;padding-top:8px;"><b>Cost History</b></p></h3>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        $("#downloadcosttoexcel").click(function () {
            let commodityname=$("#cstorigininfolbl").text();
            commodityname = commodityname.replace(/,+(?=[a-zA-Z])/g, ''); // remove comma in front of the word (if any)

            var table = document.getElementById("costdetailtbl");
            var workbook = new ExcelJS.Workbook();
            var worksheet = workbook.addWorksheet("Cost_History");

            let mergeCells = [];
            let maxColumnWidths = {}; // Store max column widths

            let titleRow = worksheet.addRow(["Cost History of "+commodityname]);
            titleRow.font = { bold: true, size: 16, color: { argb: "000000" } };
            titleRow.alignment = { horizontal: "center", vertical: "middle" };
            ...
            workbook.xlsx.writeBuffer().then((data) => {
                ...
                saveAs(blob,"Cost_History_of_"+commodityname+".xlsx");
            });
        });

        $("#downloadcosttopdf").click(function () {
            let commodityname=$("#cstorigininfolbl").text();
            commodityname = commodityname.replace(/,+(?=[a-zA-Z])/g, ''); // remove comma in front of the word (if any)
            ...
            // Get headers (handling colspan for headers)
            $("#costdetailtbl thead tr").each(function () {
                let rowData = [];
                let headerMerge = []; // Store merge info for headers
            ...
            // Get body data (handling colspan)
            $("#costdetailtbl tbody tr").each(function (rowIndex) {
                let rowData = [];
                let colIndexOffset = 0;
            ...
            $("#costdetailtbl tfoot tr").each(function (rowIndex) {
                let rowData = [];
                let colIndexOffset = 0;
            ...
            const pageWidth = doc.internal.pageSize.width;
            const titleText = "Cost History of "+commodityname;
            const textWidth = doc.getStringUnitWidth(titleText) * doc.internal.getFontSize() / doc.internal.scaleFactor;
            const xCoordinate = (pageWidth - textWidth) / 2;  // Centering the text
            ...
            doc.save("Cost_History_of_"+commodityname+".pdf");
        });
