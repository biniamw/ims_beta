        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    ...
                    <th style="width: 13%;" class="bordertables">SKU No.</th>
                    <th style="width: 9%;" class="bordertables">UOM</th>
                    <th style="width: 8%;" class="bordertables">Stock In</th>
                    <th style="width: 8%;" class="bordertables">Value</th>
                    <th style="width: 8%;" class="bordertables">Total Value</th>
                    <th style="width: 9%;" class="bordertables">Reason</th>
            ...
            <tr>           
                ...
                <td style="text-align: center" class="bordertables">{{$item->StockIn}}</td>
