                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">General DS PullOut Report</h3>
                        </div>
                            ...
                            <div style="width:100%;">
                                <div style="width:98%; margin-left:1%; margin-top:2%;">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                            <label strong style="font-size: 14px;color">Payment Type</label>
                                                <div>
                                                    <select class="selectpicker form-control" id="paymenttype" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="({0})" onchange="clearptype()">
                                                        <option value='"--"'>--</option> 
                                        ...
                                        <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                            <label strong style="font-size: 14px;color">PullOut Type</label>
                                                <div>
                                        ...
                                        <div class="col-xl-2 col-md-6 col-sm-12 mb-2">
                                            <label strong style="font-size: 14px;color">Item Group</label>
                                                <div>
                                                    <select class="selectpicker form-control" id="itemgroup" multiple="multiple" data-live-search="true" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="({0})" onchange="clearitemgrp()">
                                                        <option disabled value=""></option> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7 col-md-6 col-sm-12 mt-2 mb-1">
                                               ...
                                               <table id="gpurchasetable" class="table" style="width: 100%;color:black;">
                                                    <thead>
                                                        ...
                                                        <tr id="daterangetr" style="display: none;">
                                                            <th colspan="10">
                                                                <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>General DS PullOut Report</b></p></h4>
                                                            </th>
                                                        </tr>
                                                        <tr id="titletr" style="display: none;">
                                                            ...
                                                            <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">PullOut Type</label></th>
                                                        ...
                                                        <tr id="paymenttr" style="display: none;">
                                                            ...
                                                            <th colspan="5" style="border: 1px solid black;"><label id="itemgrouphead" strong style="font-size: 14px;"></label></th>
                                                        </tr>
                                                        <tr id="storetr" style="display: none;">
                                                            <th colspan="2" style="border: 1px solid black;"><label strong style="font-size: 14px;">Store/Shop</label></th>
                                                            <th colspan="9" style="border: 1px solid black;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr style="color:white; border: 0.1px solid black;">
                                                            ...
                                                            <th style="width:10%;color:white; border: 0.1px solid white;background-color:#00cfe8;width:10%;">PullOut Type</th>
...
{    
    ...
    var selectedpotype="";
    var selecteditemgr="";
    if(storeval==''||paymenttype==''||itemgroup==''||potypevar==''){
        if(storeval=='')
        {
        ...
        if(itemgroup=='')
        {
            $( '#itemgroup-error' ).html('Item group field is required');
        }
        if(potypevar=='')
        {
            $( '#potype-error' ).html('PullOut type field is required');
        }
    ...
    {   
        ...
        $('#itemgrouphead').html('<b>'+selecteditemgr+'</b>');
            var table = $("#gpurchasetable").DataTable({
                ...
                info: true, 
                    ...
                    ajax: {
                        ...
                        url: '/dspogenreport/' + fr + '/' + tr + '/' + storeval + '/' + paymenttype+'/'+itemgroup+'/'+potypevar,
                        type: 'DELETE',
                        dataType: "json",
                        beforeSend: function () { 
                            cardSection.block({
                    ...
                    startRender: function ( rows, group,level ) {
                        ...
                        if(level===0){
                            ...
                            .append('<td colspan="11" style="text-align:center;border: 0.1px solid black; background:#ccc;"><b>' + group + ' PullOut </b></td></tr>')
                        }
                        else if(level==1){
                            return $('<tr ' + color + '>')
                    ...
                    if(level===0){
                        return $('<tr ' + color + '/>')
                        .append('<td colspan="9" style="text-align:right;border:0.1px solid;">Total of  :   ' + group+ ' PullOut</td>') 
                        .append('<td style="text-align:center;border:0.1px solid;">'+ numformat(totalcost.toFixed(2))+'</td>');    
                    }  
                    else if(level==1){
                        return $('<tr ' + color + '/>')
                        .append('<td colspan="9" style="text-align:right;border:0.1px solid;">Total of  :   ' + group+ ' Payment Type</td>') 
                        .append('<td style="text-align:center;border:0.1px solid;">'+ numformat(totalcost.toFixed(2))+'</td>');    
                    }  
                    else{
                        return $('<tr ' + color + '/>')
            ...
            var intVal = function ( i ) {
                ...
                var grandtotalnull = api
                .cells( function ( index, data, node ) {
                    return api.row( index ).data().Type === 'Disposal' ?
                        true : false;
                }, 9 )
                .data()
                .reduce( function (a, b) {
                ...
                var tf='<tr style="color:black;"><td colspan="9" class="text-right" style="color: black;background:#f2f3f4; font-weight:bold;border:0.1px solid;">Total Disposal PullOut</td>'+
                '<td style="text-align: center; font-weight:bold; color:black;border:0.1px solid;background:#f2f3f4;">'+numformat(grandtotalnull.toFixed(2))+'</td>'+
                '</tr>'+
                '<tr style="color:black;"><td colspan="9" class="text-right" style="color: black; font-weight:bold;border:0.1px solid;background:#f2f3f4;">Total External PullOut</td>'+
                ...
                '</tr>'+
                '<tr style="color:black;"><td colspan="9" class="text-right" style="color: black;background:#f2f3f4; font-weight:bold;border:0.1px solid;">Total Internal PullOut</td>'+
    ...
    $("#downloatoexcel").click(function(){
        ...
        name: "Worksheet Name",
        filename: "GeneralDSPullOutReport"+fr+' to '+tr, //do not include extension
