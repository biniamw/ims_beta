...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Store Balance Report</h3>
                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-6 col-sm-12 mb-2">
                                        <div style="width: 100%;">
                                            <div class="table-responsive">
                                               <table id="balancetable" class="table" style="width: 100%;">
                                                    <thead>
                                                        ...
                                                        <tr id="daterangetr" style="display: none;">
                                                            ...
                                                            <td colspan="3" style="border: 0.1px solid black;"><label id="fiscalyearlbl" strong style="font-size: 14px;"></label></td>
                                                        ...
                                                        <tr id="titletr" style="display: none;">
                                                            ...
                                                            <td colspan="3" style="border: 1px solid black;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></td>
                                                        ...
                                                        <tr id="paymenttr" style="display: none;">
                                                            <td colspan="10" style="color:black; border-bottom-color: white;background-color:white;"></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <th style="width:5%;color:white; border:0.1px solid white;background-color:#00cfe8;">Retailer Price</th>
                                                            <th style="width:5%;color:white; border:0.1px solid white;background-color:#00cfe8;">Wholeseller</th>
    ...
    $("#downloatoexcel").click(function(){
        ...
        $("#balancetable").table2excel({
            name: "Worksheet Name",
            filename: "StoreBalanceReport"+datefrom+' to '+dateto, //do not include extension
            ...
            $('#itemgrp').html('<b>'+itemgroupsv+'</b>');
                ...
                contentType: false, 
                    ...
                    ajax: {
                        ...
                        url: '/balances/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears,
                        type: 'POST',
                        data:{
                    ...
                    rowGroup: {
                            ...
                            return $('<tr ' + color + '/>')
                            .append('<td colspan="10" style="text-align:center;border:0.1px solid;"> ' + group + '</td>')
                    },
                ...
                var color = 'style="color:black;font-weight:bold;background:#f2f3f4;"';
                return $('<tr ' + color + '/>')
                    .append('<td colspan="10" style="text-align:right;border:0.1px solid;">Total of ' + group+ ' : ' + numformat(totalquantity)+'</td>');     
            }, 
            dataSrc: 'ItemName'
            },
            });
