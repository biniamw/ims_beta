            ...
            <tr>
                <td style="width: 60%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 40%;" class="bordertables"><b>Transfer Document No.</b></td>
                                <td style="width: 60%;" class="bordertables">{{$docnum}}</td>
                            </tr>
                            
                            <tr>
                                <td class="bordertables"><b>Source Store/Shop</b></td>
                ...
                <td style="width: 40%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 25%;" class="bordertables"><b>Date</b></td>
                                <td style="width: 75%;" class="bordertables">{{$reqdate}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Reason</b></td>
                                <td style="border-bottom-color: black;" class="bordertables">{{$reason}}</td>
                            </tr>
                            <tr>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    ...
                    <th style="width: 10%;" class="bordertables">Item Name</th>
                    <th style="width: 10%;" class="bordertables">SKU No.</th>
                    <th style="width: 10%;" class="bordertables">UOM</th>
                    <th style="width: 10%;" class="bordertables">Requested Qty.</th>
                    <th style="width: 10%;" class="bordertables">Approved Qty.</th>
                    <th style="width: 10%;" class="bordertables">Issued Qty.</th>
                    <th style="width: 12%;" class="bordertables">Request Remark</th>
                    <th style="width: 13%;" class="bordertables">Approve Remark</th>
                </tr>
            </thead>
            ...
            <tr>           
                ...
                <td style="text-align: center" class="bordertables">{{$item->ApprovedQuantity}}</td>
                <td style="text-align: center" class="bordertables">{{$item->IssuedQuantity}}</td>
                <td style="text-align: center" class="bordertables">{{$item->Memo}}</td>
                <td style="text-align: center" class="bordertables">{{$item->ApprovedMemo}}</td>
            </tr>
            @endforeach
        </table>
        <br/>
                        ...
                        <tr>
                            <td style="width: 25%">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><b>Date: </b><u>{{$reqdatetime}}</u></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width: 25%">
