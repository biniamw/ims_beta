                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">DS Profit & Loss General Report</h3>
                            </div>
                                                    ...
                                                    <table id="plreporttable" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr id="daterangetr" style="display: none;">
                                                                <th colspan="13">
                                                                    <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>DS Profit & Loss General Report</b></p></h4>
                                                                </th>
                                                            </tr>
                                                            ...
                                                            <tr class="paymenttr" style="display: none;">
                                                                ...
                                                                <th colspan="10" style="border: 1px solid black;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></th>                                                          </tr>
                                                            <tr>
...
<script type="text/javascript">
    ...
    $('#reportbutton').click(function() {
        ...
        if(storeval==''||storeval=='0'||storeval==null||fiscalyears==''||fr==''||tr==''||itgrp == ''||paytype == ''||pltype == ''||potype == ''){
            ...
            var table = $("#plreporttable").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/dsplreportbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+pltype,
                        type: 'POST',
                        dataType: "json",
                        data:{
                    ...
                    rowGroup: {
                        startRender: function ( rows, group,level ) {
                            ...
                            if(level===0){
                                ...
                                return $('<tr style="color:black" >')
                                .append('<td colspan="13" style="text-align:center;border: 0.1px solid;"><b>' + group + '   PullOut</b></td></tr>')
                            }
                            else if(level==2){
                                return $('<tr style="color:black" >')
                                .append('<td colspan="13" style="text-align:left;border: 0.1px solid;"><b>Payment Type : ' + group + '</b></td></tr>')
                            }
                            else{
                                return $('<tr ' + color + '>')
                                .append('<td colspan="13" style="text-align:left;border: 0.1px solid;">Category : ' + group + '</td></tr>')
                            }                            
                        },
                        ...
                        dataSrc: ['StoreName','POType','PaymentType','CategoryName']
                    },
        ...
        $("#downloatoexcel").click(function(){
            ...
            $("#plreporttable").table2excel({
                name: "Worksheet Name",
                filename: "DSProfit&LossReport "+datefrom+' to '+dateto, //do not include extension
