...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table> 
            <tr>
                <td colspan="3" class="headers doctitle"><b>Inventory Begining Note</b></td>
            </tr>
            <tr>
                <td colspan="3">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 20%;text-align: center" class="bordertables"><b>IBN #</b></td>
                                <td style="width: 20%;text-align: center" class="bordertables"><b>Ending #</b></td>
                                <td style="width: 20%;text-align: center" class="bordertables"><b>Store/Shop</b></td>
                                <td style="width: 25%;text-align: center" class="bordertables"><b>Fiscal Year</b></td>
                                <td style="width: 15%;text-align: center" class="bordertables"><b>Date</b></td>
                                
                            </tr>
                            <tr>
                                <td style="text-align: center" class="bordertables">{{$docnum}}</td>
                                <td style="text-align: center" class="bordertables">{{$begnum}}</td>
                                <td style="text-align: center" class="bordertables">{{$storename}}</td>
                                <td style="text-align: center" class="bordertables">{{$fiscalyear}}</td>
                                <td style="text-align: center" class="bordertables">{{$date}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    <th style="width: 6%;text-align: center" class="bordertables">#</th>
                    <th style="width: 12%;text-align: center" class="bordertables">Item Code</th>
                    <th style="width: 20%;text-align: center" class="bordertables">Item Name</th>
                    <th style="width: 15%;text-align: center" class="bordertables">SKU Number</th>
                    <th style="width: 9%;text-align: center" class="bordertables">UOM</th>
                    <th style="width: 12%;text-align: center" class="bordertables">Store/Shop Name</th>
                    <th style="width: 8%;text-align: center" class="bordertables">Qty.</th>
                    <th style="width: 13%;text-align: center" class="bordertables">Unit Cost</th>
                    <th style="width: 15%;text-align: center" class="bordertables">Total Cost</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tr>           
                ...
                <td style="text-align: center" class="bordertables">{{$item->UnitCost}}</td>
                <td style="text-align: center" class="bordertables">{{$item->BeforeTaxCost}}</td>
            </tr>
            @endforeach
            </tbody>
        </table>
        ...
        <table>
            <tr>
                <td></td>
                <td colspan="2" style="text-align: right;"><b>Total Value : </b><label style="font-size: 16px;" id="totalcostvallbl"><u>{{$prices}}</u></label></td>
            </tr>
            <tr>
                <td colspan="3">
                    <table style="width: 100%">
            ...
            <tr>
                <td style="width: 30%">
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td colspan="2" class="bordertablessign"><b>Name: </b><u>{{$adjustedby}}</u></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="bordertablessign"><b>Date: </b><u>{{$adjusteddate}}</u></td>
                        </tr>
                    </table>
                </td>
