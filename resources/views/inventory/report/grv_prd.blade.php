...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table>
            <tr>
                <td colspan="2" class="headers doctitle"><b>Good Receiving Voucher / GRV</b></td>
            </tr>
            <tr>
                <td style="width: 50%;">
                    ...
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr class="headerHeight">
                                <td class="headers bordertables" style="height:20px;" colspan="2"><div style="height:20px;"><b>Production Information</b></div></td>
                            </tr>
                            <tr>
                                <td style="width: 34%" class="bordertables"><b>Production No.</b></td>
                                <td style="width: 66%" class="bordertables">{{$productiono}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Requisition No.</b></td>
                                <td class="bordertables">{{$requisitiono}}</td>
                            </tr>
                            <tr>
                ...
                <td style="width: 50%;">
                    <table style="width: 100%" class="bordertables">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 34%" class="bordertables"><b>GRV No.</b></td>
                                <td style="width: 66%" class="bordertables">{{$docnum}}</td>
                            </tr>
                            <tr>
