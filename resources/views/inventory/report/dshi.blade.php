...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table>
            <tr>
                <td colspan="2" class="headers doctitle"><b>Direct Stock-IN Voucher</b></td>
            </tr>
            <tr>
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            ...
                            <tr>
                                <td class="bordertables"><b>Supplier</b></td>
                ...
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            @if($sales->Type == 1)
                            <tr>
                                <td style="width: 41%;" class="bordertables"><b>Payment Type</b></td>
                                <td style="width: 59%;" class="bordertables">{{$sales->PaymentType}}</td>
                            </tr>
                            @endif
                            @if($sales->Type != 1)
                            <tr>
                                <td class="bordertables"><b>Source Station</b></td>
                                <td class="bordertables">{{$storename}}</td>
                            </tr>
                            @endif
                            <tr>
                                <td class="bordertables"><b>{{$sales->Type == 1 ? 'Station' : 'Destination Station'}}</b></td>
                                <td class="bordertables">{{$dsstoreName}}</td>
                            </tr>
                            <tr>
        ...
        <table style="width: 100%" class="headers bordertables">
            <thead>
                <tr>
                    ...
                    <th style="width: 15%;text-align: center" class="bordertables">Barcode No.</th>
                    <th style="width: 10%;text-align: center" class="bordertables">Quantity</th>
                    @if($sales->Type == 1)
                    <th style="width: 10%;text-align: center" class="bordertables">Unit Cost</th>
                    <th style="width: 12%;text-align: center" class="bordertables">Total Cost</th>
                    @endif
                    <th style="width: 10%;text-align: center" class="bordertables">Remark</th>
                </tr>
            </thead>
            ...
            @if($sales->Type == 1)
            <tr>
                <td colspan="6" class="bordertables" style="text-align: right;">Total</td>
                <td class="bordertables">{{$subTotal}}</td>
            </tr>
            @endif
        </table>
        <br/>
        <div>Remark:  <u>{{$memo}}</u></div>
        <br/>
        <table style="width: 100%">
            <tr>
                <td>
                        ...
                        <tr>
                            <td style="width: 33%">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><b>Name: </b><u>{{$sales->Username}}</u></td>
                                    </tr>
                                    <tr>
                            ...
                            <td style="width: 33%">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><b>Name: </b><u>{{$sales->ReceivedBy}}</u></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="bordertablessign"><b>Date: </b><u>{{$sales->ReceivedDate}}</u></td>
                                    </tr>
                                </table>
                            </td>
                        </tr> 
