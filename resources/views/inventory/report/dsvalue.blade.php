...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">DS Inventory Value Report</h3>
                            </div>
                                ...
                                <div style="width:100%;">
                                    ...
                                    <div style="width:98%; margin-left:1%; margin-top:2%;">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input type="text" id="date" name="date" class="form-control form-control-sm" placeholder="YYYY-MM-DD" onchange="dateVal()" readonly="true" />
                                                    </div>
                                                    <span class="text-danger">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-12 mb-2" id="storediv">
                                                    ...
                                                    <select class="selectpicker form-control" id="store" name="store[]" data-live-search="true" multiple="multiple" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" data-selected-text-format="count" data-count-selected-text="Store/Shop ({0})">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-5 col-md-6 col-sm-12 mb-2 itemdiv" id="itemdiv">
                                                    <label strong style="font-size: 14px;color">Item(s)</label>
                                                    <select class="selectpicker form-control" id="itemsv" name="itemsv[]" data-live-search="true" multiple="multiple" data-style="btn btn-outline-secondary waves-effect" data-actions-box="true" onchange="clearitemsval()" data-selected-text-format="count" data-count-selected-text="Items ({0})"></select>
                                                    <span class="text-danger">
                    ...
                    <div class="col-12">
                         <div class="card" id="valuecard" style="display: none;">
                            <div class="card-datatable">
                                ...
                                <table id="balancetable" class="display" style="width: 100%;">
                                    <thead>
                                        ...
                                        <tr style="display: none;" class="compinfotr">
                                            <td colspan="12">
                                                <h3><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>DS Inventory Value Report</b></p></h3>
                                            </td>
                                        </tr>
                                        <tr id="daterangetr" style="display: none;">
                                            <td colspan="2" style="border: 0.1px solid black;"><label strong style="font-size: 14px;">Date Range</label></td>
                                            <td colspan="3" style="border: 0.1px solid black;"><label id="daterange" strong style="font-size: 14px;"></label></td>
                                            <td colspan="2" style="border: 0.1px solid black;"><label strong style="font-size: 14px;">Item Group</label></td>
                                            <td colspan="5" style="border: 1px solid black;"><label id="itemgrouplbl" strong style="font-size: 14px;"></label></td>
                                        </tr>
                                        <tr id="paymenttr" style="display: none;">
                                            <td colspan="2" style="border: 0.1px solid black;"><label strong style="font-size: 14px;">Store/Shop</label></td>
                                            <td colspan="10" style="border: 1px solid black;"><label id="selectedstorelbl" strong style="font-size: 14px;"></label></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Average Cost</th>
                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Available Quantity</th>
                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Inventory Value</th>
                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">Number of Sold Goods</th>
                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;">COGS</th>
                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;display:none;">Category</th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot><tr></tr></tfoot>
    ...
    $("#downloatoexcel").click(function(){
        ...
        $("#balancetable").table2excel({
        name: "Worksheet Name",
        filename: "DSInventoryValueReport"+datefrom+' to '+dateto, //do not include extension
    ...
    $('#printtable').click(function(){
        ...
        var divToPrint=document.getElementById("balancetable");
        var htmlToPrint = '' +
            '<style type="text/css">' +
            'table th, table td {' +
    ...
    $('#store').change(function() {
        ...
        var formData = registerForm.serialize();
        $.ajax({
            url:'getDsItemsBySelectedStore/'+stores,
            type:'DELETE',
            data:formData,
            beforeSend: function () { 
                itemSection.block({
    ...
    {    
        ...
        var itemnames="";
        var itemgroupsv="";
        if(storeval==''||fiscalyears==''||items==''||fr==''||tr==''||itemsgrp==''){
            if(storeval=='')
            {
        ...
        {   
            ...
            $('#fiscalyearlbl').html('<b>'+fiscalyears+'</b>');
            $('#selectedstorelbl').html('<b>'+selectedstore+'</b>');
            $('#itemgrouplbl').html('<b>'+itemgroupsv+'</b>');
            var table = $("#balancetable").DataTable({
                ...
                searchHighlight: true,
                    ...
                    ajax: {
                        ...
                        url: '/dsvaluereports/' + fr + '/' + tr + '/' + storeval,
                        type: 'POST',
                        dataType: "json",
                        data:{
                    ...
                    rowGroup: {
                        ...
                        .append('<td colspan="11" style="text-align:center;border: 0.1px solid black; background:#ccc;font-size:12px;"><b>Category of : ' + group + '</b></td></tr>')
                        }
                        else{
                            return $('<tr ' + color + '>')
                            .append('<td colspan="11" style="text-align:left;border:0.1px solid;font-size:12px;">' + group + '</td></tr>')
                        }  
                    },
                ...
                if(level===0){
                    return $('<tr ' + color + '/>')
                    .append('<td colspan="7" style="text-align:right;border:0.1px solid;font-size:12px;">Total of : '+group+' Category</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalquantity.toFixed(2))+'</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalvalue.toFixed(2))+'</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalsold.toFixed(2))+'</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalcogs.toFixed(2))+'</td></tr>');  
                }
                else{
                    return $('<tr ' + color + '/>')
                    .append('<td colspan="7" style="text-align:right;border:0.1px solid;font-size:12px;">Total of : '+group+' Item</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalquantity.toFixed(2))+'</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalvalue.toFixed(2))+'</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalsold.toFixed(2))+'</td>')
                    .append('<td style="text-align:center;border:0.1px solid;font-size:12px;">' + numformat(totalcogs.toFixed(2))+'</td></tr>');  
            ...
            allcogs = api
                ...
                .reduce( function (a, b) {
                 ...
                 var tf='<tr style="color:black;"><td colspan="7" class="text-right" style="color: black; font-weight:bold;border:0.1px solid;background:#f2f3f4;font-size:12px;">Total </td>'+
                '<td style="text-align: center; font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;font-size:12px;">'+numformat(allquantity.toFixed(2))+'</td>'+
                '<td style="text-align: center; font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;font-size:12px;">'+numformat(allvalue.toFixed(2))+'</td>'+
                '<td style="text-align: center; font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;font-size:12px;">'+numformat(allsold.toFixed(2))+'</td>'+
                '<td style="text-align: center; font-weight:bold; color:black; border:0.1px solid;background:#f2f3f4;font-size:12px;">'+numformat(allcogs.toFixed(2))+'</td>'
                '</tr>';
