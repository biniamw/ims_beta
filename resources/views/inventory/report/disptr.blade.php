            ...
            <tr>
                <td style="width: 50%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 42%;" class="bordertables"><b>Dispatch Type</b></td>
                                <td style="width: 58%;" class="bordertables">{{$dispatch_type}}</td>
                            </tr>
                            <tr>
                                <td class="bordertables"><b>Document No.</b></td>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    ...
                    <th style="width:12%;">Barcode No.</th>
                    <th style="width:12%;">UOM</th>
                    <th style="width:12%;">Sold/ Issued Qty.</th>
            ...
            <tr>  
                ...
                <td style="text-align: center" class="bordertables">{{$item->SoldIssued}}</td>
                <td style="text-align: center" class="bordertables">{{$item->DispatchedQnt}}</td>
