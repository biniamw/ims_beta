...
<html lang="en" data-textdirection="ltr">
    ...
    <body>
        ...
        <table>
            <tr>
                <td colspan="3" class="headers doctitle"><b>Inventory Begining Note / IBN</b></td>
            </tr>
            <tr>
                <td colspan="3" style="width: 100%;">
                    <table style="width: 100%;" class="bordertables">
                        <tbody>
                            <tr>
                                <td style="width: 15%;text-align: center" class="bordertables"><b>IBN #</b></td>
                                <td style="width: 15%;text-align: center" class="bordertables"><b>Ending #</b></td>
                                <td style="width: 18%;text-align: center" class="bordertables"><b>Store/Shop</b></td>
                                <td style="width: 25%;text-align: center" class="bordertables"><b>Fiscal Year</b></td>
                                <td style="width: 13%;text-align: center" class="bordertables"><b>Date</b></td>
                                <td style="width: 13%;text-align: center" class="bordertables"><b>Status</b></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: center" class="bordertables">{{$status}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    <th style="width: 8%;text-align: center" class="bordertables">#</th>
                    ...
                    <th style="width: 18%;text-align: center" class="bordertables">SKU Number</th>
                    ...
                    <th style="width: 15%;text-align: center" class="bordertables">Unit Cost</th>
                </tr>
            </thead>
