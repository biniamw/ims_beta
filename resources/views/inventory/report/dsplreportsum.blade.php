                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">DS Profit & Loss By Point of Sales Report</h3>
                            </div>
                                                        ...
                                                        <table id="plreporttable" class="table" style="width: 100%;color:black;">
                                                            <thead>
                                                                ...
                                                                <tr id="daterangetr" style="display: none;">
                                                                    <th colspan="5">
                                                                        <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>DS Profit & Loss By Point of Sales Report</b></p></h4>
                                                                    </th>
                                                                </tr>
                                                                ...
                                                                <tr class="paymenttr" style="display: none;">
                                                                    ...
                                                                    <th colspan="1" style="border: 1px solid black;"><label id="potypelbl" strong style="font-size: 14px;"></label></th>
                                                                </tr>
                                                                <tr class="paymenttr" style="display: none;">
                                                                    <th colspan="1" style="border: 1px solid black;"><label strong style="font-size: 14px;">Item Group</label></th>
                                                                    <th colspan="2" style="border: 1px solid black;text-align:left;"><label id="itemgrouplbl" strong style="font-size: 14px;"></label></th>
...
<script type="text/javascript">
            ...
            var table = $("#plreporttable").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/dsplreporsumtbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears+'/'+itgrp+'/'+paytype+'/'+pltype,
                        type: 'POST',
                        dataType: "json",
                        data:{
    ...
    $("#downloatoexcel").click(function(){
        ...
        $("#plreporttable").table2excel({
            name: "Worksheet Name",
            filename: "DSProfit&LossReportbyPointofSales  "+datefrom+' to '+dateto, //do not include extension
