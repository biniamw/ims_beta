                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <select class="selectpicker form-control" id="referencedefault" name="referencedefault" title="Select reference here..." data-style="btn btn-outline-secondary waves-effect" data-live-search="true">
                                                    @foreach ($referece as $referece)
                                                        <option value="{{ $referece->DataVal }}" title="{{$referece->DataProp }}">{{ $referece->ReferenceNo }}</option>
                                                    @endforeach    
                                                </select>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <div style="width: 99%;margin-left:0.5%; margin-top:0.5%;">
                                            <div class="table-responsive">
                                                <table id="stockbalancereporttable" class="display table-bordered defaultdatatable nowrap" style="text-align:left;width: 100%">
                                                    <thead>
                                                        ...
                                                        <tr style="color:white; border: 0.1px solid black;">
                                                            ...
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Transaction Type">Transaction Type</th>
                                                            <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Supplier Name and TIN">Supplier</th>
                                                            <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Reference Number">Reference No.</th>
                                                            <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Store/ Station">Store/ Station</th>
                                                            <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Floor Map">Floor Map</th>
                                                            <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Commodity Type">Commodity Type</th>
                                                            <th style="width:7%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Commodity">Commodity</th>
                                                            ...
                                                            <th style="width:%;color:white; border: 0.1px solid white;background-color:#00cfe8;border-right:1px solid black" title="Allocated Amount">Allocated Amount<i>(by KG)</i></th>
                                                    ...
                                                    <tfoot style="font-size: 13px;background-color:#ccc;color:#000000">
                                                        <tr>
                                                            <th colspan="12" style="text-align: right;border: 1px solid black;">Grand Total</th>
...
@endcan
    ...
    <script type="text/javascript">
        ...
        $('#printtable').click(function(){
            var divToPrintBody = document.getElementById("stockbalancereporttable");
                            ...
                            <table class="table table-sm" style="width:100%;border: none !important;">
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:center;vertical-align: middle;border: none !important;padding:2px;">
                                        <h3><p style="color:#00cfe8;padding-top:8px;"><b>Stock Balance Report</b></p></h3>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        $("#downloatoexcel").click(function () {
            ...
            var table = document.getElementById("stockbalancereporttable");
            var workbook = new ExcelJS.Workbook();
            var worksheet = workbook.addWorksheet("Stock_Balance_Report");

            let mergeCells = [];
            let maxColumnWidths = {}; // Store max column widths

            let titleRow = worksheet.addRow(["Stock Balance Report ("+fromdate+" to "+todate+")"]);
            titleRow.font = { bold: true, size: 16, color: { argb: "000000" } };
            titleRow.alignment = { horizontal: "center", vertical: "middle" };

            worksheet.mergeCells(1, 1, 1, 17); // 🔹 Merge across all columns
            ...
            workbook.xlsx.writeBuffer().then((data) => {
                ...
                saveAs(blob,"Stock_Balance_Report_from_"+fromdate+"_to_"+todate+".xlsx");
            });
        });
        ...
        $("#downloadtopdf").click(function () {
            ...
            $("#stockbalancereporttable thead tr").each(function () {
                let rowData = [];
            ...
            $("#stockbalancereporttable tbody tr").each(function (rowIndex) {
                let rowData = [];
            ...
            const titleText = "Stock Balance Report ("+fromdate+" to "+todate+")";
                ...
                didParseCell: function (data) {
                    if (data.row.section === "body"){
                        mergeCells.forEach(function (merge) {
                            ...
                            if(parseInt(data.cell.colSpan)==12){
            ...
            doc.save("Stock_Balance_Report_from_"+fromdate+"_to_"+todate+".pdf");
        });
        ...
        $('#reportbutton').on('click', function() {
            var registerForm = $('#stockbalancereportform');
            var formData = registerForm.serialize();

            $.ajax({ 
                url: "{{url('stockBalanceReport')}}",
                type: 'POST',
                data: formData,
                beforeSend: function() {
                    cardSection.block({
                ...
                success: function(data) {
                    ...
                    if(data.success) {
                        ...
                        var table = $("#stockbalancereporttable").DataTable({ 
                            destroy: true,
                            processing: true,
                            serverSide: true,
                            paging: false,
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        ...
                                        else if(row.TransactionsType=="Beginning" || row.TransactionsType==="Beginning"){
                                        ...
                                        else if(row.TransactionsType=="Production" || row.TransactionsType==="Production"){
                                ...
                                },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        if(parseFloat(data)==0){
                                            ...
                                            return '<a style="text-decoration:underline;color:blue;" onclick=openAllocModalFn("'+row.woredaId+'","'+row.StoreId+'","'+row.LocationId+'","'+row.CommType+'","'+row.Grade+'","'+row.ProcessType+'","'+row.CropYear+'","'+row.uomId+'","'+row.customers_id+'","'+row.CustomTransactionType+'","'+row.GrnNumber+'","'+row.PrdNumber+'","'+row.CertNo+'")>'+numformat(parseFloat(data).toFixed(2))+'</a>';
                                        }
                                    },
                                    width:"6%"
                                },
                            ...
                            rowGroup: {
                                startRender: function ( rows, group,level ) {
                                    if(level===0){
                                        ...
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#ccc;"><td colspan="17" style="text-align:left;border:0.1px solid black;"><b>'+cusorowner+group+'</b></td></tr>');
                                    } 
                                    if(level===1){
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#f2f3f4;"><td colspan="17" style="text-align:center;border:0.1px solid black;"><b>Store/ Station: '+group+'</b></td></tr>');
                                    } 
                                    if(level===2){
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#f2f3f4;"><td colspan="17" style="text-align:left;border:0.1px solid black;"><b>Commodity Type: '+group+'</b></td></tr>');
                                    }
                                },
                                endRender: function ( rows, group,level ) {
                                    ...
                                    if(level===0){
                                        ...
                                        return $('<tr style="color:#000000;background:#ccc">')
                                            .append('<td colspan="12" style="text-align:right;border:0.1px solid;"><b>'+cusorowner + '</b></td>') 
                                            ...
                                            .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(parseFloat(allocatedqty).toFixed(2))+'</td>')
                                            .append('</tr>'); 
                                    }
                                    if(level===1){
                                        return $('<tr style="color:#000000;background:#f2f3f4">')
                                            .append('<td colspan="12" style="text-align:right;border:0.1px solid;"><b>Total of : ' + group+ '</b></td>') 
                                            .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(parseFloat(numofbag).toFixed(0))+'</td>')
                                            .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(parseFloat(netkg).toFixed(2))+'</td>')
                                            .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(parseFloat(ton).toFixed(2))+'</td>')
                                            .append('<td style="text-align:left;border:0.1px solid;">'+ numformat(parseFloat(feresula).toFixed(2))+'</td>')
                            ...
                            "footerCallback": function ( row, data, start, end, display ) {
                                ...
                                $(api.column(12).footer()).html(totalnumofbag.toLocaleString());
                                $(api.column(13).footer()).html(totalnetkg.toLocaleString());
                                $(api.column(14).footer()).html(totalton.toLocaleString());
                                $(api.column(15).footer()).html(totalferesula.toLocaleString());
                                $(api.column(16).footer()).html(totalallocationqty.toLocaleString());
                            },
