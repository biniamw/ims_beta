...
<style>
    ...
    <body>
        ...
        <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    <th style="width:2%;" class="bordertables">#</th>
                    <th style="width:6%;" class="bordertables">Floor Map</th>
                    <th style="width:6%;" class="bordertables">Type</th>
                    <th style="width:8%" class="bordertables">Commodity</th>
                    <th style="width:6%" class="bordertables">Grade</th>
                    <th style="width:6%" class="bordertables">Process Type</th>
                    <th style="width:6%" class="bordertables">Crop Year</th>
                    <th style="width:6%" class="bordertables">UOM/ Bag</th>
                    <th style="width:6%" class="bordertables">No. of Bag</th>
                    <th style="width:6%" class="bordertables">Bag Weight by KG</th>
                    <th style="width:6%" class="bordertables">Total KG</th>
                    <th style="width:6%" class="bordertables">Net KG</th>
                    <th style="width:6%" class="bordertables">Feresula<label id="feresulainfolbl" title="Feresula= Net KG / 17"><i class="fa-solid fa-circle-info"></i></label></th>
                    <th style="width:6%" class="bordertables">TON<label id="feresulainfolbl" title="TON= Net KG / 1000"><i class="fa-solid fa-circle-info"></i></label></th>
                    <th style="width:6%" class="bordertables">Variance Shortage by KG</th>
                    <th style="width:6%" class="bordertables">Variance Overage by KG</th>
                    <th style="width:6%" class="bordertables">Remark</th>
            ...
            <tr>           
                ...
                <td style="text-align: center" class="bordertables">{{$comm->LocationName}}</td>
                <td style="text-align: center" class="bordertables">{{$comm->CommType}}</td>
                <td style="text-align: center" class="bordertables">{{$comm->Origin}}</td>
                <td style="text-align: center" class="bordertables">{{$comm->GradeName}}</td>
                <td style="text-align: center" class="bordertables">{{$comm->ProcessType}}</td>
                <td style="text-align: center" class="bordertables">{{$comm->CropYearData}}</td>
                <td style="text-align: center" class="bordertables">{{$comm->UomName}}</td>
                <td style="text-align: center" class="bordertables">{{number_format($comm->NumOfBag,0)}} </td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->BagWeight,2)}}</td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->TotalKg,2)}}</td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->NetKg,2)}}</td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->Feresula,2)}} </td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->WeightByTon,2)}}</td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->VarianceShortage,2)}} </td>
                <td style="text-align: center" class="bordertables"> {{number_format($comm->VarianceOverage,2)}}</td>
                <td style="text-align: center" class="bordertables"> {{$comm->Remark}}</td>
            </tr>
            {{$numofbag+=$comm->NumOfBag}}
            {{$bagwweight+=$comm->BagWeight}}
            {{$totalkg+=$comm->TotalKg}}
            {{$netkg+=$comm->NetKg}}
            {{$feresula+=$comm->Feresula}}
            {{$ton+=$comm->WeightByTon}}
            {{$varshortage+=$comm->VarianceShortage}}
            {{$varoverage+=$comm->VarianceOverage}}
            @endforeach
            </tbody>
            <tfoot>
                <tr>
