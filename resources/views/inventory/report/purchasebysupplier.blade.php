...
<head>
    ...
    <title>Purchase By Supplier</title>
    <style>
        table {
            width: 100%;
...
<body>
    <table id="t1" style="width:100%;border:none;border-collapse:collapse;cellspacing:0;cellpadding:0;">
        <tr style="border:none;">
            ...
            <td rowspan="4" style="width:15%;border:none;">
                <img src="data:image/png;base64,{{ chunk_split(base64_encode($compInfo->Logo)) }}" width="150"
                    height="150">
            </td>
        </tr>
        <tr>
    ...
    <table id="t2" style="margin-bottom:10px;">
        <tr>
            ...
            <td rowspan=2 style="width:15%">Store</td>
            <td rowspan=2 style="font-weight:bold;">@foreach ($storename as $storename) {{ $storename->StoreName }} @endforeach</td>
        </tr>
        <tr>
