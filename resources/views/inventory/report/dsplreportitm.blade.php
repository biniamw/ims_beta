                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">DS Profit & Loss By Item Report</h3>
                            </div>
                                                    ...
                                                    <table id="plreporttable" class="table" style="width: 100%;color:black;">
                                                        <thead>
                                                            ...
                                                            <tr id="daterangetr" style="display: none;">
                                                                <th colspan="13">
                                                                    <h4><p style="text-align:center; margin:top:-10px;color:#00cfe8;font-family: 'Segoe UI', Verdana, Helvetica, Sans-Serif;"><b>DS Profit & Loss By Item Report</b></p></h4>
                                                                </th>
                                                            </tr>
...
<script type="text/javascript">
    ...
    $('#store').change(function() {
        ...
        var formData = registerForm.serialize();
        $.ajax({
            url:'getDSItemsBySelectedStorePl/'+stores+'/'+fy,
            type:'DELETE',
            data:formData,
            beforeSend: function () { 
                itemSection.block({
    ...
    $('#reportbutton').click(function() {
        ...
        if(storeval==''||storeval=='0'||storeval==null||fiscalyears==''||fr==''||tr==''||itgrp == ''||paytype == ''||items==''||pltype == ''||potype == ''){
            ...
            var table = $("#plreporttable").DataTable({
                ...
                responsive:true,
                    ...
                    ajax: {
                        ...
                        url: '/dsplreporitmtbl/' + fr + '/' + tr + '/' + storeval + '/' + fiscalyears + '/' + itgrp+'/'+paytype+'/'+pltype,
                        type: 'POST',
                        dataType: "json",
                        data:{
