                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">Product Movement Report</h3>
                        </div>
                                    ...
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-1">
                                                ...
                                                <select class="selectpicker form-control dropdownclass errorerase" id="store" name="store" title="Select store/station here..." data-style="btn btn-outline-secondary waves-effect" data-live-search="true"></select>
                                                <span class="text-danger">
                                                ...
                                                <table style="width: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 47%;text-align:left;">
                                                            <div class="btn-group" id="exportdiv" style="display: none;">
                                                                ...
                                                                <ul class="dropdown-menu" data-popper-placement="bottom-start" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1px, 40px);">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <div style="width: 99%;margin-left:0.5%; margin-top:0.5%;">
                                            <div>
                                                <table id="stockmovementreporttable" class="display table-bordered defaultdatatable nowrap" style="text-align:left;width: 100%">
                                                    <thead>
                                                        <tr style="border:1px solid black;">
                                                            ...
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="">Store/ Station</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Floor Map">Floor Map</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Commodity Type">Commodity Type</th>
                                                            <th style="width:9%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Commodity">Commodity</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Grade">Grade</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Crop Year">Crop Year</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Process Type">Process Type</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="UOM/ Bag">UOM/ Bag</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="">StockIn by KG</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="">StockOut by KG</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Running Quantity by KG">Running Qty. by KG</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="">StockIn by Bag</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="">StockOut by KG</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Running Quantity by Bag">Running Qty. by Bag</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="">Transaction Type</th>
                                                            <th style="width:6%;color:white; border: 0.1px solid white;background-color:#00cfe8;" title="Reference Number">Reference No.</th>
                                                            <th style="width:5%;color:white; border: 0.1px solid white;background-color:#00cfe8;border-right:1px solid black" title="">Date</th>
...
@endcan
    ...
    <!--Start Requisition Information Modal -->
    <div class="modal modal-slide-in event-sidebar fade" id="reqInfoModal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true" style="overflow-y: scroll;">
        <form id="reqInfoform">
        {{ csrf_field() }}
            <div class="modal-dialog sidebar-xl" style="width:98%;">
                <div class="modal-content p-0">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #ea5455 !important;font-weight:bold;">x</button>
                    <div class="modal-header">
                        <h4 class="modal-title">Requisition Information</h4>
                        <div style="text-align: center;padding-right:30px;" id="reqstatusdisplay"></div>
                    </div>
                    <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="row mt-1">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <section id="collapsible">
                                        <div class="card collapse-icon">
                                            <div class="collapse-default">
                                                <div class="card">
                                                    <div id="headingCollapse5" class="card-header" data-toggle="collapse" role="button" data-target=".infocommreq" aria-expanded="false" aria-controls="collapse5">
                                                        <span class="lead collapse-title">Basic & Action Information</span>
                                                        
                                                    </div>
                                                    <div id="collapse5" role="tabpanel" aria-labelledby="headingCollapse5" class="collapse infocommreq">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-lg-8 col-md-6 col-12" style="border-right-style: solid;border-right-color:rgba(34, 41, 47, 0.2);border-right-width: 1px;">
                                                                    <div class="card">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                                                    <table style="width: 100%">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Booking No.</label></td>
                                                                                            <td><label id="infobookingnum" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                ...
                                                                                <div class="col-lg-6 col-md-12 col-12">
                                                                                    <table style="width:100%;">
                                                                                        <tr>
                                                                                            <td style="width:30%"><label style="font-size: 14px;">Station</label></td>
                                                                                            <td style="width:70%"><label id="infosourcestore" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-12">
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-12 col-md-12 col-sm-12 scrdivhor scrollhor" style="overflow-y: scroll;height:15rem">
                                                                                    <ul id="reqactiondiv" class="timeline mb-0 mt-0"></ul>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane propdtableBody active" id="requestedtabBody" role="tabpanel" aria-labelledby="requestedtabBody">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                    <div class="table-responsive scroll scrdiv">
                                                        <table id="reqcommdatatable" class="display table-bordered table-striped table-hover dt-responsive mb-0 infodatatbl" style="width: 100%">
                                                            <thead> 
                                                                <tr>
                                                                    <th style="width:2%;">#</th>
                                                                    <th style="width:4%;text-align:left;">Floor Map</th>
                                                            ...
                                                            <tfoot>
                                                                <th colspan="13" style="font-size:16px;text-align: right;padding-right:7px;">Total</th>
                                                                <th style="font-size: 14px;" id="reqtotalbag"></th>
                                                                <th style="font-size: 14px;" id="reqtotalbagweight"></th>
                                                                <th style="font-size: 14px;" id="reqtotalgrosskg"></th>
                                                                <th style="font-size: 14px;" id="reqtotalkg"></th>
                                                                <th style="font-size: 14px;" id="reqtotalton"></th>
                                                                <th style="font-size: 14px;" id="reqtotalferesula"></th>
                                                                <th style="font-size: 14px;" id="reqtotalvarshortage"></th>
                                                                <th style="font-size: 14px;" id="reqtotalvarovrage"></th>
                                                                <th></th>
                                                            </tfoot>
                                                        </table>
                                                    </div>
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6" style="text-align: left">
                                                    ...
                                                    <button type="button" id="requisitionprintbtn" class="btn btn-outline-dark waves-effect"><i class="fa fa-print" aria-hidden="true"></i> Print</button>
                                                </div>
                    ...
                    <div class="modal-footer">
                        <div class="col-xl-12 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-8" style="text-align:right;">
                                    <button id="closebuttonreq" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
    ...
    <!--End Requisition Information Modal -->
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('#printtable').click(function(){
            var divToPrintBody = document.getElementById("stockmovementreporttable");
                            ...
                            <table class="table table-sm" style="width:100%;border: none !important;">
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:center;vertical-align: middle;border: none !important;padding:2px;">
                                        <h3><p style="color:#00cfe8;padding-top:8px;"><b>Product Movement Report</b></p></h3>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        $("#downloatoexcel").click(function () {
            ...
            var table = document.getElementById("stockmovementreporttable");
            var workbook = new ExcelJS.Workbook();
            var worksheet = workbook.addWorksheet("Product_Movement_Report");

            let mergeCells = [];
            let maxColumnWidths = {}; // Store max column widths

            let titleRow = worksheet.addRow(["Product Movement Report ("+fromdate+" to "+todate+")"]);
            titleRow.font = { bold: true, size: 16, color: { argb: "000000" } };
            titleRow.alignment = { horizontal: "center", vertical: "middle" };

            worksheet.mergeCells(1, 1, 1, 18); // 🔹 Merge across all columns
            ...
            processTableRows($(table).find("tbody"), lastRow);
            ...
            workbook.xlsx.writeBuffer().then((data) => {
                ...
                saveAs(blob,"Product_Movement_Report_from_"+fromdate+"_to_"+todate+".xlsx");
            });
        });
        ...
        $("#downloadtopdf").click(function () {
            ...
            $("#stockmovementreporttable thead tr").each(function () {
                let rowData = [];
            ...
            $("#stockmovementreporttable tbody tr").each(function (rowIndex) {
                let rowData = [];
            ...
            const titleText = "Product Movement Report ("+fromdate+" to "+todate+")";
            ...
            doc.save("Product_Movement_Report_from_"+fromdate+"_to_"+todate+".pdf");
        });
        ...
        function getProductType(storeid){
            ...
            cusowner.forEach(a1 => {
                allCombinations.push(fiscalyear + a1 + storeid);
            });
        ...
        function getTransactionType(prdtype){
            ...
            cusowner.forEach(a1 => {
                prdtype.forEach(a3 => { 
                    allCombinations.push(fiscalyear + a1 + storeid + a3);
                });
            });
        ...
        function getReference(trtype){
            ...
            cusowner.forEach(a1 => {
                prdtype.forEach(a3 => { 
                    trtype.forEach(a4 => { 
                        allCombinations.push(fiscalyear + a1 + storeid + a3 + a4);
                    });
                });
            });
                ...
                prdtype.forEach(a3 => { 
                    commoditytype.forEach(a4 => { 
                        commodity.forEach(a5 => {
                            allCombinations.push(fiscalyear + a1 + storeid + a3 + a4 + a5);
                        });
                    });
                });
            });
            ...
            cusowner.forEach(a1 => {
                prdtype.forEach(a3 => { 
                    commoditytype.forEach(a4 => { 
                        commodity.forEach(a5 => {
                            grade.forEach(a6 => {
                                allCombinations.push(fiscalyear + a1 + storeid + a3 + a4 + a5 + a6);
                            });
                        });
                    }); 
                });
                        ...
                        commodity.forEach(a5 => {
                            grade.forEach(a6 => {
                                processtype.forEach(a7 => {
                                    allCombinations.push(fiscalyear + a1 + storeid + a3 + a4 + a5 + a6 + a7);
                                });
                            });
                        });
                    });
        ...
        $('#reportbutton').on('click', function() {
            var registerForm = $('#stockmovementform');
            var formData = registerForm.serialize();
            var columnIndex=1;

            $.ajax({ 
                url: "{{url('stockMovementReport')}}",
                type: 'POST',
                data: formData,
                beforeSend: function() {
                    cardSection.block({
                ...
                success: function(data) {
                    ...
                    if(data.success) {
                        ...
                        var table = $("#stockmovementreporttable").DataTable({ 
                            destroy: true,
                            processing: true,
                            serverSide: true,
                            paging: false,
                            ...
                            ajax: {
                                ...
                                url: "{{url('stockMovementDataFetch')}}",
                                type: 'POST',
                                beforeSend: function() {
                                    cardSection.block({
                                        message:
                            ...
                            columns: [
                                ...
                                {
                                    data: 'RunningQtyByBag',
                                    name: 'RunningQtyByBag',
                                    render: $.fn.dataTable.render.number(',', '.',2, ''),
                                    width:"5%"
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        if(row.TransactionsType == "Beginning"){
                                        ...
                                        else if(row.TransactionsType == "Requisition"){
                                            return '<a @can("Requisition-View")style="text-decoration:underline;color:blue;" onclick=DocReqInfo("'+row.HeaderId+'")@endcan>'+data+'</a>';
                                        }
                                        else{
                                            return data;
                                        }
                            ...
                            rowGroup: {
                                startRender: function ( rows, group,level ) {
                                    if(level===0){
                                        ...
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#ccc;"><td colspan="18" style="text-align:left;border:0.1px solid black;"><b>'+cusorowner+group+'</b></td></tr>');
                                    } 
                                    if(level===1){
                                        return $('<tr style="font-weight:bold;font-size:13px;color:#000000;background:#f2f3f4;"><td colspan="18" style="text-align:center;border:0.1px solid black;"><b>'+group+'</b></td></tr>');
                                    } 
                                },
                                endRender: function ( rows, group,level ) {
                                    ...
                                    if(level===0){
                                        ...
                                        if(group==="Owner"){
                                            ...
                                            cusorowner=group+" Customer";
                                        }
                                        return $('<tr style="color:#000000;background:#ccc">')
                                            .append('<td colspan="18" style="text-align:right;border:0.1px solid;text-align:center"><b>End of '+cusorowner + '</b></td>') 
                                            .append('</tr>'); 
                                    }
                                    if(level===1){
                                        let totalkgamount=0;
                                        let totalbagamount=0;
                                        totalkgamount=parseFloat(totalstockinkg)-parseFloat(totalstockoutkg);
                                        totalbagamount=parseFloat(totalstockinbag)-parseFloat(totalstockoutbag);

                                        var uoms = rows
                                        .data()
                                        .pluck('UOM')
                                        .toArray();
                                        uoms = uoms.filter((value, index, self) => self.indexOf(value) === index);
                                        return $('<tr style="color:#000000;background:#f2f3f4">')
                                            .append('<td colspan="9" style="text-align:right;border:0.1px solid;"><b>Total</b></td>') 
                                            .append('<td colspan="3" style="text-align:left;border:0.1px solid;text-align:center"><b>'+ numformat(parseFloat(totalkgamount).toFixed(2))+'    KG</b></td>')
                                            .append('<td colspan="3" style="text-align:left;border:0.1px solid;text-align:center"><b>'+ numformat(parseFloat(totalbagamount).toFixed(0))+'    '+uoms+'</b></td>')
        ...
        function DocReqInfo(recordId){
               ...
               url: '/showReqData'+'/'+recordId,
                ...
                success: function(data) {
                    ...
                    $.each(data.reqHeader, function(key, value) {
                        ...
                        $(".reqbtncls").hide();
                        if(statusvals=="Draft"){
                            $("#reqstatusdisplay").html("<span style='color:#A8AAAE;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Pending"){
                            $("#reqstatusdisplay").html("<span style='color:#FF9F43;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Verified"){
                            $("#reqstatusdisplay").html("<span style='color:#00CFE8;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Reviewed"){
                            $("#reqstatusdisplay").html("<span style='color:#4e73df;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Issued"){
                            $("#reqstatusdisplay").html("<span style='color:#4e73df;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Approved"){
                            $("#reqstatusdisplay").html("<span style='color:#1cc88a;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Rejected"){
                            $("#reqstatusdisplay").html("<span style='color:#e74a3b;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     ,     "+statusvals+"</span>");
                        }
                    ...
                    $("#reqactiondiv").empty();
                    $('#reqactiondiv').append(lidata);
                },
            });

            $('#reqcommdatatable').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                paging: false,
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    $('#reqtotalbag').html(totalbagvar === 0 ? '' : numformat(totalbagvar));
                    $('#reqtotalbagweight').html(totalbagweight === 0 ? '' : numformat(parseFloat(totalbagweight).toFixed(2)));
                    $('#reqtotalgrosskg').html(totalgrosskg === 0 ? '' : numformat(parseFloat(totalgrosskg).toFixed(2)));
                    $('#reqtotalkg').html(totalkgvar === 0 ? '' : numformat(parseFloat(totalkgvar).toFixed(2)));
                    $('#reqtotalton').html(totaltonvar === 0 ? '' : numformat(parseFloat(totaltonvar).toFixed(2)));
                    $('#reqtotalferesula').html(totalferesulavar === 0 ? '' : numformat(parseFloat(totalferesulavar).toFixed(2)));
                    $('#reqtotalvarshortage').html(totalvarianceshr === 0 ? '' : numformat(parseFloat(totalvarianceshr).toFixed(2)));
                    $('#reqtotalvarovrage').html(totalvarianceov === 0 ? '' : numformat(parseFloat(totalvarianceov).toFixed(2)));
                },
            });
            ...
            $('#infodispatchdatatbl').DataTable({
                ...
                fixedColumns: {
                    left: [1,2] // Freeze first column (Category)
                },
                drawCallback: function () { 
                    cardSection.block({
                        message:
                    ...
                    $('#reqcommdatatable').show();
                    $('#infodispatchdatatbl').show();
                },
            });

            $(".infocommreq").collapse('show');
            $(".propdtable").removeClass("active");
            $(".propdtableBody").removeClass("active");
        ...
        //Start Requisition Print Attachment
        $('#requisitionprintbtn').on('click', function() {
            var id = $('#reqId').val();
            var link = "/reqcomm/"+id;
            window.open(link, 'Requisition', 'width=1200,height=800,scrollbars=yes');
        });
        //End Requisition Print Attachment
        ...
        function mergeRows(columnIndex) {
            var prevCell = null;
            var rowspan = 1;

            $('#stockmovementreporttable tbody tr').each(function () {
                var cell = $(this).find("td").eq(columnIndex);

                if (prevCell && cell.text() === prevCell.text()) {
                    rowspan++;
                    prevCell.attr("rowspan", rowspan);
                    prevCell.attr("title", cell.text());
                    cell.hide();
                } else {
                    prevCell = cell;
                    rowspan = 1;
