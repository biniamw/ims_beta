...
@section('content')
        ...
        <div class="app-content content">
            <section id="responsive-datatable">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom" style="height: 5rem;padding: 0.6rem;">
                                <h3 class="card-title">Stock Requisition & Issue</h3>
                            ...
                            <div class="card-datatable">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="ownertab" aria-labelledby="ownertab" role="tabpanel">
                                        <div class="row" style="position: absolute;left: 270px;top: 83px;width:50%;z-index: 10;display:none" id="owner_fiscalyear_div">
                                            ...
                                            <table id="laravel-datatable-crud" class="display table-bordered table-striped table-hover dt-responsive defaultdatatable" style="width: 100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:3%;">#</th>
                                                        <th style="width:10%;">Requisition Doc. No.</th>
                                                        <th style="width:9%;">Reference</th>
                                                        <th style="width:10%;">Buyer</th>
                                                        <th style="width:9%;">Product Type</th>
                                                        <th style="width:9%;">Store/ Station</th>
                                                        <th style="width:9%;">Request Reason</th>
                                                        <th style="width:9%;">Date</th>
                                                        <th style="width:9%;">Requested For</th>
                                                        <th style="width:10%;">Requisition Status</th>
                                                        <th style="width:9%;">Dispatch Status</th>
                                    ...
                                    <div class="tab-pane" id="customertab" aria-labelledby="customertab" role="tabpanel">
                                        <div class="row" style="position: absolute;left: 270px;top: 83px;width:50%;z-index: 10;display:none" id="customer_fiscalyear_div">
                                            <div class="col-lg-4 col-xl-4 col-md-6 col-sm-12 col-12">
                                                <select class="select2 form-control" name="customer_fiscalyear[]" id="customer_fiscalyear">
                                                    @foreach ($fiscalyears as $cusfy)
                                                        <option value="{{ $cusfy->FiscalYear }}">{{ $cusfy->Monthrange }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <table id="customer-crud" class="display table-bordered table-striped table-hover dt-responsive defaultdatatable" style="width: 100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:8%;">Customer TIN</th>
                                                        <th style="width:7%;">Store/ Station</th>
                                                        <th style="width:8%;">Request Reason</th>
                                                        <th style="width:7%;">Date</th>
                                                        <th style="width:7%;">Requested For</th>
                                                        <th style="width:8%;">Requisition Status</th>
                                                        <th style="width:8%;">Dispatch Status</th>
                                                        <th style="width:4%;">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="table table-sm"></tbody>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="requisitionformtitle">Requisition Form</h4>
                    <div class="row">
                ...
                <form id="Register">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-1">
                                                <fieldset class="fset">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-4 col-md-4 col-sm-12 mb-1 commproperty commprop" id="company_type_div">
                                                        ...
                                                        <div class="col-xl-4 col-md-4 col-sm-12 mb-1 commproperty commprop" id="request_reason_div">
                                                            <label style="font-size: 14px;">Request Reason</label><label style="color: red; font-size:16px;">*</label>
                                                            <select class="select2 form-control" name="RequestReason" id="RequestReason" onchange="reqReasonFn()"></select>
                                                            <span class="text-danger">
                                                                <strong id="reqreason-error" class="errordatalabel"></strong>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-4 col-md-4 col-sm-6 mb-1 commproperty recustomerdiv">
                                                            <label style="font-size: 14px;" id="recustomerlbl">Buyer</label><label style="color: red; font-size:16px;">*</label>
                                                            <select class="select2 form-control" name="CustomerReceiver" id="CustomerReceiver" onchange="recustomerFn()">
                                                                <option selected disabled value=""></option>
                                                                @foreach ($recustomerdatasrc as $recustomerdatasrc)
                                                                <option value="{{$recustomerdatasrc->id}}">{{$recustomerdatasrc->Code}} , {{$recustomerdatasrc->Name}} , {{$recustomerdatasrc->TinNumber}}</option>
                                                                @endforeach
                                                            </select>
                                                            <span class="text-danger">
                                                                <strong id="recustomer-error" class="errordatalabel cusreprerr"></strong>
                                                            </span>
                                                        </div>
                                                        <div class="col-xl-4 col-md-4 col-sm-6 mb-1 commproperty bookingnumdiv">
                                                            <label style="font-size: 14px;">Booking No.</label>
                                                            <input type="text" name="BookingNumber" id="BookingNumber" placeholder="Write Booking number here" class="BookingNumber form-control mainforminp" onkeyup="bookingNumFn()"/>
                                                            <span class="text-danger">
                                                                <strong id="bookingnum-error" class="errordatalabel"></strong>
                                                            </span>
                                                        </div>
                                                        <div class="col-xl-4 col-md-4 col-sm-6 mb-1 commproperty referencediv">
                                                            <label style="font-size: 14px;">Reference</label>
                                                            <input type="text" name="Reference" id="Reference" placeholder="Write Reference here" class="Reference form-control mainforminp" onkeyup="referenceFn()"/>
                                                            <span class="text-danger">
                                                                <strong id="reference-error" class="errordatalabel"></strong>
                                                            </span>
                                                        </div>
                                                        <div class="col-xl-4 col-md-4 col-sm-6 mb-1 commproperty lablocdiv">
                                                            <label style="font-size: 14px;">Labratory Location</label><label style="color: red; font-size:16px;">*</label>
                                                            <div>
                                                                <select class="select2 form-control" name="LabratoryLocation" id="LabratoryLocation" onchange="labLocationFn()">
                                                                    <option selected disabled value=""></option>
                                                                    @foreach ($storelists as $lablocsrc)
                                                                        <option value="{{ $lablocsrc->id }}">{{ $lablocsrc->Name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <span class="text-danger">
                                                                <strong id="labloc-error" class="errordatalabel"></strong>
                                                            </span>
                                                        </div>
                                                        <div class="col-xl-4 col-md-4 col-sm-6 mb-1 commproperty production_class" id="production_div">
                                                            <label style="font-size: 14px;">Production No.</label><label style="color: red; font-size:16px;">*</label>
                                                            <select class="select2 form-control" name="productionId" id="productionId" onchange="productionNumFn()">
                                                                <option selected disabled value=""></option>
                                                            </select>
                                                            <span class="text-danger">
                                                                <strong id="production_num-error" class="errordatalabel"></strong>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                <fieldset class="fset">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-4 col-md-4 col-sm-6 mb-1" id="sourceDiv">
                                                        ...
                                                        <div class="col-xl-4 col-md-4 col-sm-6">
                                                            <label style="font-size: 14px;">Request For</label>
                                                            <div>
                                                            ...
                                                            <span class="text-danger">
                                                                <strong id="requestedby-error" class="errordatalabel"></strong>
                                                            </span>
                                                        </div>
                                                        <div class="col-xl-4 col-md-4 col-sm-6">
                    ...
                    <div class="modal-footer">
                        <div style="display:none;">
                            <select class="select2 form-control" name="RequestReasonDefault" id="RequestReasonDefault">
                                <option selected disabled value=""></option>
                                @foreach ($reqreason as $reqreason)
                                <option value="{{$reqreason->RequestReasonValue}}">{{$reqreason->RequestReason}}</option>
                                @endforeach
                            </select>
                            <select class="select2 form-control allitems" name="allitems" id="allitems">
                                    <option selected disabled value=""></option>
                                    @foreach ($itemSrcs as $itemSrc)
                                        <option value="{{ $itemSrc->id }}">{{ $itemSrc->Name }}</option>
                                    @endforeach 
                            </select>
                            ...
                            <select class="select2 form-control" name="production_number_default" id="production_number_default">
                                <option selected disabled value=""></option>
                                @foreach ($prd_order_data as $prd_order_data)
                                    <option data-customer_id="{{$prd_order_data->customers_id}}" value="{{ $prd_order_data->id }}">{{ $prd_order_data->ProductionOrderNumber }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <input type="hidden" class="form-control" name="requistionId" id="requistionId" readonly="true"/>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="deletereqform">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label style="font-size: 16px;font-weight:bold;">Do you really want to void requisition?</label>
                        </div>
                        <div class="divider">
    ...
    <!--Start Info Modal -->
    <div class="modal fade text-left" id="reqInfoModal" data-keyboard="false" data-backdrop="static" tabindex="-1"
        role="dialog" aria-labelledby="requisitionmodaltitle" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="requisitionmodaltitle">Stock Requisition Information</h4>
                    <div class="row">
                ...
                <form id="reqInfoform">
                                                            ...
                                                            <div class="row">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                                                    <table style="width: 100%" class="infotbl">
                                                                                        <tr style="display: none;">
                                                                                            <td style="width:47%"><label style="font-size: 14px;">Requisition Doc. No.</label></td>
                                                                                            <td style="width:53%"><label id="infodocnum" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr style="display: none;">
                                                                                            <td><label style="font-size: 14px;">Issue Doc. No.</label></td>
                                                                                            <td><label id="infoissdocnum" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Request Reason</label></td>
                                                                                            <td><label id="inforequestreason" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Buyer</label></td>
                                                                                            <td><label id="infocustomerreceiver" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Reference</label></td>
                                                                                            <td><label id="inforeference" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Production No.</label></td>
                                                                                            <td><label id="infoproductionnum" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                ...
                                                                                <div class="col-lg-6 col-md-12 col-12">
                                                                                    <table style="width:100%;" class="infotbl">
                                                                                        <tr>
                                                                                            <td style="width:30%"><label style="font-size: 14px;">Booking No.</label></td>
                                                                                            <td style="width:70%"><label id="infobookingnum" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Labratory Location</label></td>
                                                                                            <td><label id="infolablocation" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Request For</label></td>
                                                                                            <td><label id="inforequestfor" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td><label style="font-size: 14px;">Request Date</label></td>
                                                                                            <td><label id="inforequestdate" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><label id="infodispatchstation" style="font-size: 14px;font-weight:bold;"></label></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-12 col-md-12 col-12 scrdivhor scrollhor" style="overflow-y: scroll;height:10rem">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <ul class="nav nav-tabs nav-fill" role="tablist" style="border:1px solid #D3D3D3">
                                        <li class="nav-item">
                                            <a class="nav-link propdtable active" id="requestedtab" data-toggle="tab" aria-controls="requestedtab" href="#requestedtabBody" role="tab" aria-selected="true">Requested Commodity</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link propdtable" id="dispatchtab" data-toggle="tab" aria-controls="dispatchtab" href="#dispatchtabBody" role="tab" aria-selected="true">Dispatch Information</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane propdtableBody active" id="requestedtabBody" role="tabpanel" aria-labelledby="requestedtabBody">
                                            <div class="row datatable_div" id="goods_dt_div">
                                            ...
                                            <div class="row datatable_div" id="commodity_dt_div">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        ...
                                                        <table id="commdatatable" class="display table-bordered table-striped table-hover dt-responsive mb-0 defaultdatatable" style="width: 100%">
                                                            <thead> 
                                                                <tr>
                                                                    ...
                                                                    <th style="width:6%" title="GRN Number">GRN No.</th>
                                                                    ...
                                                                    <th style="width:6%" title="Export Certificate Number">Export Certificate No.</th>
                                        ...
                                        <div class="tab-pane propdtableBody" id="dispatchtabBody" role="tabpanel" aria-labelledby="dispatchtabBody">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                    <table id="infodispatchdatatbl" class="display table-bordered table-striped table-hover dt-responsive defaultdatatable" style="width: 100%">
                                                        <thead>
                                                            <tr>
                                                                <th style="display: none;"></th>
                                                                <th style="width:3%;">#</th>
                                                                <th style="width:8%;">Dispatch Doc. No.</th>
                                                                <th style="width:8%;">Dispatch Mode</th>
                                                                <th style="width:8%;">Driver Name</th>
                                                                <th style="width:8%;">Driver License No.</th>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="changetopending" type="button" onclick="getPendingInfoConf()" class="btn btn-info reqbtncls">Change to Pending</button>
                        <button id="backtodraft" type="button" onclick="backToDraftFn()" class="btn btn-info reqbtncls">Back to Draft</button>
                        @endcan

                        @can('Requisition-Verify')
                        <button id="backtopending" type="button" onclick="backToPendingFn()" class="btn btn-info reqbtncls">Back to Pending</button>
                        <button id="verifybtn" type="button" onclick="verifyFn()" class="btn btn-info reqbtncls">Verify</button>
                        @endcan

                        @can('Requisition-Review')<!-- Review -->
                        <button id="backtoverifybtn" type="button" onclick="backToVerifyFn()" class="btn btn-info reqbtncls">Back to Verify</button>
                        <button id="reviewreqbtn" type="button" onclick="reviewFn()" class="btn btn-info reqbtncls">Review</button>
                        @endcan

                        @can('Requisition-Approve')
                        <button id="backtoreviewbtn" type="button" onclick="backToReviewFn()" class="btn btn-info reqbtncls">Back to Review</button>
                        <button id="approvebtn" type="button" onclick="getApproveInfo()" class="btn btn-info reqbtncls">Approve</button>
                        @endcan
                        <button id="correctionbtn" type="button" onclick="getCommentInfo()" class="btn btn-info reqbtncls">Comment</button>
                        @can('Requisition-Reject')
                        <button id="rejectbtn" type="button" onclick="getRejectInfo()" class="btn btn-info reqbtncls">Reject</button>
                        @endcan
                        @can('Requisition-Issue')
                        <button id="issuebtn" type="button" onclick="getIssueInfo()" class="btn btn-info reqbtncls">Issue</button>
                        @endcan
            ...
            <div class="modal-content">
                ...
                <form id="verifyform">
                    ...
                    <div class="modal-body" style="background-color:#00CFE8">
                        <label style="font-size: 16px; color:white;font-weight:bold;">Do you really want to verify requisition?</label>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="approveform">
                    ...
                    <div class="modal-body" style="background-color:#5cb85c">
                        <label style="font-size: 16px; color:#FFFFFF;font-weight:bold;">Do you really want to approve requisition?</label>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="rejectform">
                    ...
                    <div class="modal-body" style="background-color:#d9534f">
                        <label style="font-size: 16px; color:white;font-weight:bold;">Do you really want to reject requisition?</label>
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="issueform">
                    @csrf
                    <div class="modal-body" style="background-color:#5cb85c;">
                        <label style="font-size: 16px; color:white;font-weight:bold;">Do you really want to Issue requisition?</label>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="issueId" id="issueId" readonly="true">
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form id="undovoidform">
                    ...
                    <div class="modal-body" style="background-color:#f6c23e">
                        <label style="font-size: 16px;font-weight:bold;">Do you really want to undo void requisition?</label>
                        <div class="form-group">
    ...
    <!--Start Pending Requisition modal -->
    <div class="modal fade text-left" id="pendingconfmodal" data-keyboard="false" data-backdrop="static" tabindex="-1"
        role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="pendingreceivingform">
                    @csrf
                    <div class="modal-body" style="background-color:#f6c23e">
                        <label style="font-size: 16px;font-weight:bold;">Do you really want to change requisition to pending?</label>
                        <div class="form-group">
    ...
    <!--Start Review modal -->
    <div class="modal fade text-left" id="reviewmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Confirmation</h4>
                ...
                <form id="reviewform">
                    @csrf
                    <div class="modal-body" style="background-color:#7367F0;">
                        <label style="font-size: 16px;font-weight:bold;color:white">Do you really want to change requisition to reviewed?</label>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="reviewid" id="reviewid" readonly="true">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button id="reviewbtn" type="button" class="btn btn-info">Change to Review</button>
    ...
    <!--Start Back to Review modal -->
    <div class="modal fade text-left" id="backtoreviewmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Confirmation</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeBackToReviewFn()">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="backtoreviewform">
                    @csrf
                    <div class="modal-body">
                        <label style="font-size: 14px;">Comment</label>
                        <div class="form-group">
                            <textarea type="text" placeholder="Write Comment here..." class="form-control" rows="3" name="BackToReviewComment" id="BackToReviewComment" onkeyup="backToReviewValFn()"></textarea>
                            <span class="text-danger">
                                <strong id="backtoreview-error"></strong>
                            </span>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" class="form-control" name="backtoreviewid" id="backtoreviewid" readonly="true">
                        <button id="backtoreviewbutton" type="button" class="btn btn-info">Back to Review</button>
                        <button id="closebacktoreviewbtn" type="button" class="btn btn-danger" data-dismiss="modal" onclick="closeBackToReviewFn()">Close</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <!-- End Back to Review modal -->

    <!--Start Dispatch Information Modal -->
    <div class="modal fade" id="dispatchinfomodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true" style="overflow-y: scroll;">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="dispatchinfotitle">Manage Dispatch Information</h4>
                    <div class="row">
                        <div style="text-align: right" id="dispatchstatustitle"></div>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeDispatchFn()"><span aria-hidden="true">&times;</span></button>
                    </div>
                </div>
                <form id="DispatchForm">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12">
                                    <fieldset class="fset">
                                        <legend>Add / Edit Dispatch Info</legend>
                                        <div class="row">
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1">
                                                <label style="font-size: 14px;">Dispatch Mode</label><label style="color: red; font-size:16px;">*</label>
                                                <select class="select2 form-control" name="DispatchMode" id="DispatchMode" onchange="dispatchModeFn()">
                                                    @foreach ($dispmodedata as $dispmodedata)
                                                    <option value="{{$dispmodedata->DispatchModeValue}}">{{$dispmodedata->DispatchModeName}}</option>
                                                    @endforeach
                                                </select>
                                                <span class="text-danger">
                                            ...
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1 vech mainprop">
                                                ...
                                                <span class="text-danger">
                                                    <strong id="drivername-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1 vech mainprop">
                                                <label style="font-size: 14px;">Driver License No.</label><label style="color: red; font-size:16px;">*</label>
                                                ...
                                                <span class="text-danger">
                                                    <strong id="driverlic-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1 vech mainprop">
                                                <label style="font-size: 14px;">Driver Phone No.</label><label style="color: red; font-size:16px;">*</label>
                                                <input type="text" placeholder="Write Driver phone number here" class="form-control mainforminp" name="DriverPhoneNo" id="DriverPhoneNo" onkeyup="driverPhoneFn()" onkeypress="return ValidateOnlyNum(event);"/>
                                                <span class="text-danger">
                                                    <strong id="driverphone-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1 vech mainprop">
                                            ...
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1 vech mainprop">
                                                <label style="font-size: 14px;">Container No.</label>
                                                ...
                                                <span class="text-danger">
                                                    <strong id="containernumber-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-2 col-md-4 col-sm-4 mb-1 vech mainprop">
                                                <label style="font-size: 14px;">Seal No.</label>
                                                ...
                                                <span class="text-danger">
                                                    <strong id="sealnumber-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-sm-6 mb-1 per mainprop">
                                                <label style="font-size: 14px;">Person's Name</label><label style="color: red; font-size:16px;">*</label>
                                                ...
                                                <span class="text-danger">
                                                    <strong id="personname-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-sm-6 mb-1 per mainprop">
                                                <label style="font-size: 14px;">Person's Phone No.</label><label style="color: red; font-size:16px;">*</label>
                                                <input type="text" placeholder="Write Person's phone number here" class="form-control mainforminp" name="PersonPhoneNo" id="PersonPhoneNo" onkeyup="personPhoneFn()" onkeypress="return ValidateOnlyNum(event);"/>
                                                <span class="text-danger">
                                                    <strong id="personphone-error" class="errordatalabel"></strong>
                                                </span>
                                            </div>
                                            <div class="col-xl-2 col-md-4 col-sm-4">
                                                <label style="font-size: 14px;">Remark</label>
                                                <textarea type="text" placeholder="Write Remark here..." class="form-control" name="Remark" id="Remark"></textarea>
                                                <span class="text-danger">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12">
                                                <table id="dispDynamicTable" class="mb-0 rtable" style="width:100%;">
                                                    <thead style="font-size:12px;">
                                                        <tr>
                                                            <th rowspan="2" style="width:3%;">#</th>
                                                            <th rowspan="2" style="width:12%;">Commodity<label style="color: red;">*</label></th>
                                                            <th rowspan="2" style="width:30%;">Supplier, GRN No., Production Order No. Production Certficate No., Export Certificate No., UOM/Bag<label style="color: red;">*</label></th>
                                                            <th colspan="3" style="width:20%;">Remaining Amount</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="width:7%;">Total KG</th>
                                                            <th style="width:6%;">Net KG</th>
                                                            <th style="width:7%;">No. of Bag<label style="color: red;">*</label></th>
                                                            <th style="width:7%;">Total KG<label style="color: red;">*</label></th>
                                                            <th style="width:6%;">Net KG<label style="color: red;">*</label></th>
                                                        </tr>
                                                    <thead>
                                                    <tbody></tbody>
                                                    <tfoot>
                                                        <tr>
                                                            <th style="background-color:#FFFFFF;padding: 0px 0px 0px 0px;border-color:#FFFFFF;text-align:left;" colspan="2">
                                                                <button type="button" name="dispadds" id="dispadds" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i>  Add New</button></br>
                                                            </th>
                                                            <th style="background-color:#FFFFFF;border:none;padding:0px;text-align:right;" colspan="4">
                                                                <label style="font-size: 16px;text-align:right;float:right;">Total</label>
                                                            </th>
                                                            <th class="disptblfootercls" style="font-size: 16px;" id="disptotalnumofbag"></th>
                                                            <th class="disptblfootercls" style="font-size: 16px;" id="disptotalkg"></th>
                                                            <th class="disptblfootercls" style="font-size: 16px;" id="disptotalnetkg"></th>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-3" style="text-align: right;">
                                                <button id="savebuttondispatch" type="button" class="btn btn-info">Save</button>
                                                <button id="closeupdatedispatchbtn" type="button" class="btn btn-danger" onclick="closeDispatchUpdateFn()">Close</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                    ...
                    <div class="modal-footer">
                        <div style="display: none;">
                            <select class="select2 form-control" name="reqcommoditydefault" id="reqcommoditydefault">
                                <option selected disabled value=""></option>
                                @foreach ($requestedCommData as $requestedCommData)
                                    <option title="{{$requestedCommData->HeaderId}}" value="{{ $requestedCommData->CommodityId }}">{{ $requestedCommData->Origin }}</option>
                                @endforeach
                            </select>
                            <select class="select2 form-control" name="concatdatadefault" id="concatdatadefault">
                                <option selected disabled value=""></option>
                                @foreach ($concatDataSrc as $concatDataSrc)
                                    <option title="{{$concatDataSrc->CommodityId}}" label="{{$concatDataSrc->HeaderId}}" value="{{ $concatDataSrc->ReqDetailId }}">{{ $concatDataSrc->ConcatData }}</option>
                                @endforeach
                            </select>
                        </div>
                        <input type="hidden" class="form-control" name="dispatchCurrRecId" id="dispatchCurrRecId" readonly="true"/>   
                        <input type="hidden" class="form-control" name="dispatchRecId" id="dispatchRecId" readonly="true"/>       
                        <input type="hidden" class="form-control" name="dispatchOperationtypes" id="dispatchOperationtypes" readonly="true"/>
                        
                        <button id="closebuttondispatch" type="button" class="btn btn-danger" onclick="closeDispatchFn()" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <!--End Dispatch Information Modal -->
            ...
            <div class="modal-dialog sidebar-xl" style="width:90%;">
                <div class="modal-content p-0">
                    ...
                    <div class="modal-header mb-1">
                        <h5 class="modal-title">Dispatch Information</h5>
                    ...
                    <div class="modal-footer">
                        @can('Verify-Dispatch')
                        <button id="changetobackbtn" type="button" onclick="changeToPendingFn()" class="btn btn-info dispbtnprop" style="display: none;">Back to Pending</button>
                        <button id="changetoverifiedbtn" type="button" onclick="changeToVerifiedFn()" class="btn btn-info dispbtnprop" style="display: none;">Verify</button>
                        @endcan
                        @can('Approve-Dispatch')
                        <button id="changetoapprovebtn" type="button" onclick="changeToApprovedFn()" class="btn btn-info dispbtnprop" style="display: none;">Approve</button>
                        @endcan
    ...
    <div class="modal fade text-left" id="voiddispatchmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="voiddispatchform">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label style="font-size: 16px;font-weight:bold;">Do you really want to void dispatch?</label>
                        </div>
                        <div class="divider">
                            <div class="divider-text">Reason</div>
                        </div>
    ...
    <!--Start dispatch undo void modal -->
    <div class="modal fade text-left" id="dispundovoidmodal" data-keyboard="false" data-backdrop="static" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="dispundovoidform">
                    @csrf
                    <div class="modal-body" style="background-color:#f6c23e">
                        <label style="font-size: 16px;font-weight:bold;">Do you really want to undo void dispatch?</label>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="dispundovoidid" id="dispundovoidid" readonly="true">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button id="dispundovoidbtn" type="button" class="btn btn-info">Undo Void</button>
                        <button id="closebuttondisp" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <!-- End dispatch undo void modal -->

    <!--Start dispatch verified modal -->
    <div class="modal fade text-left" id="dispverifiedmodal" data-keyboard="false" data-backdrop="static" tabindex="-1"
        role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="dispverifiedform">
                    @csrf
                    <div class="modal-body" style="background-color:#f6c23e">
                        <label style="font-size: 16px;font-weight:bold;">Do you really want to verify dispatch?</label>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="dispverifiedid" id="dispverifiedid" readonly="true">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button id="dispverifiedbtn" type="button" class="btn btn-info">Verify</button>
                        <button id="closebuttondispver" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <!-- End dispatch verified modal -->

    <!--Start Back to Pending Modal -->
    <div class="modal fade text-left" id="dispbacktopendingmodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="backtopendingtitle">Confirmation</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="dispbacktopendingform">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label style="font-size: 16px;font-weight:bold;">Do you really want a dispatch Back to pending?</label>
                        </div>
                        <div class="divider">
                            <div class="divider-text">Reason</div>
                        </div>
                        <label style="font-size: 16px;"></label>
                        <textarea type="text" placeholder="Write Reason here..." class="form-control BackToPendingReason" rows="3" name="BackToPendingReason" id="BackToPendingReason" onkeyup="backToPendingDispFn()"></textarea>
                        <span class="text-danger">
                            <strong id="dispbacktopending-error"></strong>
                        </span>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" class="form-control" name="backtopendingidval" id="backtopendingidval" readonly="true">
                        <button id="dispbacktopendingbtn" type="button" class="btn btn-info">Back to Pending</button>
                        <button id="closebuttonbackpendisp" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!--Start dispatch approve modal -->
    <div class="modal fade text-left" id="dispapprovemodal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Confirmation</h4>
                ...
                <form id="dispapproveform">
                    @csrf
                    <div class="modal-body" style="background-color:#5cb85c">
                        <label style="font-size: 16px;color:#FFFFFF;font-weight:bold;">Do you really want to approve dispatch?</label>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="dispapproveid" id="dispapproveid" readonly="true">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button id="dispapprovebtn" type="button" class="btn btn-info">Approve</button>
                        <button id="closebuttondispappr" type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <!-- End dispatch approve modal -->
    ...
    <script type="text/javascript">
        ...
        function getRequisitionData(fyears){
            $('#owner_dt').hide();
            $('#owner_fiscalyear_div').hide();
            owner_data = $('#laravel-datatable-crud').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                ...
                scrollY: '60vh', // example dynamic calc
                scrollX: true,
                scrollCollapse: true,
                ...
                "initComplete": function () {
                    $('.custom-buttons').html(`
                        @can('Requisition-Add')
                            <button type="button" class="btn btn-gradient-info btn-sm addreqprocbutton" data-toggle="modal">Add</button>
                        @endcan
                    `);
                },
        ...
        $('body').on('click', '.addreqprocbutton', function() {
            ...
            $('#LabratoryLocation').select2
            ({
                placeholder: "Select Labratory location here",
            });

            $('.production_class').hide();
                ...
                success: function(data) {
                    if (data.errors) {
                        ...
                        if (data.errors.CompanyType) {
                            ...
                            text = text.replace("1", "commodity");
                            $('#comptype-error').html(text);
                        }
                        if (data.errors.RequestReason) {
                            var text = data.errors.RequestReason[0];
                            text = text.replace("1", "commodity");
                            $('#reqreason-error').html(text);
                        }
                        ...
                        if (data.errors.CustomerReceiver) {
                            $('#recustomer-error').html("The buyer field is required when company type is owner and request reason is sales export");
                        }
                        if (data.errors.BookingNumber) {
                            var text=data.errors.BookingNumber[0];
                            text = text.replace("3", "sales export");
                            $('#bookingnum-error').html(text);
                        }
                        ...
                        if (data.errors.LabratoryLocation) {
                            var text=data.errors.LabratoryLocation[0];
                            text = text.replace("5", "sample lab");
                            $('#labloc-error').html(text);
                        }
                        if (data.errors.productionId) {
                            var text=data.errors.productionId[0];
                            text = text.replace("10", "production");
                            text = text.replace("production id", "production no.");
                            $('#production_num-error').html(text);
                        }
                        if (data.errors.SourceStore) {
                            var text=data.errors.SourceStore[0];
                            text = text.replace("source store", "station");
                    ...
                    else if (data.errorv2 ||data.suppcnt || data.grnnumcnt || data.cernumcnt || data.prdnumcnt) {
                        ...
                        if(data.product_type == 2){
                            $('#dynamicTable > tbody > tr').each(function () {
                                ...
                                let rowind = $(this).find('.idval').val();
        ...
        $('#deletereqdatabtn').click(function() {
            var delid = $('#delidi').val();
            var deleteForm = $("#deletereqform");
            var formData = deleteForm.serialize();
            $.ajax({
                url: '/reqVoidComm/' + delid,
                type: 'DELETE',
                data: formData,
                beforeSend: function() {
                    cardSection.block({
        ...
        //start edit requisition item modal
        $('body').on('click', '.editRecDatas', function() {
            ...
            var reqitemnames = $(this).data('itemname');
            var requomvar = $(this).data('uom');
            var reqcodevar = $(this).data('code');
            $('#requisitionsid').val(recItemVar);
            $('#newreqmodal').modal('show');
            $.get("/reqitemedit" + '/' + recItemVar, function(data) {
                itemn = data.recDataId.ItemId;
                console.log(itemn);
                $('#reqpartnumber').val(reqcodevar);
                $('#requom').val(requomvar);
                $('#reqquantity').val(data.recDataId.Quantity);
                $('#reqmemo').val(data.recDataId.Memo);
                $('#stId').val(data.recDataId.StoreId);
                $('#desstId').val(data.recDataId.DestStoreId);
                $('#editVal').val("1");
            ...
            //             for(var i=0;i<=len;i++)
            //             {
            //                 var code=data['sid'][i].Code;
            //                 var name=data['sid'][i].ItemName;
            //                 var sku=data['sid'][i].SKUNumber;
            //                 var id=data['sid'][i].id;
            //                 var option = "<option value='"+id+"'>"+code+"       ,       "+name+"        ,       "+sku+"</option>";
            //                 $("#reqItemname").append(option); 

            //                 console.log(id+" - "+itemn);
            //                 $('#reqItemname').selectpicker('refresh');  
            //                 $('#reqItemname').selectpicker('val',itemn).trigger('change');
            ...
            $.ajax({
                url: 'getEditItemBalance/' + reqitemid,
                type: 'DELETE',
                data: formData,
                success: function(data) {
                    if (data.sid) {
        ...
        //end edit requisition item modal
                    ...
                    success: function(data) {
                        if (data.sid) {
                            ...
                            for (var i = 0; i <= len; i++) {
                                ...
                                var partnum = (data['itinfo'][i].Code);
                                var uoms = (data['itinfo'][i].UOM);
                                var maxcost = (data['getCost'][i].UnitCost);
                                $('#reqpartnumber').val(partnum);
                                $('#requom').val(uoms);
                                $('#reqEditMaxCost').val(maxcost);
        ...
        $("#adds").click(function() {
            ...
            if(isNaN(parseFloat(storeidvar)) || storeidvar == null){
                ...
                $("#dynamicTable > tbody").append(`<tr>
                    ...
                    <td style="width:17%;">
                        <select id="itemNameSl${m}" onchange="itemFn(this)" class="select2 form-control itemName" name="row[${m}][ItemId]"></select>
                    </td>
                    <td style="width:15%;background-color:#efefef;text-align:center">
                        <label style="font-weight:bold;font-size:14px" class="readonlyfield" id="uomgoods${m}"></label>
                        <input type="hidden" name="row[${m}][UOM]" placeholder="UOM" id="uom${m}" class="uom form-control" readonly="true"/>
                    </td>
                    <td style="width:15%;background-color:#efefef;text-align:center">
                        <label style="font-weight:bold;font-size:14px" class="readonlyfield qtyonhandcls" id="qtyonhand${m}"></label>
                        <input type="hidden" name="row[${m}][AvQuantity]" placeholder="Quantity On Hand" id="AvQuantity${m}" class="AvQuantity form-control" readonly="true"/>
                    </td>
                    <td style="width:15%;">
                        <input type="number" name="row[${m}][Quantity]" onkeyup="checkQ(this)" ondrop="return false;" onpaste="return false;" placeholder="Quantity" id="quantity${m}" class="quantity form-control numeral-mask"/>
                    </td>
                    <td style="width:17%;">
                ...
                $(`#location${m} option[title!="${storeidvar}"]`).remove(); 
                ...
                var item_data = $("#allitems > option").clone();
        ...
        function checkDuplicateCombination(loc, itm, indx, excludeRow, param) {
            ...
            var store_id = $('#sstore').val();
            var cus_id = $('#Customer').val() || 1;
            var rec_id = $('#requistionId').val() || 0;
            ...
            if(param == 1){
                fetchItemBalance(loc,itm,store_id,cus_id,rec_id,indx);
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data.itemdata, function(key, value) {
                        $(`#uom${indx}`).val(value.MeasurementId);
        ...
        function fetchItemBalance(loc_id,itm_id,str_id,cus_id,rec_id,indx){
            $(`#AvQuantity${indx}`).val("");
            $(`#qtyonhand${indx}`).html("");

            if (itm_id == null || loc_id == null || str_id == null || itm_id === '' || loc_id === '' || str_id === '') return false;
            var location_id = "";
            var item_id = "";
            var store_id = "";
            var customer_id = "";
            ...
            $.ajax({
                ...
                success: function(data) {
                    $(`#AvQuantity${indx}`).val(data.available_qty);
                    $(`#qtyonhand${indx}`).html(data.available_qty);
        ...
        $("#commadds").click(function() {
            ...
            var borcolor="";
            if(isNaN(parseInt(storeid)) || isNaN(parseInt(comptype)) || isNaN(parseInt(reqreason)) || (parseInt(comptype)==2 && isNaN(parseInt(customer))) ){
                ...
                if(isNaN(parseInt(reqreason))){
                    $('#reqreason-error').html("Request reason is required"); 
                }
                        ...
                        '<div class="col-xl-5 col-md-6 col-lg-6">'+
                            '<div class="row">'+
                                ...
                                '<div class="col-xl-2 col-md-4 col-lg-4 mb-0">'+
                                    ...
                                    '<input type="number" name="row['+m2+'][NumOfBag]" placeholder="Write Number of bag here" id="NumOfBag'+m2+'" class="NumOfBag form-control numeral-mask commnuminp" onkeyup="NumOfBagFn(this)" onblur="checkBalanceBlFn(this)" step="any" onkeypress="return ValidateOnlyNum(event);"/>'+
                                '</div>'+
                                '<div class="col-xl-3 col-md-4 col-lg-4 mb-0">'+
                                ...
                                '<div class="col-xl-4 col-md-4 col-lg-4 mb-1">'+
                                    '<label style="font-size: 12px;">Qty. on Hand</label>'+
                                    '<div class="row" style="border: 0.1px solid #d9d7ce;">'+
                                ...
                                '<div class="col-xl-4 col-md-4 col-lg-4">'+
                                    ...
                                    '<input type="number" name="row['+m2+'][TotalKg]" placeholder="Write total kg here..." id="TotalKg'+m2+'" class="TotalKg form-control numeral-mask commnuminp" onkeyup="TotalKgFn(this)" onblur="checkBalanceBlFn(this)" onkeypress="return ValidateNum(event);" step="any"/>'+
                                '</div>'+
                                '<div class="col-xl-4 col-md-4 col-lg-4">'+
                                    '<label style="font-size: 12px;">Net KG</label><label style="color: red; font-size:16px;">*</label>'+
                                    '<input type="number" name="row['+m2+'][NetKg]" placeholder="Write Net KG here..." id="NetKg'+m2+'" class="NetKg form-control numeral-mask commnuminp" onkeyup="NetKgFn(this)" onblur="checkBalanceBlFn(this)" onkeypress="return ValidateNum(event);" step="any"/>'+
                                '</div>'+
                                '<div class="col-xl-4 col-md-4 col-lg-4">'+
        ...
        function calcQtyOnHand(rowid){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    console.log(rowid+") "+totalbalancekg+"= ("+data.avbalancekg+" - "+data.stockoutkg+" - "+data.avothbalancekg+" - "+data.prdbalancekg+" - "+otherskg+") + "+data.stockoutkg);

                    if(parseFloat(totalbalancekg)<parseFloat(quantitykg)){
                        $('#QtyOnHand'+rowid).val("");
        ...
        function NumOfBagFn(ele) {
            ...
            if(parseFloat(qtyonhand)<parseFloat(quantity)){
                $('#NumOfBag'+idval).val("");
            ...
            else if(parseFloat(qtyonhand)>=parseFloat(quantity)){
        ...
        function TotalKgFn(ele) {
            ...
            // }
            if(parseFloat(totalkgval) > parseFloat(uomfactor) && parseFloat(numofbag)==0){
                $('#TotalKg'+idval).val("");
                $('#NetKg'+idval).val("");
                $('#Feresula'+idval).val("");
                $('#Feresula'+idval).css("background","#efefef");
            ...
            else if(parseFloat(qtyonhandkg)<parseFloat(netkg)){
                $('#TotalKg'+idval).val("");
                $('#NetKg'+idval).val("");
                $('#Feresula'+idval).val("");
                $('#Feresula'+idval).css("background","#efefef");
        ...
        //edit modal open
        function editreqdata(recordId) {
            $('.select2').select2();
            $('#operationtypes').val("2");
            $('#requistionId').val(recordId);
            $('#tid').val(recordId);
            $(".commproperty").hide();
            $(".productcls").hide();
            $(".production_class").hide();
               ...
               url: '/showReqData'+'/'+recordId,
                ...
                success: function(data) {
                    ...
                    $.each(data.reqHeader, function(key, value) {
                        reqreason=value.ReqReason;
                        $('#ProductType').val(value.Type).select2();
                        $('#CompanyType').val(value.CompType).select2();
                        $('#Customer').val(value.CusId).select2({dropdownCssClass:'commprp'});
                        $('#CustomerReceiver').val(value.CusRec).select2({dropdownCssClass:'commprp'});

                        $('#BookingNumber').val(value.BookingNumber);
                        $('#Reference').val(value.Reference);

                        $('#LabratoryLocation').val(value.LabSt).select2();
                        ...
                        $('#RequestReason').empty();
                        var request_reason = $("#RequestReasonDefault > option").clone();
                        $('#RequestReason').append(request_reason);
                        var default_reason = `<option selected value="${value.ReqReason}">${value.RequestReason}</option>`;

                        if(parseInt(value.Type)==1){
                            $(".commprop").show();
                            $("#commoditydiv").show();
                            $('#company_type_div').show(); 
                            $('#request_reason_div').show(); 
                            
                            if(parseInt(value.CompType)==1 && parseInt(value.ReqReason)==3){
                                $(".recustomerdiv").show();
                                $(".bookingnumdiv").show();
                                $(".referencediv").show();
                            }
                            if(parseInt(value.CompType)==1 && parseInt(value.ReqReason)==5){
                                $(".lablocdiv").show();
                                $(".referencediv").show();
                            }
                            else{
                            ...
                            $('#RequestReason option[value=10]').remove(); 
                            ...
                            $('#RequestReason option').each(function () {
                                if(value.ReqReason <= 9){
                                    $(`#RequestReason option[value="${value.ReqReason}"]`).remove(); 
                                }
                            });
                        }

                        $('#RequestReason').append(default_reason);
                        $('#RequestReason').select2();

                        if(parseInt(value.ReqReason) == 10){
                            var default_production = `<option selected value="${value.productionId}">${value.production_num}</option>`;
                            var production_num_data = $("#production_number_default > option").clone();
                            $('#productionId').append(production_num_data);
                            $(`#productionId option[data-customer_id!="${value.CustomerOrOwner}"]`).remove(); 
                            $(`#productionId option[value="${value.productionId}"]`).remove(); 
                            $('#productionId').append(default_production);
                        ...
                        $("#statusdisplay").html(`<span style='color:${fore_color};font-weight:bold;font-size:16px;text-align:right;'>${value.DocumentNumber} , ${value.Status}</span>`);
                    });
                    ...
                    if(product_type == 1){
                        $.each(data.reqDetail, function(key, value) {
                                ...
                                '<div class="row">'+
                                    '<div class="col-xl-7 col-md-6 col-lg-6" style="border-right-style: solid;border-right-color:rgba(34, 41, 47, 0.2);border-right-width: 1px;">'+
                                        '<div class="row">'+
                                            ...
                                            '<div class="col-xl-2 col-md-4 col-lg-4 mb-1 expcertcls exptypeprop'+m2+'" id="expcernumdiv'+m2+'" style="display:none;">'+
                                                '<label style="font-size: 12px;">Export Certificate No.</label>'+
                                                '<input type="number" name="row['+m2+'][ExpCertificateNum]" placeholder="Write Export Certificate Number here" id="ExpCertificateNum'+m2+'" class="ExpCertificateNum form-control commnuminp" value="'+value.ExportCertNumber+'" onkeyup="ExpCertificateNumFn(this)" onblur="ExpCertificateNumBlFn(this)" onkeypress="return ValidateOnlyNum(event);"/>'+
                                            '</div>'+
                                        '</div>'+
                                        '<div class="row">'+
                                            '<div class="col-xl-3 col-md-4 col-lg-4 mb-1">'+
                                            ...
                                            '<div class="col-xl-3 col-md-4 col-lg-4 mb-1">'+
                                                '<label style="font-size: 12px;">Remark</label>'+
                                                '<textarea type="text" placeholder="Write Remark here..." class="Remark form-control mainforminp" rows="1" name="row['+m2+'][Remark]" id="Remark'+m2+'">'+value.Memo+'</textarea>'+
                                            '</div>'+
                                        '</div>'+
                                    '</div>'+
                                    '<div class="col-xl-5 col-md-6 col-lg-6">'+
                                        '<div class="row">'+
                                            ...
                                            '<div class="col-xl-2 col-md-4 col-lg-4 mb-0">'+
                                                '<label style="font-size: 12px;">No. of Bag</label><label style="color: red; font-size:16px;">*</label>'+
                                                '<input type="number" name="row['+m2+'][NumOfBag]" placeholder="Write Number of bag here" id="NumOfBag'+m2+'" class="NumOfBag form-control numeral-mask commnuminp" value="'+value.NumOfBag+'" step="any" onkeyup="NumOfBagFn(this)" onblur="checkBalanceBlFn(this)" onkeypress="return ValidateOnlyNum(event);"/>'+
                                            '</div>'+
                                            '<div class="col-xl-3 col-md-4 col-lg-4 mb-0">'+
                                                '<label style="font-size: 12px;">Bag Weight by KG</label><label style="color: red; font-size:16px;">*</label>'+
                                                '<input type="number" name="row['+m2+'][TotalBagWeight]" placeholder="Bag weight" id="TotalBagWeight'+m2+'" class="TotalBagWeight form-control numeral-mask commnuminp" value="'+value.BagWeight+'" step="any" onkeyup="BagWeightFn(this)" readonly onkeypress="return ValidateNum(event);" style="font-weight:bold;"/>'+
                                            '</div>'+
                                            '<div class="col-xl-4 col-md-4 col-lg-4 mb-1">'+
                                                '<label style="font-size: 12px;">Qty. on Hand</label>'+
                                                '<div class="row" style="border: 0.1px solid #d9d7ce;">'+
                                            ...
                                            '<div class="col-xl-4 col-md-4 col-lg-4">'+
                                                '<label style="font-size: 12px;">Total KG</label><label style="color: red; font-size:16px;">*</label>'+
                                                '<input type="number" name="row['+m2+'][TotalKg]" placeholder="Write total kg here..." id="TotalKg'+m2+'" class="TotalKg form-control numeral-mask commnuminp" value="'+value.TotalKg+'" step="any" onkeyup="TotalKgFn(this)" onblur="checkBalanceBlFn(this)" onkeypress="return ValidateNum(event);"/>'+
                                            '</div>'+
                                            '<div class="col-xl-4 col-md-4 col-lg-4">'+
                                                '<label style="font-size: 12px;">Net KG</label><label style="color: red; font-size:16px;">*</label>'+
                                                '<input type="number" name="row['+m2+'][NetKg]" placeholder="Write Net KG here..." id="NetKg'+m2+'" class="NetKg form-control numeral-mask commnuminp" value="'+value.NetKg+'" step="any" onkeyup="NetKgFn(this)" onblur="checkBalanceBlFn(this)" onkeypress="return ValidateNum(event);"/>'+
                                            '</div>'+
                                            '<div class="col-xl-4 col-md-4 col-lg-4">'+
                                                '<label style="font-size: 12px;">Feresula<i class="fa-solid fa-circle-info" title="Net KG / 17"></i></label>'+
                                                '<input type="number" name="row['+m2+'][Feresula]" placeholder="Write Feresula here..." id="Feresula'+m2+'" class="Feresula form-control numeral-mask commnuminp" readonly value="'+value.Feresula+'" step="any" onkeypress="return ValidateNum(event);"/>'+
                                            '</div>'+
                                            '<div class="col-xl-4 col-md-4 col-lg-4 mb-0"></div>'+
                                            '<div class="col-xl-8 col-md-8 col-lg-8 mb-0">'+
                                                '<label style="font-size: 12px;font-weight:bold;" class="variancecls" id="varianceLbl'+m2+'"></label>'+
                            ...
                            '<td style="display:none;"><input type="number" name="row['+m2+'][QtyOnHand]" placeholder="Quantity on Hand" id="QtyOnHand'+m2+'" class="QtyOnHand form-control numeral-mask commnuminp" readonly onkeypress="return ValidateNum(event);" style="font-weight:bold;"/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][QtyOnHandByKg]" placeholder="Quantity on Hand" id="QtyOnHandByKg'+m2+'" class="QtyOnHandByKg form-control numeral-mask commnuminp" readonly onkeypress="return ValidateNum(event);" style="font-weight:bold;"/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][remBagNum]" id="remBagNum'+m2+'" class="remBagNum form-control numeral-mask" style="font-weight:bold;" value="'+value.id+'" step="any" readonly/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][remKg]" id="remKg'+m2+'" class="remKg form-control numeral-mask" style="font-weight:bold;" step="any" value="'+value.id+'" readonly/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][bagWeight]" id="bagWeight'+m2+'" class="bagWeight form-control numeral-mask" style="font-weight:bold;" value="'+value.bagweight+'" step="any" readonly/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][uomFactor]" id="uomFactor'+m2+'" class="uomFactor form-control numeral-mask" style="font-weight:bold;" value="'+value.uomamount+'" step="any" readonly/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][varianceshortage]" id="varianceshortage'+m2+'" class="varianceshortage form-control numeral-mask" value="'+value.VarianceShortage+'" style="font-weight:bold;" step="any" readonly/></td>'+
                            '<td style="display:none;"><input type="number" name="row['+m2+'][varianceoverage]" id="varianceoverage'+m2+'" class="varianceoverage form-control numeral-mask" value="'+value.VarianceOverage+'" style="font-weight:bold;" step="any" readonly/></td>'+
                            '<td style="display:none;"><input type="hidden" name="row['+m2+'][id]" id="id'+m2+'" class="id form-control" readonly="true" value="'+value.id+'" style="font-weight:bold;"/></td>'+
                            '</tr>');
                            ...
                            var defaultprdorder='<option selected value='+value.ProductionOrderNo+'>'+value.ProductionOrderNo+'   ,   '+value.CertNumber+'</option>';
                            var defaultcertdata='<option selected value='+value.CertNumber+'>'+value.CertNumber+'</option>';
                            
                            var prddoc = $('#ProductionNum'+m2+' option[value="' + value.ProductionOrderNo + '"]').attr('label');
                        ...
                        $.each(data.reqDetail, function(key, value) { 
                            ...
                            $("#dynamicTable > tbody").append(`<tr>
                                ...
                                <td style="width:15%;background-color:#efefef;text-align:center">
                                    <label style="font-weight:bold;font-size:14px" class="readonlyfield" id="uomgoods${m}">${value.UomName}</label>
                                    <input type="hidden" name="row[${m}][UOM]" placeholder="UOM" id="uom${m}" class="uom form-control" readonly="true" value="${value.NewUOMId}"/>
                                </td>
                                <td style="width:15%;background-color:#efefef;text-align:center">
                                    <label style="font-weight:bold;font-size:14px" class="readonlyfield qtyonhandcls" id="qtyonhand${m}"></label>
                                    <input type="hidden" name="row[${m}][AvQuantity]" placeholder="Quantity On Hand" id="AvQuantity${m}" class="AvQuantity form-control" readonly="true"/>
                                ...
                                <td style="width:15%;">
                                    <input type="number" name="row[${m}][Quantity]" onkeyup="checkQ(this)" ondrop="return false;" onpaste="return false;" placeholder="Quantity" id="quantity${m}" value="${value.Quantity}" class="quantity form-control numeral-mask"/>
                                </td>
                                <td style="width:17%;">
                                    <input type="text" name="row[${m}][Memo]" id="Memo${m}" class="Memo form-control" value="${value.Memo}" placeholder="Write remark here..."/>
                                </td>
                                <td style="width:3%;text-align:center;">
                                    <button type="button" class="btn btn-light btn-sm remove-tr" style="color:#ea5455;background-color:#FFFFFF;border-color:#FFFFFF"><i class="fa fa-times fa-lg" aria-hidden="true"></i></button>
                                </td>
                            ...
                            renumberRows();
                            fetchItemBalance(value.LocationId,value.ItemId,value.StoreId,value.CustomerOrOwner,value.HeaderId,m);
                        });
                    }
                },
            });
        ...
        function DocReqInfo(recordId){
               ...
               url: '/showReqData'+'/'+recordId,
                ...
                success: function(data) {
                    ...
                    $.each(data.reqHeader, function(key, value) {
                        ...
                        $('#infotype').text(value.Type);
                        $('#infoproducttype').text(value.ProductType);
                        $('#infocompanytype').text(value.CompanyType);
                        $('#inforequestreason').text(value.RequestReason);
                        $('#infocustomer').text(value.CustomerName);
                        $('#infocustomerreceiver').text(value.CustomerReceiverName);
                        $('#inforeference').text(value.Reference);
                        $('#infoproductionnum').text(value.production_num);
                        $('#infobookingnum').text(value.BookingNumber);
                        $('#infolablocation').text(value.LabStation);
                        $('#infosourcestore').text(value.SourceStore);
                        $('#infodestinationstore').text(value.DestinationStore);
                        $('#inforequestfor').text(value.RequestedBy);
                        $('#inforequestdate').text(value.Date);
                        $('#infopurpose').html(value.Purpose);
                        $('#infodispatchstation').html(value.DispatchStatus);
                        $("#statusi").val(value.Status);
                        $('#infostatus').text(value.Status);

                        $('#driverNameLbl').html(value.DriverName);
                        $('#plateNumberLbl').html(value.TruckPlateNo);
                        $('#driverPhoneLbl').html(value.DriverPhoneNo);
                        $('#driverlicenseno').html(value.DriverLicenseNo);
                        $('#containernumber').html(value.ContainerNo);
                        statusvals=value.Status;
                        $(".reqbtncls").hide();
                        if(statusvals=="Draft"){
                            $("#changetopending").show();
                            $("#statustitles").html("<span style='color:#A8AAAE;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     |     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Pending"){
                            $("#verifybtn").show();
                            $("#backtodraft").show();
                            $("#statustitles").html("<span style='color:#FF9F43;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     |     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Verified"){
                            $("#reviewreqbtn").show();
                            $("#backtopending").show();
                            $("#statustitles").html("<span style='color:#00CFE8;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     |     "+statusvals+"</span>");
                        }

                        else if(statusvals=="Reviewed" && parseFloat(appstore)>0){
                            $("#approvebtn").show();
                            $("#backtoverifybtn").show();
                            $("#rejectbtn").show();
                            $("#statustitles").html("<span style='color:#4e73df;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     |     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Reviewed" && parseFloat(appstore)==0){
                            $("#approvebtn").hide();
                            $("#rejectbtn").hide();
                        ...
                        else if(statusvals=="Approved" && parseFloat(issstore)>0){
                            $("#approvebtn").hide();
                            $("#rejectbtn").show();
                            $("#issuebtn").show();
                            $("#backtoreviewbtn").show();
                            $("#statustitles").html("<span style='color:#1cc88a;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     |     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Approved" && parseFloat(issstore)==0){
                            $("#approvebtn").hide();
                            $("#rejectbtn").hide();
                            ...
                            $("#rejectbtn").hide();
                            $("#issuebtn").hide();
                            $("#statustitles").html("<span style='color:#e74a3b;font-weight:bold;font-size:16px;text-align:right;'>"+value.DocumentNumber+"     |     "+statusvals+"</span>");
                        }
                        else if(statusvals=="Void"||statusvals=="Void(Draft)"||statusvals=="Void(Pending)"||statusvals=="Void(Approved)"||statusvals=="Void(Reviewed)")
                        {
                            $("#approvebtn").hide();
                            $("#rejectbtn").hide();
                            $("#issuebtn").hide();
                    ...
                    if(product_type == 1){
                        ...
                        fetchDispatchData(recordId);
                        $("#requestedtab").html("Requested Commodity");
                        ...
                        fetchDispatchData(recordId);
                        $("#requestedtab").html("Requested Goods");
                        $("#goods_dt_div").show();
                        $("#dispatchtab").hide();
                    }
            ...
            $("#requestedtabBody").addClass("active");
        ...
        function fetchDispatchData(recordId){
            $('#infodispatchdatatbl').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                paging: true,
                ...
                ajax: {
                    ...
                    url: '/showInfoDispatchData/' + recordId,
                    type: 'DELETE',
                },
                columns: [
                    {
        ...
        $('#customer_fiscalyear').on('change', function() {
            var fyear = $(this).val();
            getCustomerData(fyear);
        });
                        ...
                        url:'/issReqComm',
                            ...
                            success:function(data) {
                                if(data.valerror)
                                {
                                    ...
                                    if(data.product_type == 1){
                                        msg = "There is no available amount for the following commodity</br>______________________</br>"; 
                                        $.each(data.getcommlist, function(key, value) {
                                            msg += key+". "+value.Origin+"</br>";
                                        });
                                    }
                                    else if(data.product_type == 2){
                                        msg = "There is no available amount for the following goods</br>______________________</br>"; 
                                        $.each(data.getgoodslist, function(key, value) {
                                            msg += key+". "+value.approved_item+"</br>";
                                        });
                                    }

                                    toastrMessage('error',msg,"Error");
                                    $('#conissuebtn').text('Issue');
                                    $('#conissuebtn').prop( "disabled",false);
                                    $("#issueconmodal").modal('hide');
                                }
            ...
            $.get("/showReqData" + '/' + recordId, function(data) {
                ...
                for (var i = 0; i <= len; i++) {
                    ...
                    if (st == "Void" || st == "Void(Draft)" || st == "Void(Pending)" || st == "Void(Approved)"||st == "Void(Issued)") {
                            ...
                            success: function(data) {
                                if(data.valerror)
                                {
                                    ...
                                    {  
                                        ...
                                        $('#undovoidbtn').text('Undo Void');
                                        toastrMessage('error',"You cant void the following Item(s) because item(s) have transactions." + loopedVal,"Error");
                        ...
                        toastrMessage('error',"Requisition should be void","Error");
                        $("#undovoidmodal").modal('hide');
                        var oTable = $('#laravel-datatable-crud').dataTable();
                        oTable.fnDraw(false);
                        $("#undovoidform")[0].reset();
        ...
        function prTypeFn() {
            ...
            if(productType == 1){
                ...
                $('#RequestReason option').each(function () {
                    if($(this).val() <= 9){
                        $(`#RequestReason option[value="${$(this).val()}"]`).remove(); 
                    }
                });
            }
            $('#RequestReason').append(default_option);
            $('#RequestReason').select2
            ({
                placeholder: "Select Request reason here...",
            });
        ...
        function compTypeFn() {
            ...
            if(parseInt(comtype)==1){
                ...
                populateProductionNumFn(customersId);
            }
        ...
        function customerFn() {
            ...
            resetQtyProp();
            $('#productionId').empty();
            populateProductionNumFn(cusorowner);
            $('#customer-error').html("");
        }

        function populateProductionNumFn(cus_id){
            var defaultoption = '<option selected value=""></option>';
            var production_num_data = $("#production_number_default > option").clone();
            $('#productionId').append(production_num_data);
            $(`#productionId option[data-customer_id!="${cus_id}"]`).remove(); 
            $('#productionId').append(defaultoption);
            $('#productionId').select2
            ({
                placeholder: "Select production number here",
            });
