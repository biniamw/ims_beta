...
class delivery_order extends Model
{
    ...
    'expiry_date','order_by','sales_person','supporting_doc_no','payment_type','payment_term','show_pricing','show_std_pricing','customers_id',
    'delivery_by','received_by','phone_no','id_no','plate_no','total_price','std_total_price','fiscal_year','current_document_no','prepared_by',
