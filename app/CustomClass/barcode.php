...
class Barcode
{
   ...
   public function __construct (string $number, $scale, $fontpath=null)
   {
      ...
      if (!$fontpath)
         ...
         //$this->font = public_path("app-assets/fonts/FreeSansBold.ttf");
      else
          $this->font = $fontpath;
   ...
   protected function _drawText()
   {
      ...
      imagettftext($this->_image, $fontsize, 0, $x+10, $y, $text_color, $this->font, '>');
     // imagettftext('>');
   }
